...
static DungeonDef gDungeonDefs[] = {
    ...
    { "Forest",         SCE_OOT_TEMPLE_FOREST,          DD_OOT, 5 },
    { "Fire",           SCE_OOT_TEMPLE_FIRE,            DD_OOT, 8 },
    { "Water",          SCE_OOT_TEMPLE_WATER,           DD_OOT, 5 },
    { "Shadow",         SCE_OOT_TEMPLE_SHADOW,          DD_OOT, 5 },
    { "Spirit",         SCE_OOT_TEMPLE_SPIRIT,          DD_OOT, 5 },
    { "Well",           SCE_OOT_BOTTOM_OF_THE_WELL,     DD_OOT, 3 },
    { "Ice",            SCE_OOT_ICE_CAVERN,             DD_OOT, 0 },
    { "Hideout",        SCE_OOT_THIEVES_HIDEOUT,        DD_OOT, 4 },
    { "GTG",            SCE_OOT_GERUDO_TRAINING_GROUND, DD_OOT, 9 },
    { "Ganon",          SCE_OOT_INSIDE_GANON_CASTLE,    DD_OOT, 2 },
    { "Woodfall",       0,                              DD_MM,  0 },
    { "Snowhead",       1,                              DD_MM,  0 },
    { "Great Bay",      2,                              DD_MM,  0 },
    { "Stone Tower",    3,                              DD_MM,  0 },
};
