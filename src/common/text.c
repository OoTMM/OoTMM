...
const RegionName kRegionNamesOot[] = {
    ...
    { "inside",     TEXT_COLOR_BLUE "Jabu Jabu's Belly" },
    ...
    { "in",         "the " TEXT_COLOR_YELLOW "Thieves' Hideout" },
    { "inside",     TEXT_COLOR_RED "Ganon's Castle" },
    { "in",         "the " TEXT_COLOR_GREEN "Kokiri Forest" },
    { "in",         TEXT_COLOR_YELLOW "Hyrule Field" },
    { "in",         TEXT_COLOR_YELLOW "Market" },
    { "in",         TEXT_COLOR_ORANGE "Lon Lon Ranch" },
    { "in",         TEXT_COLOR_YELLOW "Hyrule Castle" },
    { "in",         TEXT_COLOR_RED "Ganon's Castle Exterior" },
    { "in",         "the " TEXT_COLOR_GREEN "Lost Woods" },
    { "in",         "the " TEXT_COLOR_GREEN "Sacred Forest Meadow" },
    { "in",         TEXT_COLOR_RED "Kakariko" },
    { "inside",     TEXT_COLOR_PINK "Graveyard" },
    { "on",         TEXT_COLOR_RED "Death Mountain Trail" },
    { "in",         TEXT_COLOR_RED "Death Mountain Crater" },
    ...
    { "in",         "the " TEXT_COLOR_YELLOW "Haunted Wasteland" },
...
const RegionName kRegionNamesMm[] = {
    ...
    { "on",         "the " TEXT_COLOR_GREEN "Road to Southern Swamp" },
    ...
    { "in",         TEXT_COLOR_PINK "Ikana Graveyard" },
    { "in",         TEXT_COLOR_ORANGE "Ikana Canyon" },
    { "in",         "the " TEXT_COLOR_ORANGE "Ikana Castle" },
