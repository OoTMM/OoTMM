const OOT_REGION_NAMES: {[k: string]: string} = {
  ...
  'OOT_GERUDO_TRAINING_GROUNDS': 'Gerudo Training Ground',
...
const MM_REGION_NAMES: {[k: string]: string} = {
  ...
  'MM_PATH_TO_SNOWHEAD': 'Path to Snowhead',
  ...
  'MM_PIRATE_FORTRESS_INTERIOR': 'Pirates\' Fotress Interior',
