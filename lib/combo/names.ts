const ITEM_NAMES: {[k: string]: string} = {
  ...
  MM_BOTTLE_EMPTY: "Bottle - Empty (MM)",
  ...
  MM_GS_TOKEN_OCEAN: "Ocean Golden Skulltula Spirits",
  MM_GS_TOKEN_SWAMP: "Swamp Golden Skulltula Spirits",
  ...
  OOT_BOTTLE_EMPTY: "Bottle - Empty (OoT)",
  OOT_BOTTLE_MILK: "Bottle - Milk (OoT)",
  ...
  OOT_EYE_DROPS: "Biggoron's Eye Drops",
  OOT_EYEBALL_FROG: "Eyeball Frog",
  OOT_FAIRY: "Bottle - Fairy (OoT)",
  OOT_FISH: "Bottle - Fish (OoT)",
  ...
  OOT_MILK: "Bottle - Lon Lon Milk (OoT)",
  ...
  OOT_POE: "Bottle - Poe Spirit (OoT)",
  OOT_POTION_BLUE: "Bottle - Blue Potion (OoT)",
  OOT_POTION_GREEN: "Bottle - Green Potion (OoT)",
  OOT_POTION_RED: "Bottle - Red Potion (OoT)",
