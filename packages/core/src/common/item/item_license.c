...
int isItemLicensed(s16 gi)
{
    ...
    case GI_OOT_BOMBCHU_BAG_20:
        return ((!Config_Flag(CFG_OOT_BOMBCHU_BAG) && gOotSave.inventory.upgrades.bombBag != 0) || gOotSave.inventory.items[ITS_OOT_BOMBCHU] == ITEM_OOT_BOMBCHU_10);
    case GI_MM_BOMBCHU:
    ...
    case GI_MM_BOMBCHU_BAG_20:
        return (Config_Flag(CFG_MM_BOMBCHU_BAG) ? (gMmSave.inventory.items[ITS_MM_BOMBCHU] == ITEM_MM_BOMBCHU) : (gMmSave.inventory.upgrades.bombBag != 0));
