...
static const SharedItem kSimpleSharedItems[] = {
    ...
    { CFG_SHARED_LENS, GI_OOT_POTION_RED, GI_MM_POTION_RED },
    { CFG_SHARED_LENS, GI_OOT_POTION_GREEN, GI_MM_POTION_GREEN },
    { CFG_SHARED_LENS, GI_OOT_POTION_BLUE, GI_MM_POTION_BLUE },
    { CFG_SHARED_LENS, GI_OOT_FAIRY, GI_MM_FAIRY },
    { CFG_SHARED_LENS, GI_OOT_BOTTLE_MILK, GI_MM_BOTTLE_MILK },
