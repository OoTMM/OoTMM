...
static const SharedItem kSimpleSharedItems[] = {
    ...
    { CFG_SHARED_MAGIC_SPELLS, GI_OOT_SPELL_FIRE, GI_MM_SPELL_FIRE },
    { CFG_SHARED_MAGIC_SPELLS, GI_OOT_SPELL_WIND, GI_MM_SPELL_WIND },
    { CFG_SHARED_MAGIC_SPELLS, GI_OOT_SPELL_LOVE, GI_MM_SPELL_LOVE },
};
