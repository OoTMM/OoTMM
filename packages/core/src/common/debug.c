...
static void cheatAllItems(PlayState* play)
{
    ...
    gSave.info.playerData.rupees = gMmSave.info.lotteryCodes[CURRENT_DAY - 1][0] * 100 + (gMmSave.info.lotteryCodes[CURRENT_DAY - 1][1] * 10) + (gMmSave.info.lotteryCodes[CURRENT_DAY - 1][2]);
