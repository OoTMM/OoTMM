...
export async function applyRandomSettings(rnd: OptionRandomSettings, oldSettings: Settings): Promise<Settings> {
  ...
  base.shuffleLotteryMm = booleanWeighted(random, 0.30);
  ...
  if (rnd.extraShuffles) {
    ...
    case 2:
      ...
      base.shuffleRocksOot = true;
      base.shuffleRocksMm = 'all';
      base.shuffleTreesOot = true;
      base.shuffleTreesMm = 'all';
      base.shuffleBushOot = true;
      base.shuffleBushMm = 'all';
      base.shuffleSoilOot = true;
      base.shuffleSoilMm = 'all';
      ...
      base.shuffleGossipFairiesMm = 'all';
      base.shuffleGossipBigFairiesMm = 'all';
    ...
    case 3:
      ...
      base.shuffleTFGrassMm = true;
      base.shuffleRocksOot = true;
      base.shuffleRocksMm = 'overworld';
      base.shuffleTreesOot = true;
      base.shuffleTreesMm = 'overworld';
      base.shuffleBushOot = true;
      base.shuffleBushMm = 'overworld';
      base.shuffleSoilOot = true;
      base.shuffleSoilMm = 'overworld';
      ...
      base.shuffleGossipFairiesMm = 'overworld';
      base.shuffleGossipBigFairiesMm = 'overworld';
    ...
    case 4:
      ...
      base.shuffleRocksMm = 'dungeons';
      base.shuffleTreesMm = 'dungeons';
      base.shuffleBushMm = 'dungeons';
      base.shuffleSoilMm = 'dungeons';
      ...
      base.shuffleGossipFairiesMm = 'dungeons';
      base.shuffleGossipBigFairiesMm = 'dungeons';
    ...
    default:
      ...
      base.shufflePotsMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleCratesOot = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleCratesMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleGrassOot = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleGrassMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleTFGrassMm = booleanWeighted(random, 0.5);
      base.shuffleRocksOot = booleanWeighted(random, 0.5);
      base.shuffleRocksMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleTreesOot = booleanWeighted(random, 0.5);
      ...
      base.shuffleSoilMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      ...
      base.shuffleFreeRupeesMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleBarrelsMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      ...
      base.shuffleGossipFairiesMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
      base.shuffleGossipBigFairiesMm = sampleWeighted(random, { none: 10, overworld: 10, dungeons: 10, all: 10 });
