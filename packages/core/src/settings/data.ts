...
},
{
  ...
  key: 'bombBagMmOot',
  name: "Bomb Bag (MM) (OoT)",
  category: 'items.extensions',
  type: 'boolean',
  description: "Add the Bomb Bag from Majora's Mask to Ocarina of Time.",
  default: false,
  cond: hasOoT,
}, {
  key: 'bombBagOotMm',
  name: "Bomb Bag (OoT) (MM)",
  category: 'items.extensions',
  type: 'boolean',
  description: "Add the Bomb Bag from Ocarina of Time to Majora's Mask.",
  default: false,
  cond: hasMM,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && !s.bombBagOotMm && !s.bombBagMmOot,
}, {
  key: 'sharedBombBagsOot',
  name: 'Shared Bomb Bags (OoT)',
  category: 'items.shared',
  type: 'boolean',
  description: 'Combines the Bomb Bags (OoT) from OoT and MM into three progressive items for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.bombBagOotMm,
}, {
  key: 'sharedBombBagsMm',
  name: 'Shared Bomb Bags (MM)',
  category: 'items.shared',
  type: 'boolean',
  description: 'Combines the Bomb Bags (MM) from OoT and MM into three progressive items for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.bombBagMmOot,
}, {
  key: 'sharedMagic',
  name: 'Shared Magic',
  category: 'items.shared',
