...
export const SETTINGS = [{
  ...
  key: 'shuffleGossipBigFairiesOot',
  name: 'Gossip Big Fairies Shuffle (OoT)',
  category: 'main.shuffle',
  type: 'enum',
  description: 'Controls whether or not the gossip stones big fairies are shuffled (OoT)',
  values: [
    { value: 'none', name: 'None' },
    { value: 'all', name: 'All' },
    { value: 'overworld', name: 'Overworld' },
  ...
  key: 'shuffleGossipFairiesMm',
  name: 'Gossip Fairies Shuffle (MM)',
  category: 'main.shuffle',
  type: 'enum',
  description: 'Controls whether or not the gossip stones fairies are shuffled (MM)',
  values: [
    { value: 'none', name: 'None' },
    { value: 'all', name: 'All' },
    { value: 'overworld', name: 'Overworld' },
  ...
  key: 'shuffleGossipBigFairiesMm',
  name: 'Gossip Big Fairies Shuffle (MM)',
  category: 'main.shuffle',
  type: 'enum',
  description: 'Controls whether or not the gossip stones big fairies are shuffled (MM)',
  values: [
    { value: 'none', name: 'None' },
    { value: 'all', name: 'All' },
    { value: 'overworld', name: 'Overworld' },
  ...
  key: 'songEventsShuffleMm',
  name: 'Song Events Shuffle (MM)',
  category: 'main.events',
  type: 'boolean',
  description: 'Shuffle the various events requiring songs to trigger them (MM)',
  cond: hasMM,
  default: false
}, {
  key: 'ganonTrials',
  ...
  key: 'damageMultiplierOot',
  name: 'Damage Multiplier (OoT)',
  category: 'main.nologic',
  type: 'enum',
  description: 'Modifies the damage dealt to the player. Logic is NOT adjusted for this setting. Use at your own risk.',
  values: [
    { value: 'normal', name: 'Normal (x1)' },
    { value: 'double', name: 'Double (x2)' },
    { value: 'quadruple', name: 'Quadruple (x4)' },
    { value: 'octuple', name: 'Octuple (x8)' },
    { value: 'ohko', name: 'OHKO (One-Hit K.O.)' },
  ],
  default: 'normal',
  cond: hasOoT,
}, {
  key: 'damageMultiplierMm',
  name: 'Damage Multiplier (MM)',
  category: 'main.nologic',
  type: 'enum',
  description: 'Modifies the damage dealt to the player. Logic is NOT adjusted for this setting. Use at your own risk.',
  values: [
  ...
  category: 'items.progressive',
  type: 'enum',
  description: 'Alters the behavior of the MM Goron Lullaby',
  values: [
  ...
  key: 'progressiveGoronLullabyOot',
  name: 'OoT Goron Lullaby',
  category: 'items.progressive',
  type: 'enum',
  description: 'Alters the behavior of the OoT Goron Lullaby',
  values: [
    { value: 'single', name: 'Full Lullaby Only', description: 'Only the Goron Lullaby can be found' },
    { value: 'progressive', name: 'Progressive', description: 'The Lullaby Intro will be received first before getting the full song' },
  ],
  default: 'progressive',
  cond: (s: any) => hasOoT(s) && s.songGoronOot,
}, {
  ...
  key: 'fillWallets',
  name: 'Fill Wallets',
  category: 'items.extensions.general',
  type: 'boolean',
  ...
  group: 'Gerudo Mask',
  type: 'boolean',
  description: "Add the Gerudo Mask in Majora's Mask which can be used as a disguise to enter Pirates Fortress.",
  default: false,
  cond: hasMM,
}, {
  key: 'skullMaskMm',
  ...
  group: 'Skull Mask',
  type: 'boolean',
  description: "Add the Skull Mask in Majora's Mask which can be used as a disguise to enter the Deku Palace.",
  default: false,
  cond: hasMM,
}, {
  key: 'spookyMaskMm',
  ...
  key: 'songSoaringOot',
  name: "Song of Soaring (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'Song of Soaring',
  type: 'boolean',
  description: "Add the Song of Soaring in Ocarina of Time. Usable only as child. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songHealingOot',
  name: "Song of Healing (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'Song of Healing',
  type: 'boolean',
  description: "Add the Song of Healing in Ocarina of Time. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songAwakeningOot',
  name: "Sonata of Awakening (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'Sonata of Awakening',
  type: 'boolean',
  description: "Add the Sonata of Awakening in Ocarina of Time. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songGoronOot',
  name: "Goron Lullaby (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'Goron Lullaby',
  type: 'boolean',
  description: "Add the Goron Lullaby in Ocarina of Time. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songZoraOot',
  name: "New Wave Bossa Nova (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'New Wave Bossa Nova',
  type: 'boolean',
  description: "Add the New Wave Bossa Nova in Ocarina of Time. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songOrderOot',
  name: "Oath to Order (OoT)",
  category: 'items.extensions.crossGame.songs',
  game: 'oot',
  group: 'Oath to Order',
  type: 'boolean',
  description: "Add the Oath to Order in Ocarina of Time. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasOoT,
}, {
  key: 'songSunMm',
  ...
  group: "Sun's Song",
  type: 'boolean',
  description: "Add Sun's Song in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songZeldaLullabyMm',
  name: "Zelda's Lullaby (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: "Zelda's Lullaby",
  type: 'boolean',
  description: "Add Zelda's Lullaby in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songSariasMm',
  name: "Saria's Song (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: "Saria's Song",
  type: 'boolean',
  description: "Add Saria's Song in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songMinuetMm',
  name: "Minuet of Forest (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Minuet of Forest',
  type: 'boolean',
  description: "Add the Minuet of Forest in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songBoleroMm',
  name: "Bolero of Fire (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Bolero of Fire',
  type: 'boolean',
  description: "Add the Bolero of Fire in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songSerenadeMm',
  name: "Serenade of Water (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Serenade of Water',
  type: 'boolean',
  description: "Add the Serenade of Water in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songRequiemMm',
  name: "Requiem of Spirit (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Requiem of Spirit',
  type: 'boolean',
  description: "Add the Requiem of Spirit in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songNocturneMm',
  name: "Nocturne of Shadow (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Nocturne of Shadow',
  type: 'boolean',
  description: "Add the Nocturne of Shadow in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'songPreludeMm',
  name: "Prelude of Light (MM)",
  category: 'items.extensions.crossGame.songs',
  game: 'mm',
  group: 'Prelude of Light',
  type: 'boolean',
  description: "Add the Prelude of Light in Majora's Mask. If Songs are on Song Locations, you must share or start with at least one song",
  default: false,
  cond: hasMM,
}, {
  key: 'powderKegOot',
  ...
  key: 'clocksOot',
  name: 'Clock as Item (OoT)',
  category: 'items.extensions.systems',
  game: 'oot',
  group: 'Clocks',
  type: 'enum',
  description: 'Add an item representing the flow of time in Ocarina of Time into the pool. You will be locked at either noon or midnight unless you collect this item.',
  values: [
    { value: 'none', name: 'None', description: 'Disabled' },
    { value: 'day', name: 'Day', description: 'The world will allways experience daytime until you find the clock.' },
    { value: 'night', name: 'Night', description: 'The world will allways experience nighttime until you find the clock.' },
    { value: 'random', name: 'Random', description: 'Either night or day, at random.' },
  ],
  default: 'none',
  cond: hasOoT,
}, {
  ...
  key: 'coins',
  name: 'Coins',
  category: 'items.extensions.coins',
  type: 'boolean',
  ...
  key: 'trapIce',
  name: 'Ice Traps',
  category: 'items.extensions.traps',
  type: 'boolean',
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songSunMm,
}, {
  key: 'sharedHookshot',
  ...
  key: 'sharedSongHealing',
  name: 'Shared Song of Healing',
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'Song of Healing',
  type: 'boolean',
  description: 'Combines the Songs of Healing from OoT and MM into one item for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songHealingOot,
}, {
  key: 'sharedSongSoaring',
  name: 'Shared Song of Soaring',
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'Song of Soaring',
  type: 'boolean',
  description: 'Combines the Songs of Song from OoT and MM into one item for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songSoaringOot,
}, {
  key: 'sharedSongAwakening',
  name: "Shared Sonata of Awakening",
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'Sonata of Awakening',
  type: 'boolean',
  description: "Combines the Sonata of Awakening from OoT and MM into one item for both games",
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songAwakeningOot,
}, {
  key: 'sharedSongGoron',
  name: "Shared Goron Lullaby",
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'Goron Lullaby',
  type: 'boolean',
  description: "Combines the Goron Lullaby from OoT and MM into one item for both games",
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songGoronOot && s.progressiveGoronLullabyMm === s.progressiveGoronLullabyOot,
}, {
  key: 'sharedSongZora',
  name: "Shared New Wave Bossa Nova",
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'New Wave Bossa Nova',
  type: 'boolean',
  description: "Combines the New Wave Bossa Nova from OoT and MM into one item for both games",
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songZoraOot,
}, {
  key: 'sharedSongOrder',
  name: "Shared Oath to Order",
  category: 'items.extensions.crossGame.songs',
  game: 'shared',
  group: 'Oath to Order',
  type: 'boolean',
  description: "Combines the Oath to Order from OoT and MM into one item for both games",
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songOrderOot,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songZeldaLullabyMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songSariasMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songMinuetMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songBoleroMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songSerenadeMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songRequiemMm,
}, {
  ...
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.songNocturneMm,
}, {
  ...
  key: 'sharedMaskGerudo',
  name: "Shared Gerudo Mask",
  category: 'items.extensions.crossGame.masks',
  game: 'shared',
  group: 'Gerudo Mask',
  type: 'boolean',
  description: 'Combines the Gerudo Masks from OoT and MM into one item for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.gerudoMaskMm,
}, {
  key: 'sharedMaskSkull',
  name: "Shared Skull Mask",
  category: 'items.extensions.crossGame.masks',
  game: 'shared',
  group: 'Skull Mask',
  type: 'boolean',
  description: 'Combines the Skull Masks from OoT and MM into one item for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.skullMaskMm,
}, {
  key: 'sharedMaskSpooky',
  name: "Shared Spooky Mask",
  category: 'items.extensions.crossGame.masks',
  game: 'shared',
  group: 'Spooky Mask',
  type: 'boolean',
  description: 'Combines the Spooky Masks from OoT and MM into one item for both games',
  default: false,
  cond: (s: any) => hasOoTMM(s) && s.spookyMaskMm,
}, {
  key: 'sharedBottles',
  name: 'Shared Bottles',
  category: 'items.extensions.shared',
  ...
  key: 'cutsceneSkipOoT',
  name: 'Skip Mundane Cutscenes (OoT)',
  category: 'cutscenes.main',
  type: 'boolean',
  description: 'Skips a lot of mundane cutscenes in OoT, such as chests appearing, barred doors opening, etc.',
  default: false,
  cond: hasOoT,
}, {
  key: 'cutsceneSkipMM',
  ...
  key: 'cutsceneGlitchOoT',
  name: 'Glitch Aiding Cutscenes (OoT)',
  category: 'cutscenes.glitches',
  type: 'boolean',
  description: 'Enables glitch-aiding cutscenes, such as Poe Sisters, Darunia, and some other chests/switches in dungeons.',
  default: false,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroGohma',
  name: 'Skip Gohma Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Gohma.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroKingDodongo',
  name: 'Skip King Dodongo Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for King Dodongo.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroBarinade',
  name: 'Skip Barinade Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Barinade.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroPhantomGanon',
  name: 'Skip Phantom Ganon Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Phantom Ganon.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroVolvagia',
  name: 'Skip Volvagia Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Volvagia.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroMorpha',
  name: 'Skip Morpha Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Morpha.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroBongoBongo',
  name: 'Skip Bongo Bongo Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Bongo Bongo.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroTwinrova',
  name: 'Skip Twinrova Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Twinrova.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroGanondorf',
  name: 'Skip Ganondorf Intro Cutscene',
  category: 'cutscenes.bosses.oot',
  type: 'boolean',
  description: 'Skips the intro cutscene for Ganondorf.',
  default: true,
  cond: hasOoT,
}, {
  key: 'cutsceneIntroOdolwa',
  name: 'Skip Odolwa Intro Cutscene',
  category: 'cutscenes.bosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Odolwa.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroGoht',
  name: 'Skip Goht Intro Cutscene',
  category: 'cutscenes.bosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Goht.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroWart',
  name: 'Skip Wart Intro Cutscene',
  ...
  name: 'Skip Gyorg Intro Cutscene',
  category: 'cutscenes.bosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Gyorg.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroIgos',
  name: 'Skip Igos du Ikana Intro Cutscene',
  category: 'cutscenes.minibosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Igos du Ikana.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroGomess',
  name: 'Skip Gomess Intro Cutscene',
  category: 'cutscenes.minibosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Gomess.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroTwinmold',
  name: 'Skip Twinmold Intro Cutscene',
  category: 'cutscenes.bosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Twinmold.',
  default: true,
  cond: hasMM,
}, {
  key: 'cutsceneIntroMajora',
  name: 'Skip Majora Intro Cutscene',
  category: 'cutscenes.bosses.mm',
  type: 'boolean',
  description: 'Skips the intro cutscene for Majora.',
  default: false,
  cond: hasMM,
}] as const;
...
export const SUBCATEGORIES = [{
  ...
  categories: [
    ...
    { key: "Settings not affecting logic", category: "main.nologic" },
  ]
}, {
  key: "cutscenes",
  categories: [
    { key: "Main Cutscenes", category: "cutscenes.main" },
    { key: "OoT Boss Cutscenes", category: "cutscenes.bosses.oot" },
    { key: "MM Boss Cutscenes", category: "cutscenes.bosses.mm" },
    { key: "MM Miniboss Cutscenes", category: "cutscenes.minibosses.mm" },
    { key: "Glitch-Aiding Cutscenes", category: "cutscenes.glitches" },
  ]
}] as const;