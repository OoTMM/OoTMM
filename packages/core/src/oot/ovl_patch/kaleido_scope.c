...
/* C buttons in Ocarina Playback */
EXPORT_ADDR(COLOR_C_BUTTONS_R, 0x80814f76);
EXPORT_ADDR(COLOR_C_BUTTONS_G, 0x80814f77);
EXPORT_ADDR(COLOR_C_BUTTONS_B, 0x80814f82);

EXPORT_ADDR(COLOR_C_BUTTONS_R, 0x8081526a);
EXPORT_ADDR(COLOR_C_BUTTONS_G, 0x8081526b);
EXPORT_ADDR(COLOR_C_BUTTONS_B, 0x80815276);

EXPORT_ADDR(COLOR_C_BUTTONS_R, 0x80815566);
EXPORT_ADDR(COLOR_C_BUTTONS_G, 0x80815567);
EXPORT_ADDR(COLOR_C_BUTTONS_B, 0x8081557a);
