...
void EnFu_HandlerNull(Actor* actor, PlayState* play)
{
}

void EnFu_HandlerAdultOcarina2(Actor* actor, PlayState* play)
{
...
void EnFu_HandlerAdultOcarina(Actor* actor, PlayState* play)
{
