...
#include <assets/oot/textures/icon_item_static.h>
...
void KaleidoScope_DrawQuestStatus(PlayState* play, GraphicsContext* gfxCtx) {
    ...
    if (CHECK_QUEST_ITEM(QUEST_SKULL_TOKEN)) {
        ...
        gsTokenDigits[2] = gSaveContext.save.info.inventory.goldTokens;
        ...
        for (i = 0, j = 0; i < 2; i++) {
            if (i == 0) {
                ...
                // Text color
                if (gSaveContext.save.info.inventory.goldTokens == 100) {
