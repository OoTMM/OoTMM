...
static const char* EnKanban_LocName(PlayState* play)
{
    ...
    case INSTANCE_OOT_GROTTO_GENERIC_HYRULE_FIELD_SOUTHEAST: return "Hyrule Field Southeast Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_HYRULE_FIELD_OPEN: return "Hyrule Field Open Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_KAKARIKO: return "Kakariko Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_ZORA_RIVER: return "Zora River Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_KOKIRI_FOREST: return "Kokiri Forest Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_LOST_WOODS: return "Lost Woods Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_DEATH_MOUNTAIN_TRAIL: return "Death Mountain Trail Generic Grotto";
    case INSTANCE_OOT_GROTTO_GENERIC_DEATH_MOUNTAIN_CRATER: return "Death Mountain Crater Generic Grotto";

    case INSTANCE_OOT_GROTTO_SCRUB2_SACRED_FOREST_MEADOW: return "Sacred Forest Meadow Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB2_ZORA_RIVER: return "Zora River Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB2_GERUDO_VALLEY: return "Gerudo Valley Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB2_DESERT_COLOSSUS: return "Desert Colossus Scrub Grotto";

    case INSTANCE_OOT_GROTTO_SCRUB3_LON_LON_RANCH: return "Lon Lon Ranch Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB3_GORON_CITY: return "Goron City Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB3_DEATH_MOUNTAIN_CRATER: return "Death Mountain Crater Scrub Grotto";
    case INSTANCE_OOT_GROTTO_SCRUB3_LAKE_HYLIA: return "Lake Hylia Scrub Grotto";

    case INSTANCE_OOT_FAIRY_FOUNTAIN_SACRED_FOREST_MEADOW: return "Sacred Forest Meadow Fairy Fountain";
    case INSTANCE_OOT_FAIRY_FOUNTAIN_HYRULE_FIELD: return "Hyrule Field Fairy Fountain";
    case INSTANCE_OOT_FAIRY_FOUNTAIN_ZORA_RIVER: return "Zora River Fairy Fountain";
    case INSTANCE_OOT_FAIRY_FOUNTAIN_ZORA_DOMAIN: return "Zora Domain Fairy Fountain";
    case INSTANCE_OOT_FAIRY_FOUNTAIN_GERUDO_FORTRESS: return "Gerudo Fortress Fairy Fountain";

    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_UPGRADES_DEATH_MOUNTAIN_TRAIL: return "Death Mountain Trail Great Fairy Fountain";
    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_UPGRADES_DEATH_MOUNTAIN_CRATER: return "Death Mountain Crater Great Fairy Fountain";
    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_UPGRADES_OUTSIDE_GANON_CASTLE: return "Outside Ganon Castle Great Fairy Fountain";

    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_SPELLS_ZORA_FOUNTAIN: return "Zora Fountain Great Fairy Fountain";
    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_SPELLS_HYRULE_CASTLE: return "Hyrule Castle Great Fairy Fountain";
    case INSTANCE_OOT_GREAT_FAIRY_FOUNTAIN_SPELLS_DESERT_COLOSSUS: return "Desert Colossus Great Fairy Fountain";
    }
    ...
    if (this->actor.params != ENKANBAN_PIECE) {
        ...
        if (this->actor.params == ENKANBAN_FISHING) {
            if (gSave.age == AGE_CHILD) {
                this->actor.messageId = 0x409D;
            } else {
                this->actor.messageId = 0x4090;
            }
        } else {
        ...
        Actor_UpdateBgCheckInfo(play, &this->actor, 10.0f, 10.0f, 50.0f, UPDBGCHECKINFO_FLAG_OOT_2);
    ...
    switch (this->actionState) {
        ...
        case ENKANBAN_UNUSED: {
            ...
            Actor_UpdateBgCheckInfo(play, &this->actor, 30.0f, 30.0f, 50.0f,
                                    UPDBGCHECKINFO_FLAG_OOT_0 | UPDBGCHECKINFO_FLAG_OOT_2);
        ...
        case ENKANBAN_WATER:
            ...
            if (this->bounceX == 0) {
                Actor* bomb = play->actorCtx.actors[ACTORCAT_EXPLOSIVE].first;
                f32 dx;
                f32 dy;
                f32 dz;
...
static Vtx sShadowVtx[4] = {
	VTX(-2000, 0, 0, 0, 1024, 255, 255, 255, 255),
	VTX(2000, 0, 0, 1024, 1024, 255, 255, 255, 255),
	VTX(2000, 6000, 0, 1024, 0, 255, 255, 255, 255),
	VTX(-2000, 6000, 0, 0, 0, 255, 255, 255, 255),
};
...
void EnKanban_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((this->actor.projectedPos.z <= 400.0f) && (this->actor.projectedPos.z > 0.0f) &&
        ...
        if ((this->bounceX != 0) || (this->bounceZ != 0)) {
            ...
            if ((this->actionState == ENKANBAN_SIGN) && gSave.age == AGE_CHILD) {
                zShift = 0.0f;
            } else {
...
OVL_INFO_ACTOR(ACTOR_EN_KANBAN, En_Kanban_Profile);
