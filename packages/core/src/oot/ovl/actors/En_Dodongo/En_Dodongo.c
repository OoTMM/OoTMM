#include "En_Dodongo.h"
#include <actors/En_Bom/En_Bom.h>
#include <actors/En_Bombf/En_Bombf.h>
...
static InitChainEntry sInitChain[] = {
    ICHAIN_S8(hintId, NAVI_ENEMY_DODONGO, ICHAIN_CONTINUE),
...
void EnDodongo_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_Init(play, &this->skelAnime, (void*)gDodongoSkel, (void*)gDodongoWaitAnim, this->jointTable, this->morphTable, 31);
    ...
    Actor_UpdateBgCheckInfo(play, &this->actor, 75.0f, 60.0f, 70.0f,
                            UPDBGCHECKINFO_FLAG_OOT_0 | UPDBGCHECKINFO_FLAG_OOT_2 | UPDBGCHECKINFO_FLAG_OOT_3 |
...
void EnDodongo_SetupIdle(EnDodongo* this) {
    Animation_MorphToLoop(&this->skelAnime, (void*)gDodongoWaitAnim, -4.0f);
...
void EnDodongo_SetupWalk(EnDodongo* this) {
    f32 frames = Animation_GetLastFrame((void*)gDodongoWalkAnim);

    Animation_Change(&this->skelAnime, (void*)gDodongoWalkAnim, 0.0f, 0.0f, frames, ANIMMODE_LOOP, -4.0f);
...
void EnDodongo_SetupBreatheFire(EnDodongo* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)gDodongoBreatheFireAnim, -4.0f);
...
void EnDodongo_SetupEndBreatheFire(EnDodongo* this) {
    Animation_PlayOnce(&this->skelAnime, (void*)gDodongoAfterBreatheFireAnim);
...
void EnDodongo_SetupSwallowBomb(EnDodongo* this) {
    Animation_Change(&this->skelAnime, (void*)gDodongoBreatheFireAnim, -1.0f, 35.0f, 0.0f, ANIMMODE_ONCE, -4.0f);
...
void EnDodongo_SetupStunned(EnDodongo* this) {
    Animation_Change(&this->skelAnime, (void*)gDodongoBreatheFireAnim, 0.0f, 25.0f, 0.0f, ANIMMODE_ONCE, -4.0f);
...
void EnDodongo_SetupSweepTail(EnDodongo* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)gDodongoDamageAnim, -4.0f);
    ...
    if (SkelAnime_Update(&this->skelAnime)) {
        if ((this->timer != 0) || (ABS(yawDiff1) < 0x4000)) {
            ...
            if ((s16)(this->actor.yawTowardsPlayer - this->actor.shape.rot.y) >= 0) {
                ...
                animation = (void*)gDodongoSweepTailLeftAnim;
            } else {
                animation = (void*)gDodongoSweepTailRightAnim;
            }
...
void EnDodongo_SetupDeath(EnDodongo* this, PlayState* play) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)gDodongoDieAnim, -8.0f);
    this->timer = 0;
...
s32 EnDodongo_AteBomb(EnDodongo* this, PlayState* play) {
    Actor* actor = play->actorCtx.actors[ACTORCAT_EXPLOSIVE].first;
    f32 dx;
    f32 dy;
    f32 dz;
...
OVL_INFO_ACTOR(ACTOR_EN_DODONGO, En_Dodongo_Profile);
