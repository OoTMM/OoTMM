...
OVL_INFO_ACTOR(ACTOR_EN_ISHI, En_Ishi_Profile);
    ...
    for (i = 0; i < 3; i++) {
        Actor* bug =
            Actor_Spawn(&play->actorCtx, play, ACTOR_EN_INSECT, this->actor.world.pos.x, this->actor.world.pos.y,
                        this->actor.world.pos.z, 0, Rand_ZeroOne() * 0xFFFF, 0, 0x01 /* INSECT_TYPE_SPAWNED */);
...
void EnIshi_LiftedUp(EnIshi* this, PlayState* play) {
    if (Actor_HasNoParent(&this->actor, play)) {
        ...
        Actor_UpdateBgCheckInfo(play, &this->actor, 7.5f, 35.0f, 0.0f, UPDBGCHECKINFO_FLAG_OOT_0 | UPDBGCHECKINFO_FLAG_OOT_2 | UPDBGCHECKINFO_FLAG_OOT_6 | UPDBGCHECKINFO_FLAG_OOT_7);
    }
}
