...
#include "Bg_Haka_Zou.h"
#include <combo.h>

#include "assets/oot/objects/object_hakach_objects.h"
#include "assets/oot/objects/object_haka_objects.h"
...
void func_80883000(BgHakaZou* this, PlayState* play) {
    if (this->collider.base.acFlags & AC_HIT) {
        ...
        } else if (this->dyna.actor.params == STA_BOMBABLE_RUBBLE) {
...
void func_80883254(BgHakaZou* this, PlayState* play) {
    f32 moveDist = MULT((Rand_ZeroOne() * 0.5f) + 0.5f);
...
void func_80883328(BgHakaZou* this, PlayState* play) {
    ...
    if (Math_ScaledStepToS(&this->dyna.actor.shape.rot.x, -0x4000, MULT(this->dyna.actor.world.rot.x))) {
...
OVL_INFO_ACTOR(ACTOR_BG_HAKA_ZOU, Bg_Haka_Zou_Profile);
