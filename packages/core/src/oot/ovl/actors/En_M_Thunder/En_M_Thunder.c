...
void func_808FF3FC(PlayState* play, f32 arg1);
void func_808FF4F0(EnMThunder* this, PlayState* play);
...
// Setup action
void func_808FF0C0(EnMThunder* this, EnMThunderActionFunc actionFunc) {
    ...
    if (player->stateFlags2 & PLAYER_STATE2_17) {
        if (!gSaveContext.save.info.playerData.isMagicAcquired || (gSaveContext.magicState != MAGIC_STATE_IDLE) ||
            (PARAMS_GET_S(this->actor.params, 8, 8) &&
             !(Magic_RequestChangeCustom(play, PARAMS_GET_S(this->actor.params, 8, 8), MAGIC_CONSUME_NOW)))) {
        ...
        func_808FF0C0(this, func_808FF4F0);
    }
...
void func_808FF438(EnMThunder* this, PlayState* play) {
    Player* player = GET_PLAYER(play);
...
void func_808FF4F0(EnMThunder* this, PlayState* play) {
    ...
    if (this->unk_1CA == 0) {
        if (player->unk_858 >= 0.1f) {
            if ((gSaveContext.magicState != MAGIC_STATE_IDLE) ||
                ...
                func_808FF438(this, play);
                func_808FF0C0(this, func_808FF438);
                this->unk_1C8 = 0;
                this->unk_1BC = 0.0;
                this->unk_1AC = 0.0f;
                return;
    ...
    if (player->unk_858 > 0.85f) {
        func_800C4F94(&player->actor.projectedPos, 2);
    } else if (player->unk_858 > 0.15f) {
        func_800C4F94(&player->actor.projectedPos, 1);
    } else if (player->unk_858 > 0.1f) {
        func_800C4F94(&player->actor.projectedPos, 0);
    }
...
void EnMThunder_Update(EnMThunder* this, PlayState* play) {
    ...
    func_808FF3FC(play, this->unk_1BC);
...
void EnMThunder_Draw(EnMThunder* this, PlayState* play) {
    ...
    Matrix_Mult(&player->mf_9d0, MTXMODE_NEW);
...
OVL_INFO_ACTOR(ACTOR_EN_M_THUNDER, En_M_Thunder_Profile);
