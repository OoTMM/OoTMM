...
void EnBomChu_WaitForRelease(EnBomChu* this, PlayState* play) {
    ...
    if (Actor_HasNoParent(&this->actor, play)) {
        ...
        Actor_UpdateBgCheckInfo(play, &this->actor, 0.0f, 0.0f, 0.0f, UPDBGCHECKINFO_FLAG_OOT_2);
        ...
        this->actor.flags |= ACTOR_FLAG_OOT_ATTENTION_ENABLED; // make chu targetable
...
void EnBomChu_Move(EnBomChu* this, PlayState* play) {
    ...
    if ((this->timer == 0) || (this->collider.base.acFlags & AC_HIT) ||
        ((this->collider.base.ocFlags1 & OC1_HIT) && (this->collider.base.oc->type != ACTORCAT_PLAYER))) {
        EnBomChu_Explode(this, play);
        return;
    }
...
OVL_INFO_ACTOR(ACTOR_EN_BOM_CHU, En_Bom_Chu_Profile);
