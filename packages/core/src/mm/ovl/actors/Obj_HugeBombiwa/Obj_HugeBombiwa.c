...
#include "Obj_HugeBombiwa.h"
//  #include "z64quake.h"
//  #include "z64rumble.h"
#include "assets/mm/objects/object_bombiwa.h"
...
void ObjHugebombiwa_RequestQuakeAndRumble(ObjHugebombiwa* this, PlayState* play, s32 quakeVerticalMag) {
    s16 quakeIndex = Quake_Request(GET_ACTIVE_CAM(play), 3 /*QUAKE_TYPE_3*/);
...
void func_80A54CEC(ObjHugebombiwa* this, PlayState* play) {
    ...
    if (CutsceneManager_IsNext(this->actor.csId)) {
        ...
        if (!ENHUGEBOMBIWA_GET_100(&this->actor) &&
            ((play->sceneId == SCE_MM_TWIN_ISLANDS_WINTER) || (play->sceneId == SCE_MM_TWIN_ISLANDS_SPRING))) {
            MM_SET_EVENT_WEEK(EV_MM_WEEK_TWIN_ISLANDS_KEG_BOULDER_DESTROYED);
        }
...
void ObjHugebombiwa_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((this->actionFunc == func_80A54C04) || (this->actionFunc == func_80A54CEC)) {
        ...
        gSPDisplayList(gfx++, gSetupDLs[25 /* SETUPDL_25 */]);
...
OVL_INFO_ACTOR(ACTOR_OBJ_HUGEBOMBIWA, Obj_Hugebombiwa_Profile);
