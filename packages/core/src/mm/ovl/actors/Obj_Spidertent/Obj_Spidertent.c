...
#include "Obj_Spidertent.h"
#include "assets/mm/objects/object_spidertent.h"
...
OVL_INFO_ACTOR(ACTOR_OBJ_SPIDERTENT, Obj_Spidertent_Profile);
...
ObjSpidertentStruct D_80B31350[] = {
    {
        ...
        (void*)object_spidertent_Colheader_0011AC,
        &sTrisInit1,
        0.9f,
        1.3f,
        40.0f,
    ...
    },
    {
        ...
        (void*)object_spidertent_Colheader_00238C,
        &sTrisInit2,
        0.9f,
        0.9f,
        30.0f,
