#include <combo.h>
#include <assets/mm/objects/object_ik.h>
...
void EnIk_Update(Actor_EnIk* this, PlayState* play2);
void EnIk_Draw(Actor_EnIk* this, PlayState* play);

void EnIk_Thaw(Actor_EnIk* this, PlayState* play);
s32 EnIk_IsChangingAction(Actor_EnIk* this, PlayState* play);
s32 EnIk_ChooseAttack(Actor_EnIk* this);
void EnIk_CheckActions(Actor_EnIk* this, PlayState* play);
void EnIk_SetupIdle(Actor_EnIk* this);
void EnIk_Idle(Actor_EnIk* this, PlayState* play);
void EnIk_SetupWalk(Actor_EnIk* this);
void EnIk_WalkTowardsPlayer(Actor_EnIk* this, PlayState* play);
void EnIk_SetupRun(Actor_EnIk* this);
void EnIk_RunTowardsPlayer(Actor_EnIk* this, PlayState* play);
void EnIk_SetupVerticalAttack(Actor_EnIk* this);
void EnIk_VerticalAttack(Actor_EnIk* this, PlayState* play);
void EnIk_SetupTakeOutAxe(Actor_EnIk* this);
void EnIk_TakeOutAxe(Actor_EnIk* this, PlayState* play);
void EnIk_SetupHorizontalDoubleAttack(Actor_EnIk* this);
void EnIk_HorizontalDoubleAttack(Actor_EnIk* this, PlayState* play);
void EnIk_SetupSingleHorizontalAttack(Actor_EnIk* this);
void EnIk_SingleHorizontalAttack(Actor_EnIk* this, PlayState* play);
void EnIk_SetupEndHorizontalAttack(Actor_EnIk* this);
void EnIk_EndHorizontalAttack(Actor_EnIk* this, PlayState* play);
void EnIk_SetupBlock(Actor_EnIk* this);
void EnIk_Block(Actor_EnIk* this, PlayState* play);
void EnIk_SetupReactToAttack(Actor_EnIk* this, s32 arg1);
void EnIk_ReactToAttack(Actor_EnIk* this, PlayState* play);
void EnIk_SetupDie(Actor_EnIk* this);
void EnIk_Die(Actor_EnIk* this, PlayState* play);
void EnIk_Frozen(Actor_EnIk* this, PlayState* play);
void EnIk_SetupCutscene(Actor_EnIk* this);
void EnIk_PlayCutscene(Actor_EnIk* this, PlayState* play);
void EnIk_UpdateDamage(Actor_EnIk* this, PlayState* play);
void EnIk_UpdateArmor(Actor_EnIk* this, PlayState* play);
...
EnIkUnkStruct sIronKnuckleArmorMarkings[IRON_KNUCKLE_ARMOR_BODYPART_MAX] = {
    { (void*)gIronKnuckleHelmetMarkingDL, 0x0000 },          // IRON_KNUCKLE_ARMOR_BODYPART_HELMET
    { (void*)gIronKnuckleFrontTorsoArmorMarkingDL, 0x0000 }, // IRON_KNUCKLE_ARMOR_BODYPART_CHEST_FRONT
    { (void*)gIronKnuckleRearTorsoArmorMarkingDL, 0x7FFF },  // IRON_KNUCKLE_ARMOR_BODYPART_CHEST_BACK
    { (void*)gIronKnuckleRivetsMarking2DL, 0x4000 },         // IRON_KNUCKLE_ARMOR_BODYPART_UPPER_LEFT_PAULDRON
    { (void*)gIronKnuckleRivetsMarking1DL, -0x4000 },        // IRON_KNUCKLE_ARMOR_BODYPART_UPPER_RIGHT_PAULDRON
...
static Gfx* sIronKnuckleArmorType[3][3] = {
    { (void*)gIronKnuckleTanArmorMaterialDL,   (void*)gIronKnuckleBronzeArmorMaterialDL, (void*)gIronKnuckleSilverArmorMaterialDL },
    { (void*)gIronKnuckleBlackArmorMaterialDL, (void*)gIronKnuckleBrownArmorMaterialDL,  (void*)gIronKnuckleBrownArmorMaterialDL },
...
void EnIk_Init(Actor_EnIk* this, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)gIronKnuckleSkel, (void*)gIronKnuckleWalkAnim, this->jointTable,
...
void EnIk_HitArmor(Actor_EnIk* this, PlayState* play) {
...
s32 EnIk_ChooseAttack(Actor_EnIk* this) {
    ...
    if ((this->actor.xzDistToPlayer < 100.0f) && (fabsf(this->actor.yDistanceFromLink) < 150.0f)) {
...
void EnIk_SetupIdle(Actor_EnIk* this) {
    f32 endFrame = Animation_GetLastFrame((void*)gIronKnuckleHorizontalAttackAnim);
    ...
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleEndHorizontalAttackAnim, 1.0f, endFrame, endFrame, ANIMMODE_ONCE,
                     this->timer);
...
void EnIk_SetupWalk(Actor_EnIk* this) {
    Animation_MorphToLoop(&this->skelAnime, (void*)gIronKnuckleWalkAnim, -4.0f);
...
void EnIk_SetupRun(Actor_EnIk* this) {
    Animation_MorphToLoop(&this->skelAnime, (void*)gIronKnuckleRunAnim, -4.0f);
...
void EnIk_SetupVerticalAttack(Actor_EnIk* this) {
    ...
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleVerticalAttackAnim, playbackSpeed, 0.0f,
                     Animation_GetLastFrame((void*)gIronKnuckleVerticalAttackAnim), ANIMMODE_ONCE_INTERP, -4.0f);
    this->timer = 0;
...
void EnIk_SetupTakeOutAxe(Actor_EnIk* this) {
    Animation_PlayOnce(&this->skelAnime, (void*)gIronKnuckleEndVerticalAttackAnim);
...
void EnIk_TakeOutAxe(Actor_EnIk* this, PlayState* play) {
    if (SkelAnime_Update(&this->skelAnime)) {
        if (this->skelAnime.animation == (void*)gIronKnuckleRecoverVerticalAttackAnim) {
            EnIk_CheckActions(this, play);
        } else {
            Animation_Change(
                &this->skelAnime, (void*)gIronKnuckleRecoverVerticalAttackAnim, (this->drawArmorFlags) ? 1.5f : 1.0f, 0.0f,
                Animation_GetLastFrame((void*)gIronKnuckleRecoverVerticalAttackAnim), ANIMMODE_ONCE_INTERP, 0.0f);
        }
    }
}
...
void EnIk_SetupHorizontalDoubleAttack(Actor_EnIk* this) {
    this->actor.speed = 0.0f;
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleHorizontalAttackAnim, (this->drawArmorFlags) ? 1.3f : 1.0f, 0.0f,
                     Animation_GetLastFrame((void*)gIronKnuckleHorizontalAttackAnim), ANIMMODE_ONCE_INTERP,
...
void EnIk_SetupSingleHorizontalAttack(Actor_EnIk* this) {
    ...
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleHorizontalAttackAnim, playSpeed, 12.0f,
                     Animation_GetLastFrame((void*)gIronKnuckleHorizontalAttackAnim), ANIMMODE_ONCE_INTERP, 5.0f);
    this->timer = 0;
    this->blurEffectSpawnLock = -1;
...
void EnIk_SetupEndHorizontalAttack(Actor_EnIk* this) {
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleEndHorizontalAttackAnim, (this->drawArmorFlags) ? 2.0f : 1.0f, 0.0f,
                     Animation_GetLastFrame((void*)gIronKnuckleHorizontalAttackAnim), ANIMMODE_ONCE_INTERP, -4.0f);
...
void EnIk_SetupBlock(Actor_EnIk* this) {
    this->actor.speed = 0.0f;
    Animation_Change(&this->skelAnime, (void*)gIronKnuckleBlockAnim, 2.0f, 0.0f,
                     Animation_GetLastFrame((void*)gIronKnuckleBlockAnim), ANIMMODE_ONCE, -2.0f);
    this->timer = 20;
...
void EnIk_SetupReactToAttack(Actor_EnIk* this, s32 arg1) {
    ...
    if (ABS_ALT(temp_v0) <= 0x4000) {
        Animation_MorphToPlayOnce(&this->skelAnime, (void*)gIronKnuckleFrontHitAnim, -4.0f);
    } else {
        Animation_MorphToPlayOnce(&this->skelAnime, (void*)gIronKnuckleBackHitAnim, -4.0f);
    }
...
void EnIk_SetupDie(Actor_EnIk* this) {
    this->actor.speed = 0.0f;
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)gIronKnuckleDeathAnim, -4.0f);
    this->timer = 24;
...
void EnIk_SetupFrozen(Actor_EnIk* this) {
...
void EnIk_UpdateDamage(Actor_EnIk* this, PlayState* play) {
    ...
    if (this->colliderTris.base.acFlags & AC_BOUNCED) {
        f32 frame = Animation_GetLastFrame((void*)gIronKnuckleBlockAnim) - 2.0f;
...
void EnIk_Update(Actor_EnIk* this, PlayState* play) {
    ...
    Actor_UpdateBgCheckInfo(play, &this->actor, 75.0f, 30.0f, 30.0f,
                            UPDBGCHECKINFO_FLAG_MM_1 | UPDBGCHECKINFO_FLAG_MM_4 | UPDBGCHECKINFO_FLAG_MM_8 |
                                UPDBGCHECKINFO_FLAG_MM_10);
...
s32 EnIk_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor_EnIk* this) {
    if (this->drawArmorFlags != 0) {
...
void EnIk_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor_EnIk* this) {
...
void EnIk_UpdateArmorDraw(Actor_EnIk* this, PlayState* play) {
    Gfx* gfxOpa;
    Gfx* gfxXlu;
    s32 sp54;
    IronKnuckleEffect* ikEffect;
...
void EnIk_Draw(Actor_EnIk* this, PlayState* play) {
    ...
    gfx = POLY_XLU_DISP;
    gSPDisplayList(&gfx[0], gSetupDLs[25]); // FIXME SETUPDL_25
    POLY_XLU_DISP = &gfx[1];
    gfx = POLY_OPA_DISP;
    gSPDisplayList(&gfx[0], gSetupDLs[25]); // FIXME SETUPDL_25
...
OVL_INFO_ACTOR(ACTOR_EN_IK, Actor_EnIk_Init);
