...
void func_8093E8A0(Actor_EnGoroiwa* this) {
...
void func_8093E91C(Actor_EnGoroiwa* this) {
    this->unk_1DC = this->actor.scale.x * 595.0f;
}

void func_8093E938(Actor_EnGoroiwa* this) {
...
void func_8093EAB0(Actor_EnGoroiwa* this, u8 arg0) {
    this->unk_1E5 &= ~7;
    this->unk_1E5 |= arg0;
}
...
void func_8093EC50(Actor_EnGoroiwa* this) {
...
void func_8093ECD4(Actor_EnGoroiwa* this) {
...
void func_8093ED80(Actor_EnGoroiwa* this) {
    this->unk_1D6 = this->unk_1D8;
    this->unk_1D8 += this->unk_1DA;
    func_8093ECD4(this);
}

void func_8093EDB0(Actor_EnGoroiwa* this) {
...
void func_8093EE64(Actor_EnGoroiwa* this, s32 arg1) {
...
void func_8093EEBC(Actor_EnGoroiwa* this) {
    this->unk_1B4.x = 1.0f;
    this->unk_1C4 = 1.0f;
    this->unk_1A8.x = 1.0f;
}

s32 func_8093EEDC(Actor_EnGoroiwa* this) {
...
s32 func_8093F34C(Actor_EnGoroiwa* this) {
    Vec3s* temp_v0;
    f32 tempX;
    f32 tempZ;
    f32 x;
...
s32 func_8093F498(Actor_EnGoroiwa* this) {
    f32 temp_f0;
    Vec3f sp2C;
...
s32 func_8093F5EC(Actor_EnGoroiwa* this) {
    ...
    if ((this->actor.velocity.y < 0.0f) && (this->actor.world.pos.y <= sp7C)) {
        if (this->unk_1CA == 0) {
            if (this->actor.xzDistToPlayer < 400.0f) {
                s16 quakeIndex = Quake_Request(GET_ACTIVE_CAM(play), 3);
...
void func_8093FC00(Actor_EnGoroiwa* this) {
    s32 params = ENGOROIWA_GET_300(&this->actor);
            ...
            switch (ENGOROIWA_GET_400(&this->actor)) {
                case ENGOROIWA_400_1:
                    Actor_UpdateBgCheckInfo(play, &this->actor, 0.0f, 0.0f, 0.0f,
                                            UPDBGCHECKINFO_FLAG_MM_4 | UPDBGCHECKINFO_FLAG_MM_8 | UPDBGCHECKINFO_FLAG_MM_10);
                    break;
