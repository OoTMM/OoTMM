...
void Boss04_Init(Actor_Boss04* this, PlayState* play);
void Boss04_Destroy(Actor_Boss04* this, PlayState* play);
void Boss04_Update(Actor_Boss04* this, PlayState* play);
void Boss04_Draw(Actor_Boss04* this, PlayState* play);

void func_809EC544(Actor_Boss04* this);
void func_809EC568(Actor_Boss04* this, PlayState* play);
void func_809ECD00(Actor_Boss04* this, PlayState* play);
void func_809ECD18(Actor_Boss04* this, PlayState* play);
void func_809ECEF4(Actor_Boss04* this);
void func_809ECF58(Actor_Boss04* this, PlayState* play);
void func_809ED224(Actor_Boss04* this);
void func_809ED2A0(Actor_Boss04* this, PlayState* play);
...
void Boss04_Init(Actor_Boss04* this, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)gWartSkel, (void*)gWartIdleAnim, this->jointTable, this->morphTable,
                       WART_LIMB_MAX);
    ...
    Actor_UpdateBgCheckInfo(play, &this->actor, 35.0f, 60.0f, 60.0f, UPDBGCHECKINFO_FLAG_MM_4);

    if ((KREG(64) != 0) || MM_CHECK_EVENT_INF(EVENTINF_INTRO_CS_WATCHED_WART)) {
...
void func_809EC568(Actor_Boss04* this, PlayState* play) {
    ...
    switch (this->unk_708) {
        case 0:
            ...
            if ((player->stateFlags1 & PLAYER_STATE1_MM_100000) && (this->actor.projectedPos.z > 0.0f) &&
                ...
                if ((this->unk_704 >= 15) && (CutsceneManager_GetCurrentCsId() == CS_ID_NONE)) {
                    ...
                    boss = play->actorCtx.actors[ACTORCAT_BOSS].first;
                    while (boss != NULL) {
        ...
        case 12:
            ...
            if (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND_TOUCH) {
                ...
                Actor_Spawn(&play->actorCtx, play, ACTOR_EN_CLEAR_TAG, this->actor.world.pos.x, this->actor.world.pos.y,
                            this->actor.world.pos.z, 0, 0, 0, CLEAR_TAG_SPLASH); // FIXME CLEAR_TAG_PARAMS(CLEAR_TAG_SPLASH)
        ...
        case 3:
            ...
            if (this->unk_704 > 140) {
                ...
                MM_SET_EVENT_INF(EVENTINF_INTRO_CS_WATCHED_WART);
            }
            break;
    }
...
void func_809ED2A0(Actor_Boss04* this, PlayState* play) {
    ...
    if ((this->unk_1F8 == 2) || (this->unk_1F8 == 5)) {
        Actor_Spawn(&play->actorCtx, play, ACTOR_EN_CLEAR_TAG, this->actor.world.pos.x, this->actor.world.pos.y,
                    this->actor.world.pos.z, 0, 0, 0, CLEAR_TAG_LARGE_EXPLOSION); // FIXME CLEAR_TAG_PARAMS(CLEAR_TAG_LARGE_EXPLOSION)
...
void func_809ED50C(Actor_Boss04* this) {
    s32 i;
...
void Boss04_Update(Actor_Boss04* this, PlayState* play) {
    ...
    if (KREG(63) == 0) {
        ...
        Actor_UpdateBgCheckInfo(play, &this->actor, 100.0f, 120.0f, 200.0f,
                                UPDBGCHECKINFO_FLAG_MM_1 | UPDBGCHECKINFO_FLAG_MM_4);
        this->actor.world.pos.y += 100.0f;
        this->actor.prevPos.y += 100.0f;
    }
...
s32 Boss04_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor_Boss04* this) {
...
void Boss04_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor_Boss04* this) {
...
void Boss04_Draw(Actor_Boss04* this, PlayState* play) {
    ...
    if (this->actionFunc != func_809EC568) {
        ...
        gSPDisplayList(POLY_XLU_DISP++, (void*)gWartShadowMaterialDL);
        ...
        gSPDisplayList(POLY_XLU_DISP++, (void*)gWartShadowModelDL);
    }
...
OVL_INFO_ACTOR(ACTOR_BOSS_04, Actor_Boss04_InitVars);
