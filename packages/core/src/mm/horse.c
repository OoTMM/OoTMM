...
static int Horse_IsValidEntrance(u32 entranceId)
{
    ...
    case ENTR_MM_TERMINA_FIELD_FROM_ROAD_TO_SNOWHEAD:
    ...
    case ENTR_MM_MILK_ROAD_FROM_GORMAN_TRACK_BARRIER:
    ...
    /* Gorman track */
    case ENTR_MM_GORMAN_TRACK_UNK1:
    case ENTR_MM_GORMAN_TRACK_UNK2:
    case ENTR_MM_GORMAN_TRACK_UNK3:
    case ENTR_MM_GORMAN_TRACK_UNK4:
...
{
    if (!Horse_IsValidEntrance(gSave.entranceIndex))
        gHorseIsMounted = 0;
