...
#define gOotSilverRupeeFlags1       SAVE_EXTRA_RECORD(u32,              14)
#define gOotSilverRupeeFlags2       SAVE_EXTRA_RECORD(u32,              15)
#define gOotSilverRupeeFlags3       SAVE_EXTRA_RECORD(u32,              16)
#define gOotSilverRupeeFlags4       SAVE_EXTRA_RECORD(u32,              17)
#define gOotSilverRupeeCounts1      SAVE_EXTRA_RECORD(u32,              18)
#define gOotSilverRupeeCounts2      SAVE_EXTRA_RECORD(u32,              19)
#define gOotSilverRupeeCounts3      SAVE_EXTRA_RECORD(u32,              20)
#define gOotSilverRupeeCounts4      SAVE_EXTRA_RECORD(u32,              21)
#define gOotSilverRupeeCounts5      SAVE_EXTRA_RECORD(u32,              22)
#define gTriforceCount              SAVE_EXTRA_RECORD(u32,              23)
