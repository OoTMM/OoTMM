...
#define gOotExtraScrubsLo           SAVE_EXTRA_RECORD(u32,              10)
#define gOotExtraScrubsHi           SAVE_EXTRA_RECORD(u32,              11)
#define gOotExtraTradeSave          SAVE_EXTRA_RECORD(OotExtraTrade,    12)
#define gMmOwlFlags                 SAVE_EXTRA_RECORD(u32,              13)
#define gSaveLedgerBase             SAVE_EXTRA_RECORD(u32,              14)
#define gMmExtraFlags3              SAVE_EXTRA_RECORD(MmExtraFlags3,    15)
#define gOotSilverRupeeFlags1       SAVE_EXTRA_RECORD(u32,              16)
#define gOotSilverRupeeFlags2       SAVE_EXTRA_RECORD(u32,              17)
#define gOotSilverRupeeFlags3       SAVE_EXTRA_RECORD(u32,              18)
#define gOotSilverRupeeFlags4       SAVE_EXTRA_RECORD(u32,              19)
#define gOotSilverRupeeCounts1      SAVE_EXTRA_RECORD(u32,              20)
#define gOotSilverRupeeCounts2      SAVE_EXTRA_RECORD(u32,              21)
#define gOotSilverRupeeCounts3      SAVE_EXTRA_RECORD(u32,              22)
#define gOotSilverRupeeCounts4      SAVE_EXTRA_RECORD(u32,              23)
#define gOotSilverRupeeCounts5      SAVE_EXTRA_RECORD(u32,              24)
#define gTriforceCount              SAVE_EXTRA_RECORD(u32,              25)
