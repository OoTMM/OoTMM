...
#define DRAWGI_NOTE                         0xae
#define DRAWGI_OOT_STICK_UPGRADE            0xaf
#define DRAWGI_OOT_STICK_UPGRADE2           0xb0
#define DRAWGI_OOT_NUT_UPGRADE              0xb1
#define DRAWGI_OOT_NUT_UPGRADE2             0xb2
#define DRAWGI_MM_SPIN_UPGRADE              0xb3
#define DRAWGI_MM_STRAY_FAIRY               0xb4
#define DRAWGI_MM_GS_TOKEN_SWAMP            0xb5
#define DRAWGI_MM_GS_TOKEN_OCEAN            0xb6
#define DRAWGI_MM_STRAY_FAIRY_WF            0xb7
#define DRAWGI_MM_STRAY_FAIRY_SH            0xb8
#define DRAWGI_MM_STRAY_FAIRY_GB            0xb9
#define DRAWGI_MM_STRAY_FAIRY_ST            0xba
#define DRAWGI_MM_STRAY_FAIRY_TOWN          0xbb
#define DRAWGI_MILK                         0xbc
#define DRAWGI_MM_CHATEAU                   0xbd
#define DRAWGI_MM_OWL                       0xbe
#define DRAWGI_TRIFORCE                     0xbf
#define DRAWGI_OOT_RUPEE_SILVER             0xc0
#define DRAWGI_SOUL                         0xc1
#define DRAWGI_SKELETON_KEY                 0xc2
#define DRAWGI_COIN_YELLOW                  0xc3
#define DRAWGI_COIN_RED                     0xc4
#define DRAWGI_COIN_GREEN                   0xc5
