...
const SHARED_ITEMS_OOT = new Map([
  ...
  ['SHARED_SONG_EMPTINESS_PROGRESSIVE_NOTE', 'OOT_SONG_EMPTINESS_PROGRESSIVE_NOTE'],
]);
...
const SHARED_ITEMS_MM = new Map([
  ...
  ['SHARED_SONG_EPONA_PROGRESSIVE_NOTE',   'MM_SONG_EPONA_PROGRESSIVE_NOTE'],
  ['SHARED_SONG_STORMS_PROGRESSIVE_NOTE',     'MM_SONG_STORMS_PROGRESSIVE_NOTE'],
  ['SHARED_SONG_SUN_PROGRESSIVE_NOTE',  'MM_SONG_SUN_PROGRESSIVE_NOTE'],
  ['SHARED_SONG_TIME_PROGRESSIVE_NOTE', 'MM_SONG_TIME_PROGRESSIVE_NOTE'],
