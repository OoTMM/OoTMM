...
const SHARED_ITEMS_OOT = new Map([
  ...
  ['SHARED_SONG_EPONA_C_UP_1',   'OOT_SONG_EPONA_C_UP_1'],
  ['SHARED_SONG_EPONA_C_LEFT_1', 'OOT_SONG_EPONA_C_LEFT_1'],
  ['SHARED_SONG_EPONA_C_RIGHT_1','OOT_SONG_EPONA_C_RIGHT_1'],
  ['SHARED_SONG_EPONA_C_UP_2',   'OOT_SONG_EPONA_C_UP_2'],
  ['SHARED_SONG_EPONA_C_LEFT_2', 'OOT_SONG_EPONA_C_LEFT_2'],
  ['SHARED_SONG_EPONA_C_RIGHT_2','OOT_SONG_EPONA_C_RIGHT_2'],
  ['SHARED_SONG_STORMS_A_1',     'OOT_SONG_STORMS_A_1'],
  ['SHARED_SONG_STORMS_C_DOWN_1','OOT_SONG_STORMS_C_DOWN_1'],
  ['SHARED_SONG_STORMS_C_UP_1',  'OOT_SONG_STORMS_C_UP_1'],
  ['SHARED_SONG_STORMS_A_2',     'OOT_SONG_STORMS_A_2'],
  ['SHARED_SONG_STORMS_C_DOWN_2','OOT_SONG_STORMS_C_DOWN_2'],
  ['SHARED_SONG_STORMS_C_UP_2',  'OOT_SONG_STORMS_C_UP_2'],
  ['SHARED_SONG_SUN_C_RIGHT_1',  'OOT_SONG_SUN_C_RIGHT_1'],
  ['SHARED_SONG_SUN_C_DOWN_1',   'OOT_SONG_SUN_C_DOWN_1'],
  ['SHARED_SONG_SUN_C_UP_1',     'OOT_SONG_SUN_C_UP_1'],
  ['SHARED_SONG_SUN_C_RIGHT_2',  'OOT_SONG_SUN_C_RIGHT_2'],
  ['SHARED_SONG_SUN_C_DOWN_2',   'OOT_SONG_SUN_C_DOWN_2'],
  ['SHARED_SONG_SUN_C_UP_2',     'OOT_SONG_SUN_C_UP_2'],
  ['SHARED_SONG_TIME_C_RIGHT_1', 'OOT_SONG_TIME_C_RIGHT_1'],
  ['SHARED_SONG_TIME_A_1',       'OOT_SONG_TIME_A_1'],
  ['SHARED_SONG_TIME_C_DOWN_1',  'OOT_SONG_TIME_C_DOWN_1'],
  ['SHARED_SONG_TIME_C_RIGHT_2', 'OOT_SONG_TIME_C_RIGHT_2'],
  ['SHARED_SONG_TIME_A_2',       'OOT_SONG_TIME_A_2'],
  ['SHARED_SONG_TIME_C_DOWN_3',  'OOT_SONG_TIME_C_DOWN_3'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_1', 'OOT_SONG_EMPTINESS_C_RIGHT_1'],
  ['SHARED_SONG_EMPTINESS_C_LEFT_1',  'OOT_SONG_EMPTINESS_C_LEFT_1'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_2', 'OOT_SONG_EMPTINESS_C_RIGHT_2'],
  ['SHARED_SONG_EMPTINESS_C_DOWN',  'OOT_SONG_EMPTINESS_C_DOWN'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_3', 'OOT_SONG_EMPTINESS_C_RIGHT_3'],
  ['SHARED_SONG_EMPTINESS_C_UP',      'OOT_SONG_EMPTINESS_C_UP'],
  ['SHARED_SONG_EMPTINESS_C_LEFT_2',  'OOT_SONG_EMPTINESS_C_LEFT_2'],
]);
...
const SHARED_ITEMS_MM = new Map([
  ...
  ['SHARED_SONG_EPONA_C_UP_1',   'MM_SONG_EPONA_C_UP_1'],
  ['SHARED_SONG_EPONA_C_LEFT_1', 'MM_SONG_EPONA_C_LEFT_1'],
  ['SHARED_SONG_EPONA_C_RIGHT_1','MM_SONG_EPONA_C_RIGHT_1'],
  ['SHARED_SONG_EPONA_C_UP_2',   'MM_SONG_EPONA_C_UP_2'],
  ['SHARED_SONG_EPONA_C_LEFT_2', 'MM_SONG_EPONA_C_LEFT_2'],
  ['SHARED_SONG_EPONA_C_RIGHT_2','MM_SONG_EPONA_C_RIGHT_2'],
  ['SHARED_SONG_STORMS_A_1',     'MM_SONG_STORMS_A_1'],
  ['SHARED_SONG_STORMS_C_DOWN_1','MM_SONG_STORMS_C_DOWN_1'],
  ['SHARED_SONG_STORMS_C_UP_1',  'MM_SONG_STORMS_C_UP_1'],
  ['SHARED_SONG_STORMS_A_2',     'MM_SONG_STORMS_A_2'],
  ['SHARED_SONG_STORMS_C_DOWN_2','MM_SONG_STORMS_C_DOWN_2'],
  ['SHARED_SONG_STORMS_C_UP_2',  'MM_SONG_STORMS_C_UP_2'],
  ['SHARED_SONG_SUN_C_RIGHT_1',  'MM_SONG_SUN_C_RIGHT_1'],
  ['SHARED_SONG_SUN_C_DOWN_1',   'MM_SONG_SUN_C_DOWN_1'],
  ['SHARED_SONG_SUN_C_UP_1',     'MM_SONG_SUN_C_UP_1'],
  ['SHARED_SONG_SUN_C_RIGHT_2',  'MM_SONG_SUN_C_RIGHT_2'],
  ['SHARED_SONG_SUN_C_DOWN_2',   'MM_SONG_SUN_C_DOWN_2'],
  ['SHARED_SONG_SUN_C_UP_2',     'MM_SONG_SUN_C_UP_2'],
  ['SHARED_SONG_TIME_C_RIGHT_1', 'MM_SONG_TIME_C_RIGHT_1'],
  ['SHARED_SONG_TIME_A_1',       'MM_SONG_TIME_A_1'],
  ['SHARED_SONG_TIME_C_DOWN_1',  'MM_SONG_TIME_C_DOWN_1'],
  ['SHARED_SONG_TIME_C_RIGHT_2', 'MM_SONG_TIME_C_RIGHT_2'],
  ['SHARED_SONG_TIME_A_2',       'MM_SONG_TIME_A_2'],
  ['SHARED_SONG_TIME_C_DOWN_3',  'MM_SONG_TIME_C_DOWN_3'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_1', 'MM_SONG_EMPTINESS_C_RIGHT_1'],
  ['SHARED_SONG_EMPTINESS_C_LEFT_1',  'MM_SONG_EMPTINESS_C_LEFT_1'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_2', 'MM_SONG_EMPTINESS_C_RIGHT_2'],
  ['SHARED_SONG_EMPTINESS_C_DOWN',  'MM_SONG_EMPTINESS_C_DOWN'],
  ['SHARED_SONG_EMPTINESS_C_RIGHT_3', 'MM_SONG_EMPTINESS_C_RIGHT_3'],
  ['SHARED_SONG_EMPTINESS_C_UP',      'MM_SONG_EMPTINESS_C_UP'],
  ['SHARED_SONG_EMPTINESS_C_LEFT_2',  'MM_SONG_EMPTINESS_C_LEFT_2'],
]);
