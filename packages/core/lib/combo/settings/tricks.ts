export const TRICKS = {
    ...
    OOT_HIDDEN_GROTTOS: {
      ...
      docLink: "https://www.zeldadungeon.net/wiki/Ocarina_of_Time_Secret_Grottos",
    },
    OOT_MIDO_SKIP: {
      ...
      link: "https://www.youtube.com/watch?v=ll8e7h9vFag&ab_channel=ZeldaSpeedRuns",
    },
    OOT_MAN_ON_ROOF: {
      ...
      link: "https://www.youtube.com/watch?v=3-1BY24Fu-Y&ab_channel=dotzo",
    },
    OOT_BLIND_WASTELAND: {
      ...
      link: "https://www.youtube.com/watch?v=h5_EiPTjdEk&ab_channel=DanielBaamonde",
    },
    OOT_DEKU_SKIP: {
      name: "Deku Tree B1 Skip",
      tooltip: "Child is able to jump to the upper portion of the basement without going around.",
      link: "https://www.youtube.com/watch?v=TSAk3x-zHcI&ab_channel=AnnoyedTortoise",
    },
    OOT_DC_JUMP: {
      ...
      link: "https://www.youtube.com/watch?v=LEvlWAvpqfo&ab_channel=I_Buy_Slingshats",
    },
    OOT_FOREST_HOOK: {
      ...
      link: "https://www.youtube.com/watch?v=Lr3TpVdNg2k&ab_channel=dotzo",
    },
    OOT_HAMMER_WALLS: {
      ...
      link: "https://www.youtube.com/watch?v=R18uZdwXRPA&ab_channel=Numbers",
    },
    OOT_VOLCANO_HOVERS: {
      ...
      link: "https://www.youtube.com/watch?v=rbxaO5lNUTU&ab_channel=StoneeBadLuck",
    },
    OOT_NIGHT_GS: {
    ...
    OOT_DOMAIN_CUCCO: {
      ...
      link: "https://www.youtube.com/watch?v=shR5yahUifs&ab_channel=EmptyGarbageCan",
    },
    OOT_DOMAIN_HOVER: {
      ...
      link: "https://www.youtube.com/watch?v=y4iK6uiw0Xs&ab_channel=ZeldaSpeedRuns",
    },
    OOT_WATER_LONGSHOT: {
    ...
    OOT_SAND_RIVER_NOTHING: {
      ...
      link: "https://www.youtube.com/watch?v=PLHJY1KRvtg&ab_channel=dotzo",
    },
    OOT_SHADOW_FIRE_ARROW: {
      ...
      link: "https://www.youtube.com/watch?v=im3IXe__8ww&ab_channel=Exodus122",
    },
    OOT_KZ_SKIP: {
      name: "Skip King Zora as Adult",
      tooltip: "Adult can jump onto the fence next to King Zora and then jump down behind him.",
      link: "https://www.youtube.com/watch?v=rfp9MZPgme4&ab_channel=Kryal",
    },
    OOT_LOST_WOODS_ADULT_GS: {
      ...
      link: "https://www.youtube.com/watch?v=YFLxEw2_PBw&ab_channel=dotzo",
    },
    OOT_WINDMILL_HP_NOTHING: {
      ...
      link: "https://www.youtube.com/watch?v=vDl7lr4Ecv8&ab_channel=dotzo",
    },
    OOT_LAB_DIVE_NO_GOLD_SCALE: {
      ...
      link: "https://www.youtube.com/watch?v=7ihH-wBP0PM&ab_channel=dotzo",
    },
    OOT_LAB_WALL_GS: {
      ...
      link: "https://www.youtube.com/watch?v=ThUyxj3psSM&ab_channel=Link98OoT",
    },
    OOT_PASS_COLLISION: {
      ...
      link: "https://www.youtube.com/watch?v=OnnNUZVW8Gw&ab_channel=StoneeBadLuck",
    },
    OOT_DMT_RED_ROCK_GS: {
      ...
      link: "https://www.youtube.com/playlist?list=PL7AtrmSRvw6LAJRTwCEb0VzuOFj9BpPZ-",
    },
    OOT_DEAD_HAND_STICKS: {
      ...
      link: "https://www.youtube.com/watch?v=gROY5Y66xeA&ab_channel=dotzo",
    },
    OOT_BFA_MUDWALLS: {
      ...
      link: "https://www.youtube.com/watch?v=XXAFs1cfRrc&ab_channel=ThatWelshKaren",
    },
    OOT_JABU_BOSS_HOVER: {
    ...
    OOT_MQ_ICE_SCARE_HOVER: {
      ...
      link: "https://www.youtube.com/watch?v=RaggmtTEBuM",
    },
    OOT_MQ_GTG_FLAMES: {
    ...
    OOT_SPIRIT_BOSS_CLIMB_NO_HOOK: {
      ...
      link: "https://www.youtube.com/watch?v=hobCEU1bY-s",
    },
    OOT_ZR_FALLS_HOOK: {
    ...
    OOT_ADULT_GALLERY_TT: {
      ...
      tooltip: "Inteded for use with Interior ER. This will allow interiors where you cannot age swap with Child-only checks to be placed in this location.",
      link: "",
    },
    OOT_GTG_CHILD_TT: {
    ...
    MM_ICELESS_IKANA: {
      ...
      link: "https://www.youtube.com/watch?v=VtMx8XIE0tA&ab_channel=yogamoanyo",
    },
    MM_ONE_MASK_STONE_TOWER: {
      ...
      link: "https://www.youtube.com/watch?v=I3xLE1X9Iiw&t=3s&ab_channel=dodo",
    },
    MM_ISTT_EYEGORE: {
      ...
      link: "https://www.youtube.com/watch?v=PxUhL6pombo&list=PLJoiLTDPjgenwpASzbu07cLnUSGZcIUnB&index=52&ab_channel=dodo",
    },
    MM_SCT_NOTHING: {
      name: "South Clock Town Chest with Nothing",
      tooltip: "Climb the roof with a precise jump to access the South Clock town Chest",
      link: "https://www.youtube.com/watch?v=8_tjO86vRsY&ab_channel=PushyMisumi",
    },
    MM_GORON_BOMB_JUMP: {
      ...
      link: "https://www.youtube.com/watch?v=lLMT2-wNs9w&ab_channel=KokiriKid07",
    },
    MM_BOMBER_GUESS: {
      ...
      link: "https://www.youtube.com/watch?v=W6DhLXzJn0A&ab_channel=Tyler%2706",
    },
    MM_CAPTAIN_SKIP: {
    ...
    MM_ISTT_ENTRY_JUMP: {
      ...
      link: "https://www.youtube.com/watch?v=UAG9jbjKwek&ab_channel=Gigopler",
    },
    MM_HARD_HOOKSHOT: {
    ...
    MM_PALACE_GUARD_SKIP: {
      ...
      link: "https://www.youtube.com/watch?v=-4F9lzES7tM&ab_channel=Pokemongenius88",
    },
    MM_SHT_FIRELESS: {
      name: "Complete Snowhead Temple without Fire Arrows",
      tooltip: "Using torches and jumps, melt the ice with normal arrows",
      link: "https://youtu.be/arkzqsYWHWg?list=PL0NLeF-0sduxYgyvvamWsX9IfZpd4smNr",
    },
    MM_SHT_STICKS_RUN: {
      ...
      link: "https://www.youtube.com/watch?v=vuP_vRb6ZTI&ab_channel=Pokemongenius88",
    },
    MM_SHT_PILLARLESS: {
      ...
      link: "https://youtube.com/clip/UgkxwCrliqwRiCbljfpozhmsnlzVwSUaAI0N",
    },
    MM_KEG_EXPLOSIVES: {
    ...
    MM_DOG_RACE_CHEST_NOTHING: {
      ...
      link: "https://www.youtube.com/watch?v=DlpBZq579Ds&ab_channel=PushyMisumi",
    },
    MM_MAJORA_LOGIC: {
    ...
    MM_SOUTHERN_SWAMP_SCRUB_HP_GORON: {
      ...
      link: "https://www.youtube.com/watch?v=HvH5NaTsf5w&list=PLuteuW9RqeG0NfhzoiZlJ1HQM2BdHftzg&index=5&ab_channel=Pokemongenius88",
    },
    MM_ZORA_HALL_SCRUB_HP_NO_DEKU: {
      ...
      link: "https://www.youtube.com/playlist?list=PL7AtrmSRvw6JxohRTRK61ZGSvuIL5rq0w",
    },
    MM_ZORA_HALL_DOORS: {
    ...
    MM_IKANA_ROOF_PARKOUR: {
      ...
      link: "https://www.youtube.com/watch?v=9af_q8oYBhA&t=1s",
    },
    MM_IKANA_PILLAR_TO_ENTRANCE: {
      name: "Jump from Ikana Castle's roof pillars to get over the entrance sun block with Nothing",
      tooltip: "",
      link: "",
    },
    MM_POST_OFFICE_GAME: {
      ...
      link: "https://www.youtube.com/watch?v=bAlGLPkp8go&ab_channel=ZZtheCat2",
    },
    MM_WELL_HSW: {
    ...
    MM_GBT_ENTRANCE_BOW: {
      ...
      tooltip: "",
      link: "https://www.youtube.com/watch?v=McXOXYxYiqw",
    },
    MM_OOB_MOVEMENT: {
    ...
    MM_BIO_BABA_LUCK: {
      name: "Get lucky with the Bio Baba Grotto item landing on a lilypad",
      tooltip: "",
      link: "",
    },
    MM_WF_SHRINE_HOVERS: {
    ...
    MM_GYORG_POTS_DIVE: {
      name: "Dive down to the pots in Gyorg's Lair, break the pots with a Blast Mask explosion, and collect the item before it before it lands on the ground.",
      tooltip: "",
      link: "",
    },
    MM_STT_POT_BOMBCHU_DIVE: {
      name: "Position yourself precisely to launch a Bombchu that breaks the shallow underwater pots, then collect the items with a dive.",
      tooltip: "",
      link: "",
    },
    MM_STOCK_POT_WAIT: {
