export const SETTINGS = [{
  ...
  category: 'entrances',
  type: 'boolean',
  description: 'Shuffle additional, more complex interiors. These include:<br>- OOT: Links House, Temple of Time, Windmill<br>- MM: Stock Pot Inn, Astral Observatory/Bombers Hideout, Swamp Tourist Hut, Ikana Spring Cave',
  default: false
}] as const;
