...
const ITEM_NAMES: {[k in ItemID]: string} = {
  ...
  MM_SONG_AWAKENING_PROGRESSIVE_NOTE: "Sonata of Awakening Progressive Note",
  MM_SONG_EMPTINESS: "Elegy of Emptiness (MM)",
  MM_SONG_EMPTINESS_PROGRESSIVE_NOTE: "Elegy of Emptiness (MM) Progressive Note",
  ...
  MM_SONG_HEALING_PROGRESSIVE_NOTE: "Song of Healing Progressive Note",
  MM_SONG_ORDER: "Oath to Order",
  MM_SONG_ORDER_PROGRESSIVE_NOTE: "Oath to Order Progressive Note",
  MM_SONG_SOARING: "Song of Soaring",
  MM_SONG_SOARING_PROGRESSIVE_NOTE: "Song of Soaring Progressive Note",
  MM_SONG_STORMS: "Song of Storms (MM)",
  MM_SONG_STORMS_PROGRESSIVE_NOTE: "Song of Storms (MM) Progressive Note",
  MM_SONG_SUN: "Sun's Song (MM)",
  MM_SONG_SUN_PROGRESSIVE_NOTE: "Sun's Song (MM) Progressive Note",
  MM_SONG_TIME: "Song of Time (MM)",
  MM_SONG_TIME_PROGRESSIVE_NOTE: "Song of Time (MM) Progressive Note",
  MM_SONG_ZORA: "New Wave Bossa Nova",
  MM_SONG_ZORA_PROGRESSIVE_NOTE: "New Wave Bossa Nova Progressive Note",
  ...
  OOT_SONG_EPONA_PROGRESSIVE_NOTE: "Epona's Song (OoT) Progressive Note",
  OOT_SONG_SARIA: "Saria's Song",
  OOT_SONG_SARIA_PROGRESSIVE_NOTE: "Saria's Song Progressive Note",
  OOT_SONG_STORMS: "Song of Storms (OoT)",
  OOT_SONG_STORMS_PROGRESSIVE_NOTE: "Song of Storms (OoT) Progressive Note",
  OOT_SONG_SUN: "Sun's Song (OoT)",
  OOT_SONG_SUN_PROGRESSIVE_NOTE: "Sun's Song (OoT) Progressive Note",
  OOT_SONG_TIME: "Song of Time (OoT)",
  OOT_SONG_TIME_PROGRESSIVE_NOTE: "Song of Time (OoT) Progressive Note",
  OOT_SONG_TP_FIRE: "Bolero of Fire",
  OOT_SONG_TP_FIRE_PROGRESSIVE_NOTE: "Bolero of Fire Progressive Note",
  OOT_SONG_TP_FOREST: "Minuet of Forest",
  OOT_SONG_TP_FOREST_PROGRESSIVE_NOTE: "Minuet of Forest Progressive Note",
  OOT_SONG_TP_LIGHT: "Prelude of Light",
  OOT_SONG_TP_LIGHT_PROGRESSIVE_NOTE: "Prelude of Light Progressive Note",
  OOT_SONG_TP_SHADOW: "Nocturne of Shadow",
  OOT_SONG_TP_SHADOW_PROGRESSIVE_NOTE: "Nocturne of Shadow Progressive Note",
  OOT_SONG_TP_SPIRIT: "Requiem of Spirit",
  OOT_SONG_TP_SPIRIT_PROGRESSIVE_NOTE: "Requiem of Spirit Progressive Note",
  OOT_SONG_TP_WATER: "Serenade of Water",
  OOT_SONG_TP_WATER_PROGRESSIVE_NOTE: "Serenade of Water Progressive Note",
  OOT_SONG_ZELDA: "Zelda's Lullaby",
  OOT_SONG_ZELDA_PROGRESSIVE_NOTE: "Zelda's Lullaby Progressive Note",
  ...
  SHARED_SONG_EPONA_PROGRESSIVE_NOTE: "Epona's Song Progressive Note",
  SHARED_SONG_STORMS: "Song of Storms",
  SHARED_SONG_STORMS_PROGRESSIVE_NOTE: "Song of Storms Progressive Note",
  SHARED_SONG_SUN: "Sun's Song",
  SHARED_SONG_SUN_PROGRESSIVE_NOTE: "Sun's Song Progressive Note",
  SHARED_SONG_TIME: "Song of Time",
  SHARED_SONG_TIME_PROGRESSIVE_NOTE: "Song of Time Progressive Note",
  ...
  OOT_SONG_EMPTINESS_PROGRESSIVE_NOTE: "Elegy of Emptiness (OoT) Progressive Note",
  SHARED_SONG_EMPTINESS: "Elegy of Emptiness",
  SHARED_SONG_EMPTINESS_PROGRESSIVE_NOTE: "Elegy of Emptiness Progressive Note",
