...
const ITEM_NAMES: {[k in ItemID]: string} = {
  ...
  MM_SONG_AWAKENING_C_UP_1: "Sonata of Awakening 1st C Up",
  MM_SONG_AWAKENING_C_LEFT_1: "Sonata of Awakening 1st C Left",
  MM_SONG_AWAKENING_C_UP_2: "Sonata of Awakening 2nd C Up",
  MM_SONG_AWAKENING_C_LEFT_2: "Sonata of Awakening 2nd C Left",
  MM_SONG_AWAKENING_A_1: "Sonata of Awakening 1st A",
  MM_SONG_AWAKENING_C_RIGHT: "Sonata of Awakening C Right",
  MM_SONG_AWAKENING_A_2: "Sonata of Awakening 2nd A",
  MM_SONG_EMPTINESS: "Elegy of Emptiness (MM)",
  MM_SONG_EMPTINESS_C_RIGHT_1: "Elegy of Emptiness (MM) 1st C Right",
  MM_SONG_EMPTINESS_C_LEFT_1: "Elegy of Emptiness (MM) 1st C Left",
  MM_SONG_EMPTINESS_C_RIGHT_2: "Elegy of Emptiness (MM) 2nd C Right",
  MM_SONG_EMPTINESS_C_DOWN: "Elegy of Emptiness (MM) C Down",
  MM_SONG_EMPTINESS_C_RIGHT_3: "Elegy of Emptiness (MM) 3rd C Right",
  MM_SONG_EMPTINESS_C_UP: "Elegy of Emptiness (MM) C Up",
  MM_SONG_EMPTINESS_C_LEFT_2: "Elegy of Emptiness (MM) 2nd C Left",
  MM_SONG_EPONA: "Epona's Song (MM)",
  MM_SONG_EPONA_C_UP_1: "Epona's Song (MM) 1st C Up",
  MM_SONG_EPONA_C_LEFT_1: "Epona's Song (MM) 1st C Left",
  MM_SONG_EPONA_C_RIGHT_1: "Epona's Song (MM) 1st C Right",
  MM_SONG_EPONA_C_UP_2: "Epona's Song (MM) 2nd C Up",
  MM_SONG_EPONA_C_LEFT_2: "Epona's Song (MM) 2nd C Left",
  MM_SONG_EPONA_C_RIGHT_2: "Epona's Song (MM) 2nd C Right",
  MM_SONG_GORON_HALF: "Progressive Goron Lullaby",
  MM_SONG_GORON_HALF_A_1: "Goron Lullaby Intro 1st A",
  MM_SONG_GORON_HALF_C_RIGHT_1: "Goron Lullaby Intro 1st C Right",
  MM_SONG_GORON_HALF_C_LEFT_1: "Goron Lullaby Intro 1st C Left",
  MM_SONG_GORON_HALF_A_2: "Goron Lullaby Intro 2nd A",
  MM_SONG_GORON_HALF_C_RIGHT_2: "Goron Lullaby Intro 2nd C Right",
  MM_SONG_GORON_HALF_C_LEFT_2: "Goron Lullaby Intro 2nd C Left",
  MM_SONG_GORON: "Goron Lullaby",
  MM_SONG_GORON_A_1: "Goron Lullaby 1st A",
  MM_SONG_GORON_C_RIGHT_1: "Goron Lullaby 1st C Right",
  MM_SONG_GORON_C_LEFT_1: "Goron Lullaby 1st C Left",
  MM_SONG_GORON_A_2: "Goron Lullaby 2nd A",
  MM_SONG_GORON_C_RIGHT_2: "Goron Lullaby 2nd C Right",
  MM_SONG_GORON_C_LEFT_2: "Goron Lullaby 2nd C Left",
  MM_SONG_GORON_C_RIGHT_3: "Goron Lullaby 3rd C Right",
  MM_SONG_GORON_A_3: "Goron Lullaby 3rd A",
  MM_SONG_HEALING: "Song of Healing",
  MM_SONG_HEALING_C_LEFT_1: "Song of Healing 1st C Left",
  MM_SONG_HEALING_C_RIGHT_1: "Song of Healing 1st C Right",
  MM_SONG_HEALING_C_DOWN_1: "Song of Healing 1st C Down",
  MM_SONG_HEALING_C_LEFT_2: "Song of Healing 2nd C Left",
  MM_SONG_HEALING_C_RIGHT_2: "Song of Healing 2nd C Right",
  MM_SONG_HEALING_C_DOWN_2: "Song of Healing 2nd C Down",
  MM_SONG_ORDER: "Oath to Order",
  MM_SONG_ORDER_C_RIGHT_1: "Oath to Order 1st C Right",
  MM_SONG_ORDER_C_DOWN_1: "Oath to Order 1st C Down",
  MM_SONG_ORDER_A: "Oath to Order A",
  MM_SONG_ORDER_C_DOWN_2: "Oath to Order 2nd C Down",
  MM_SONG_ORDER_C_RIGHT_2: "Oath to Order 2nd C Right",
  MM_SONG_ORDER_C_UP: "Oath to Order C Up",
  MM_SONG_SOARING: "Song of Soaring",
  MM_SONG_SOARING_C_DOWN_1: "Song of Soaring 1st C Down",
  MM_SONG_SOARING_C_LEFT_1: "Song of Soaring 1st C Left",
  MM_SONG_SOARING_C_UP_1: "Song of Soaring 1st C Up",
  MM_SONG_SOARING_C_DOWN_2: "Song of Soaring 2nd C Down",
  MM_SONG_SOARING_C_LEFT_2: "Song of Soaring 2nd C Left",
  MM_SONG_SOARING_C_UP_2: "Song of Soaring 2nd C Up",
  MM_SONG_STORMS: "Song of Storms (MM)",
  MM_SONG_STORMS_A_1: "Song of Storms (MM) 1st A",
  MM_SONG_STORMS_C_DOWN_1: "Song of Storms (MM) 1st C Down",
  MM_SONG_STORMS_C_UP_1: "Song of Storms (MM) 1st C Up",
  MM_SONG_STORMS_A_2: "Song of Storms (MM) 2nd A",
  MM_SONG_STORMS_C_DOWN_2: "Song of Storms (MM) 2nd C Down",
  MM_SONG_STORMS_C_UP_2: "Song of Storms (MM) 2nd C Up",
  MM_SONG_SUN: "Sun's Song (MM)",
  MM_SONG_SUN_C_RIGHT_1: "Sun's Song (MM) 1st C Right",
  MM_SONG_SUN_C_DOWN_1: "Sun's Song (MM) 1st C Down",
  MM_SONG_SUN_C_UP_1: "Sun's Song (MM) 1st C Up",
  MM_SONG_SUN_C_RIGHT_2: "Sun's Song (MM) 2nd C Right",
  MM_SONG_SUN_C_DOWN_2: "Sun's Song (MM) 2nd C Down",
  MM_SONG_SUN_C_UP_2: "Sun's Song (MM) 2nd C Up",
  MM_SONG_TIME: "Song of Time (MM)",
  MM_SONG_TIME_C_RIGHT_1: "Song of Time (MM) 1st C Right",
  MM_SONG_TIME_A_1: "Song of Time (MM) 1st A",
  MM_SONG_TIME_C_DOWN_1: "Song of Time (MM) 1st C Down",
  MM_SONG_TIME_C_RIGHT_2: "Song of Time (MM) 2nd C Right",
  MM_SONG_TIME_A_2: "Song of Time (MM) 2nd A",
  MM_SONG_TIME_C_DOWN_3: "Song of Time (MM) 3rd C Down",
  MM_SONG_ZORA: "New Wave Bossa Nova",
  MM_SONG_ZORA_C_LEFT_1: "New Wave Bossa Nova 1st C Left",
  MM_SONG_ZORA_C_UP: "New Wave Bossa Nova C Up",
  MM_SONG_ZORA_C_LEFT_2: "New Wave Bossa Nova 2nd C Left",
  MM_SONG_ZORA_C_RIGHT_1: "New Wave Bossa Nova 1st C Right",
  MM_SONG_ZORA_C_DOWN: "New Wave Bossa Nova C Down",
  MM_SONG_ZORA_C_LEFT_3: "New Wave Bossa Nova 3rd C Left",
  MM_SONG_ZORA_C_RIGHT_2: "New Wave Bossa Nova 2nd C Right",
  ...
  OOT_SONG_EPONA_C_UP_1: "Epona's Song (OoT) 1st C Up",
  OOT_SONG_EPONA_C_LEFT_1: "Epona's Song (OoT) 1st C Left",
  OOT_SONG_EPONA_C_RIGHT_1: "Epona's Song (OoT) 1st C Right",
  OOT_SONG_EPONA_C_UP_2: "Epona's Song (OoT) 2nd C Up",
  OOT_SONG_EPONA_C_LEFT_2: "Epona's Song (OoT) 2nd C Left",
  OOT_SONG_EPONA_C_RIGHT_2: "Epona's Song (OoT) 2nd C Right",
  OOT_SONG_SARIA: "Saria's Song",
  OOT_SONG_SARIA_C_DOWN_1: "Saria's Song 1st C Down",
  OOT_SONG_SARIA_C_RIGHT_1: "Saria's Song 1st C Right",
  OOT_SONG_SARIA_C_LEFT_1: "Saria's Song 1st C Left",
  OOT_SONG_SARIA_C_DOWN_2: "Saria's Song 2nd C Down",
  OOT_SONG_SARIA_C_RIGHT_2: "Saria's Song 2nd C Right",
  OOT_SONG_SARIA_C_LEFT_2: "Saria's Song 2nd C Left",
  OOT_SONG_STORMS: "Song of Storms (OoT)",
  OOT_SONG_STORMS_A_1: "Song of Storms (OoT) 1st A",
  OOT_SONG_STORMS_C_DOWN_1: "Song of Storms (OoT) 1st C Down",
  OOT_SONG_STORMS_C_UP_1: "Song of Storms (OoT) 1st C Up",
  OOT_SONG_STORMS_A_2: "Song of Storms (OoT) 2nd A",
  OOT_SONG_STORMS_C_DOWN_2: "Song of Storms (OoT) 2nd C Down",
  OOT_SONG_STORMS_C_UP_2: "Song of Storms (OoT) 2nd C Up",
  OOT_SONG_SUN: "Sun's Song (OoT)",
  OOT_SONG_SUN_C_RIGHT_1: "Sun's Song (OoT) 1st C Right",
  OOT_SONG_SUN_C_DOWN_1: "Sun's Song (OoT) 1st C Down",
  OOT_SONG_SUN_C_UP_1: "Sun's Song (OoT) 1st C Up",
  OOT_SONG_SUN_C_RIGHT_2: "Sun's Song (OoT) 2nd C Right",
  OOT_SONG_SUN_C_DOWN_2: "Sun's Song (OoT) 2nd C Down",
  OOT_SONG_SUN_C_UP_2: "Sun's Song (OoT) 2nd C Up",
  OOT_SONG_TIME: "Song of Time (OoT)",
  OOT_SONG_TIME_C_RIGHT_1: "Song of Time (OoT) 1st C Right",
  OOT_SONG_TIME_A_1: "Song of Time (OoT) 1st A",
  OOT_SONG_TIME_C_DOWN_1: "Song of Time (OoT) 1st C Down",
  OOT_SONG_TIME_C_RIGHT_2: "Song of Time (OoT) 2nd C Right",
  OOT_SONG_TIME_A_2: "Song of Time (OoT) 2nd A",
  OOT_SONG_TIME_C_DOWN_3: "Song of Time (OoT) 3rd C Down",
  OOT_SONG_TP_FIRE: "Bolero of Fire",
  OOT_SONG_TP_FIRE_C_DOWN_1: "Bolero of Fire 1st C Down",
  OOT_SONG_TP_FIRE_A_1: "Bolero of Fire 1st A",
  OOT_SONG_TP_FIRE_C_DOWN_2: "Bolero of Fire 2nd C Down",
  OOT_SONG_TP_FIRE_A_2: "Bolero of Fire 2nd A",
  OOT_SONG_TP_FIRE_C_RIGHT_1: "Bolero of Fire 1st C Right",
  OOT_SONG_TP_FIRE_C_RIGHT_2: "Bolero of Fire 2nd C Right",
  OOT_SONG_TP_FOREST: "Minuet of Forest",
  OOT_SONG_TP_FOREST_A: "Minuet of Forest A",
  OOT_SONG_TP_FOREST_C_UP: "Minuet of Forest C Up",
  OOT_SONG_TP_FOREST_C_LEFT_1: "Minuet of Forest 1st C Left",
  OOT_SONG_TP_FOREST_C_RIGHT_1: "Minuet of Forest 1st C Right",
  OOT_SONG_TP_FOREST_C_LEFT_2: "Minuet of Forest 2nd C Left",
  OOT_SONG_TP_FOREST_C_RIGHT_2: "Minuet of Forest 2nd C Right",
  OOT_SONG_TP_LIGHT: "Prelude of Light",
  OOT_SONG_TP_LIGHT_C_UP_1: "Prelude of Light 1st C Up",
  OOT_SONG_TP_LIGHT_C_RIGHT_1: "Prelude of Light 1st C Right",
  OOT_SONG_TP_LIGHT_C_UP_2: "Prelude of Light 2nd C Up",
  OOT_SONG_TP_LIGHT_C_RIGHT_2: "Prelude of Light 2nd C Right",
  OOT_SONG_TP_LIGHT_C_LEFT: "Prelude of Light C Left",
  OOT_SONG_TP_LIGHT_C_UP_3: "Prelude of Light 3rd C Up",
  OOT_SONG_TP_SHADOW: "Nocturne of Shadow",
  OOT_SONG_TP_SHADOW_C_LEFT_1: "Nocturne of Shadow 1st C Left",
  OOT_SONG_TP_SHADOW_C_RIGHT_1: "Nocturne of Shadow 1st C Right",
  OOT_SONG_TP_SHADOW_C_RIGHT_2: "Nocturne of Shadow 2nd C Right",
  OOT_SONG_TP_SHADOW_A: "Nocturne of Shadow A",
  OOT_SONG_TP_SHADOW_C_LEFT_2: "Nocturne of Shadow 2nd C Left",
  OOT_SONG_TP_SHADOW_C_RIGHT_3: "Nocturne of Shadow 3rd C Right",
  OOT_SONG_TP_SHADOW_C_DOWN: "Nocturne of Shadow C Down",
  OOT_SONG_TP_SPIRIT: "Requiem of Spirit",
  OOT_SONG_TP_SPIRIT_A_1: "Requiem of Spirit 1st A",
  OOT_SONG_TP_SPIRIT_C_DOWN_1: "Requiem of Spirit 1st C Down",
  OOT_SONG_TP_SPIRIT_A_2: "Requiem of Spirit 2nd A",
  OOT_SONG_TP_SPIRIT_C_RIGHT: "Requiem of Spirit C Right",
  OOT_SONG_TP_SPIRIT_C_DOWN_2: "Requiem of Spirit 2nd C Down",
  OOT_SONG_TP_WATER: "Serenade of Water",
  OOT_SONG_TP_WATER_A: "Serenade of Water A",
  OOT_SONG_TP_WATER_C_DOWN: "Serenade of Water C Down",
  OOT_SONG_TP_WATER_C_RIGHT_1: "Serenade of Water 1st C Right",
  OOT_SONG_TP_WATER_C_RIGHT_2: "Serenade of Water 2nd C Right",
  OOT_SONG_TP_WATER_C_LEFT: "Serenade of Water C Left",
  OOT_SONG_ZELDA: "Zelda's Lullaby",
  OOT_SONG_ZELDA_C_LEFT_1: "Zelda's Lullaby 1st C Left",
  OOT_SONG_ZELDA_C_UP_1: "Zelda's Lullaby 1st C Up",
  OOT_SONG_ZELDA_C_RIGHT_1: "Zelda's Lullaby 1st C Right",
  OOT_SONG_ZELDA_C_LEFT_2: "Zelda's Lullaby 2nd C Left",
  OOT_SONG_ZELDA_C_UP_2: "Zelda's Lullaby 2nd C Up",
  OOT_SONG_ZELDA_C_RIGHT_2: "Zelda's Lullaby 2nd C Right",
  ...
  SHARED_SONG_EPONA_C_UP_1: "Epona's Song 1st C Up",
  SHARED_SONG_EPONA_C_LEFT_1: "Epona's Song 1st C Left",
  SHARED_SONG_EPONA_C_RIGHT_1: "Epona's Song 1st C Right",
  SHARED_SONG_EPONA_C_UP_2: "Epona's Song 2nd C Up",
  SHARED_SONG_EPONA_C_LEFT_2: "Epona's Song 2nd C Left",
  SHARED_SONG_EPONA_C_RIGHT_2: "Epona's Song 2nd C Right",
  SHARED_SONG_STORMS: "Song of Storms",
  SHARED_SONG_STORMS_A_1: "Song of Storms 1st A",
  SHARED_SONG_STORMS_C_DOWN_1: "Song of Storms 1st C Down",
  SHARED_SONG_STORMS_C_UP_1: "Song of Storms 1st C Up",
  SHARED_SONG_STORMS_A_2: "Song of Storms 2nd A",
  SHARED_SONG_STORMS_C_DOWN_2: "Song of Storms 2nd C Down",
  SHARED_SONG_STORMS_C_UP_2: "Song of Storms 2nd C Up",
  SHARED_SONG_SUN: "Sun's Song",
  SHARED_SONG_SUN_C_RIGHT_1: "Sun's Song 1st C Right",
  SHARED_SONG_SUN_C_DOWN_1: "Sun's Song 1st C Down",
  SHARED_SONG_SUN_C_UP_1: "Sun's Song 1st C Up",
  SHARED_SONG_SUN_C_RIGHT_2: "Sun's Song 2nd C Right",
  SHARED_SONG_SUN_C_DOWN_2: "Sun's Song 2nd C Down",
  SHARED_SONG_SUN_C_UP_2: "Sun's Song 2nd C Up",
  SHARED_SONG_TIME: "Song of Time",
  SHARED_SONG_TIME_C_RIGHT_1: "Song of Time 1st C Right",
  SHARED_SONG_TIME_A_1: "Song of Time 1st A",
  SHARED_SONG_TIME_C_DOWN_1: "Song of Time 1st C Down",
  SHARED_SONG_TIME_C_RIGHT_2: "Song of Time 2nd C Right",
  SHARED_SONG_TIME_A_2: "Song of Time 2nd A",
  SHARED_SONG_TIME_C_DOWN_3: "Song of Time 3rd C Down",
  ...
  OOT_SONG_EMPTINESS_C_RIGHT_1: "Elegy of Emptiness (OoT) 1st C Right",
  OOT_SONG_EMPTINESS_C_LEFT_1: "Elegy of Emptiness (OoT) 1st C Left",
  OOT_SONG_EMPTINESS_C_RIGHT_2: "Elegy of Emptiness (OoT) 2nd C Right",
  OOT_SONG_EMPTINESS_C_DOWN: "Elegy of Emptiness (OoT) C Down",
  OOT_SONG_EMPTINESS_C_RIGHT_3: "Elegy of Emptiness (OoT) 3rd C Right",
  OOT_SONG_EMPTINESS_C_UP: "Elegy of Emptiness (OoT) C Up",
  OOT_SONG_EMPTINESS_C_LEFT_2: "Elegy of Emptiness (OoT) 2nd C Left",
  SHARED_SONG_EMPTINESS: "Elegy of Emptiness",
  SHARED_SONG_EMPTINESS_C_RIGHT_1: "Elegy of Emptiness 1st C Right",
  SHARED_SONG_EMPTINESS_C_LEFT_1: "Elegy of Emptiness 1st C Left",
  SHARED_SONG_EMPTINESS_C_RIGHT_2: "Elegy of Emptiness 2nd C Right",
  SHARED_SONG_EMPTINESS_C_DOWN: "Elegy of Emptiness C Down",
  SHARED_SONG_EMPTINESS_C_RIGHT_3: "Elegy of Emptiness 3rd C Right",
  SHARED_SONG_EMPTINESS_C_UP: "Elegy of Emptiness C Up",
  SHARED_SONG_EMPTINESS_C_LEFT_2: "Elegy of Emptiness 2nd C Left",
