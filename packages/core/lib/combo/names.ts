...
const ITEM_NAMES: {[k in ItemID as string]: string} = {
  ...
  OOT_SOUL_ANUBIS: "Soul of Anubis",
  OOT_SOUL_ARMOS: "Soul of Armos (OoT)",
  OOT_SOUL_BABY_DODONGO: "Soul of Baby Dodongos",
  OOT_SOUL_BARINADE: "Soul of Barinade",
  OOT_SOUL_BEAMOS: "Soul of Beamos (OoT)",
  OOT_SOUL_BIRI_BARI: "Soul of Biris/Baris",
  OOT_SOUL_BONGO_BONGO: "Soul of Bongo Bongo",
  OOT_SOUL_BUBBLE: "Soul of Bubbles (OoT)",
  OOT_SOUL_DARK_LINK: "Soul of Dark Link",
  OOT_SOUL_DEAD_HAND: "Soul of Dead Hands",
  ...
  OOT_SOUL_FLARE_DANCER: "Soul of Flare Dancers",
  ...
  OOT_SOUL_MOBLIN: "Soul of Moblins",
  OOT_SOUL_MORPHA: "Soul of Morpha",
  OOT_SOUL_OCTOROK: "Soul of Octoroks (OoT)",
  OOT_SOUL_PARASITE: "Soul of Jabu-Jabu's Parasites",
  OOT_SOUL_PEAHAT: "Soul of Peahats (OoT)",
  OOT_SOUL_PHANTOM_GANON: "Soul of Phantom Ganon",
  OOT_SOUL_QUEEN_GOHMA: "Soul of Queen Gohma",
  OOT_SOUL_REDEAD_GIBDO: "Soul of ReDeads/Gibdos (OoT)",
  OOT_SOUL_SHABOM: "Soul of Shaboms",
  ...
  OOT_SOUL_SPIKE: "Soul of Spikes",
  OOT_SOUL_STALCHILD: "Soul of Stalchildren (OoT)",
  OOT_SOUL_STALFOS: "Soul of Stalfos (OoT)",
  OOT_SOUL_STINGER: "Soul of Stingers",
  OOT_SOUL_TAILPASARN: "Soul of Tailpasarans",
  OOT_SOUL_TEKTITE: "Soul of Tektites (OoT)",
  OOT_SOUL_TORCH_SLUG: "Soul of Torch Slugs",
  OOT_SOUL_TWINROVA: "Soul of Twinrova",
  OOT_SOUL_VOLVAGIA: "Soul of Volvagia",
