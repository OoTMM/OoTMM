...
const ITEM_NAMES: {[k in ItemID]: string} = {
  ...
  OOT_SOUL_NPC_CITIZEN: "Soul of Hylian Citizen",
  ...
  OOT_SOUL_NPC_MARINE_SCIENTIST: 'Soul of Lakeside Professor (OoT)',
  ...
  OOT_SOUL_NPC_OLD_HAG: 'Soul of the Potion Witch (OoT)',
  ...
  OOT_SOUL_NPC_HONEY_DARLING: 'Soul of Honey & Darling (OOo)',
  OOT_SOUL_NPC_ROOFTOP_MAN: 'Soul of Man on Roof',
  OOT_SOUL_NPC_DOG_OWNER: 'Soul of Richard\'s Owner',
  MM_SOUL_NPC_SHOOTING_GALLERY_OWNER: 'Soul of Archery Owners (MM)',
  MM_SOUL_NPC_AROMA: 'Soul of Madame Aroma',
  MM_SOUL_NPC_GORON_CHILD: 'Soul of Baby Goron',
  MM_SOUL_NPC_BOMBCHU_SHOPKEEPER: 'Soul of Bomb Shop Owner (MM)',
  MM_SOUL_NPC_BOMBERS: 'Soul of Bombers Kids',
  MM_SOUL_NPC_BUTLER_DEKU: 'Soul of Deku Butler',
  MM_SOUL_NPC_CITIZEN: 'Soul of Terminian Citizen',
  MM_SOUL_NPC_COMPOSER_BROS: 'Soul of Composer Bros. (MM)',
  MM_SOUL_NPC_DAMPE: 'Soul of Dampe (MM)',
  MM_SOUL_NPC_DARUNIA: 'Soul of Darmani',
  MM_SOUL_NPC_DEKU_KING: 'Soul of Deku King',
  MM_SOUL_NPC_DEKU_PRINCESS: 'Soul of Deku Princess',
  MM_SOUL_NPC_DEKU_PLAYGROUND_SCRUBS: 'Soul of Deku Playgrounds Proprietors',
  MM_SOUL_NPC_GORON_ELDER: 'Soul of Goron Elder',
  MM_SOUL_NPC_EPONA: 'Soul of Epona (MM)',
  MM_SOUL_NPC_FISHERMAN: 'Soul of Fisherman',
  MM_SOUL_NPC_GORMAN_BROS: 'Soul of Gorman Bros',
  MM_SOUL_NPC_GORON_RACERS: 'Soul of Goron Racers',
  MM_SOUL_NPC_GORON_SHOPKEEPER: 'Soul of Goron Shopkeeper (MM)',
  MM_SOUL_NPC_HONEY_DARLING: 'Soul of Honey & Darling (MM)',
  MM_SOUL_NPC_INDIE_GO_GO: 'Soul of Indie Go-Go Band',
  MM_SOUL_NPC_KAFEI: 'Soul of Kafei',
  MM_SOUL_NPC_KEATON: 'Soul of Keaton',
  MM_SOUL_NPC_KOUME_KOTAKE: 'Soul of Koume & Kotake',
  MM_SOUL_NPC_MAYOR_DOTOUR: 'Soul of Mayor Dotour',
  MM_SOUL_NPC_MEDIGORON: 'Soul of Medigoron (MM)',
  MM_SOUL_NPC_MIKAU: 'Soul of Mikau',
  MM_SOUL_NPC_TALON: 'Soul of Mr. Barten',
  MM_SOUL_NPC_MONKEYS: 'Soul of Monkeys',
  MM_SOUL_NPC_ASTRAL_OBVSERVER: 'Soul of ',
  MM_SOUL_NPC_OWL: 'Soul of Kaepora Gaebora (MM)',
  MM_SOUL_NPC_POE_COLLECTOR: 'Soul of Poe Collector (MM)',
  MM_SOUL_NPC_BUSINESS_SCRUBS: 'Soul of Business Scrubs (MM)',
  MM_SOUL_NPC_SEAHORSES: 'Soul of Seahorses',
  MM_SOUL_NPC_BLACKSMITHS: 'Soul of Blacksmiths',
  MM_SOUL_NPC_BOMBCHU_BOWLING_LADY: 'Soul of Treasure Chest Game Lady',
  MM_SOUL_NPC_TINGLE: 'Soul of Tingle',
  MM_SOUL_NPC_TOILET_HAND: 'Soul of Toilet hand',
  MM_SOUL_NPC_FISHING_POND_OWNER: 'Soul of Trading Post Owner',
  MM_SOUL_NPC_ROOFTOP_MAN: 'Soul of Trading Post Part Timer',
  MM_SOUL_NPC_TURTLE: 'Soul of Turtle',
  MM_SOUL_NPC_ZORA: 'Soul of Zoras (MM)',
  MM_SOUL_NPC_ZORA_SHOPKEEPER: 'Soul of Zora Shopkeeper (MM)',
  MM_SOUL_NPC_MALON: 'Soul of Romani & Cremia',
  MM_SOUL_NPC_BEAN_SALESMAN: 'Soul of Beans Salesman (MM)',
  MM_SOUL_NPC_CARPENTERS: 'Soul of Carpenters (MM)',
  MM_SOUL_NPC_ANJU: 'Soul of Anju (MM)',
  MM_SOUL_NPC_DOG: 'Soul of Dogs (MM)',
  MM_SOUL_NPC_CUCCO: 'Soul of Cuccos (MM)',
  MM_SOUL_NPC_GURU_GURU: 'Soul of Guru-Guru (MM)',
  MM_SOUL_NPC_MARINE_SCIENTIST: 'Soul of Marine Scientist (MM)',
  ...
  SHARED_SOUL_ENEMY_CURSE_SPIDER: 'Soul of Spiders of the Curse',
  SHARED_SOUL_NPC_SHOOTING_GALLERY_OWNER: 'Soul of Shooting Gallery Owner',
  SHARED_SOUL_NPC_GORON_CHILD: 'Soul of Young Goron',
  SHARED_SOUL_NPC_BOMBCHU_SHOPKEEPER: 'Soul of Bomb/Bombchu Shopkeeper',
  SHARED_SOUL_NPC_CITIZEN: 'Soul of Hyrulian/Terminian Citizen',
  SHARED_SOUL_NPC_COMPOSER_BROS: 'Soul of Composer Bros.',
  SHARED_SOUL_NPC_DAMPE: 'Soul of Dampé',
  SHARED_SOUL_NPC_DARUNIA: 'Soul of Darunia & Darmani',
  SHARED_SOUL_NPC_EPONA: 'Soul of Epona',
  SHARED_SOUL_NPC_GORON_SHOPKEEPER: 'Soul of Goron Shopkeeper',
  SHARED_SOUL_NPC_HONEY_DARLING: 'Soul of Honey & Darling',
  SHARED_SOUL_NPC_MEDIGORON: 'Soul of Medigoron',
  SHARED_SOUL_NPC_TALON: 'Soul of Talon & Mr. Barten',
  SHARED_SOUL_NPC_OWL: 'Soul of Kaepora Gaebora',
  SHARED_SOUL_NPC_POE_COLLECTOR: 'Soul of Poe Collector',
  SHARED_SOUL_NPC_BUSINESS_SCRUBS: 'Soul of Business Scrubs',
  SHARED_SOUL_NPC_ZORA: 'Soul of Zoras',
  SHARED_SOUL_NPC_ZORA_SHOPKEEPER: 'Soul of Zora Shopkeeper',
  SHARED_SOUL_NPC_MALON: 'Soul of Malon & Romani/Cremia',
  SHARED_SOUL_NPC_BEAN_SALESMAN: 'Soul of Beans Salesman',
  SHARED_SOUL_NPC_CARPENTERS: 'Soul of the Carpenters',
  SHARED_SOUL_NPC_ANJU: 'Soul of Anju',
  SHARED_SOUL_NPC_DOG: 'Soul of Dogs',
  SHARED_SOUL_NPC_CUCCO: 'Soul of Cuccos',
  SHARED_SOUL_NPC_GURU_GURU: 'Soul of Guru-Guru',
  SHARED_SOUL_NPC_MARINE_SCIENTIST: 'Soul of Marine Scientist',
  SHARED_SOUL_NPC_ROOFTOP_MAN: 'Soul of Man on Roof & Trading Post Part Timer',
  SHARED_SOUL_NPC_DOG_OWNER: 'Soul of Richard\'s Owner & Doggy Racetrack Owner',
  SHARED_SOUL_NPC_BOMBCHU_BOWLING_LADY: 'Soul of Bombchu Bowling & Treasure Chest Game Lady',
  MM_SOUL_NPC_MAGIC_CARPET_MAN: 'Soul of Swordsman',
  SHARED_SOUL_NPC_MAGIC_CARPET_MAN: 'Soul of Bombchu Merchant & Swordsman',
  MM_SOUL_NPC_SAKON_BUNDLE: 'Soul of Sakon, Bomb Granny and Curiosity Shop Owner',
  MM_SOUL_BOSS_MAJORA: 'Soul of Majora',
  MM_SOUL_ENEMY_POE: 'Soul of Poes (MM)',
  MM_SOUL_ENEMY_SPIKE_TRAPS: 'Soul of Spike Traps (MM)',
  MM_SOUL_NPC_OLD_HAG: 'Soul of Anju\' Grandmother',
  SHARED_SOUL_NPC_OLD_HAG: 'Soul of the Old Hag & Anju\'s Grandmother',
  MM_SOUL_NPC_TOURIST_CENTER: 'Soul of Tourist Owner',
