...
export function speedupDogRace(patch: Patchfile) {
    const speedup = Buffer.from([
        0x3C, 0x18, 0x80, 0x1F, 0x83, 0x18, 0xF7, 0x08, 0x07, 0x00, 0x00, 0x04, 0x24, 0x18, 0x00, 0x09,
        0x24, 0x07, 0x00, 0x0D, 0x53, 0x05, 0x00, 0x01, 0x24, 0x07, 0x00, 0x00, 0x30, 0xB8, 0x00, 0x01,
        0x13, 0x00, 0x00, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x18, 0x43
    ])
