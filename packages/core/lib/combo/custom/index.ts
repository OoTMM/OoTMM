...
export const customFiles = async (): Promise<{[k: string]: Uint8Array}> => ({
  ...
  CHEST_HALLOWEEN_FRONT: await png('halloween/chests/major_front', 'rgba16'),
  CHEST_MAJOR_SIDE: await png('chests/major_side', 'rgba16'),
  CHEST_HALLOWEEN_SIDE: await png('halloween/chests/major_side', 'rgba16'),
  ...
  CRATE_HALLOWEEN_MAJOR: await png('halloween/crates/major', 'rgba16'),
  POT_MAJOR_SIDE: await png('pots/major_side', 'rgba16'),
  POT_MAJOR_HALLOWEEN_SIDE: await png('halloween/pots/major_side', 'rgba16'),
  POT_MAJOR_TOP: await png('pots/major_top', 'rgba16'),
  POT_SPIDER_SIDE: await png('pots/spider_side', 'rgba16'),
  POT_SPIDER_HALLOWEEN_SIDE: await png('halloween/pots/spider_side', 'rgba16'),
  POT_SPIDER_TOP: await png('pots/spider_top', 'rgba16'),
  POT_KEY_SIDE: await png('pots/key_side', 'rgba16'),
  POT_KEY_HALLOWEEN_SIDE: await png('halloween/pots/key_side', 'rgba16'),
  POT_FAIRY_SIDE: await png('pots/fairy_side', 'rgba16'),
  POT_FAIRY_HALLOWEEN_SIDE: await png('halloween/pots/fairy_side', 'rgba16'),
  POT_FAIRY_TOP: await png('pots/fairy_top', 'rgba16'),
  POT_HEART_SIDE: await png('pots/heart_side', 'rgba16'),
  POT_HEART_HALLOWEEN_SIDE: await png('halloween/pots/heart_side', 'rgba16'),
