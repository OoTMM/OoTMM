...
export const isKeyRing = (item: Item) => isKeyRingRegular(item) || isKeyRingHideout(item) || isKeyRingTCG(item);
export const isKeyRingHideout = (item: Item) => item === Items.OOT_KEY_RING_GF;
export const isKeyRingTCG = (item: Item) => item === Items.OOT_KEY_RING_TCG;
...
export const isFishingPondFish = (item: Item) => item === Items.OOT_FISHING_FISH;
