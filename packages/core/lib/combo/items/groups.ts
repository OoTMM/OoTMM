...
export const MM_SONG_AWAKENING_NOTES = new Set([
  Items.MM_SONG_AWAKENING_C_UP_1,
  Items.MM_SONG_AWAKENING_C_LEFT_1,
  Items.MM_SONG_AWAKENING_C_UP_2,
  Items.MM_SONG_AWAKENING_C_LEFT_2,
  Items.MM_SONG_AWAKENING_A_1,
  Items.MM_SONG_AWAKENING_C_RIGHT,
  Items.MM_SONG_AWAKENING_A_2,
]);

export const MM_SONG_EMPTINESS_NOTES = new Set([
  Items.MM_SONG_EMPTINESS_C_RIGHT_1,
  Items.MM_SONG_EMPTINESS_C_LEFT_1,
  Items.MM_SONG_EMPTINESS_C_RIGHT_2,
  Items.MM_SONG_EMPTINESS_C_DOWN,
  Items.MM_SONG_EMPTINESS_C_RIGHT_3,
  Items.MM_SONG_EMPTINESS_C_UP,
  Items.MM_SONG_EMPTINESS_C_LEFT_2,
]);

export const MM_SONG_EPONA_NOTES = new Set([
  Items.MM_SONG_EPONA_C_UP_1,
  Items.MM_SONG_EPONA_C_LEFT_1,
  Items.MM_SONG_EPONA_C_RIGHT_1,
  Items.MM_SONG_EPONA_C_UP_2,
  Items.MM_SONG_EPONA_C_LEFT_2,
  Items.MM_SONG_EPONA_C_RIGHT_2,
]);

export const MM_SONG_GORON_HALF_NOTES = new Set([
  Items.MM_SONG_GORON_HALF_A_1,
  Items.MM_SONG_GORON_HALF_C_RIGHT_1,
  Items.MM_SONG_GORON_HALF_C_LEFT_1,
...
export const MM_SONG_GORON_NOTES = new Set([
  Items.MM_SONG_GORON_A_1,
  Items.MM_SONG_GORON_C_RIGHT_1,
  Items.MM_SONG_GORON_C_LEFT_1,
  Items.MM_SONG_GORON_A_2,
  Items.MM_SONG_GORON_C_RIGHT_2,
  Items.MM_SONG_GORON_C_LEFT_2,
  Items.MM_SONG_GORON_C_RIGHT_3,
  Items.MM_SONG_GORON_A_3,
]);

export const MM_SONG_HEALING_NOTES = new Set([
  Items.MM_SONG_HEALING_C_LEFT_1,
  Items.MM_SONG_HEALING_C_RIGHT_1,
  Items.MM_SONG_HEALING_C_DOWN_1,
  Items.MM_SONG_HEALING_C_LEFT_2,
  Items.MM_SONG_HEALING_C_RIGHT_2,
  Items.MM_SONG_HEALING_C_DOWN_2,
]);

export const MM_SONG_ORDER_NOTES = new Set([
  Items.MM_SONG_ORDER_C_RIGHT_1,
  Items.MM_SONG_ORDER_C_DOWN_1,
  Items.MM_SONG_ORDER_A,
  Items.MM_SONG_ORDER_C_DOWN_2,
  Items.MM_SONG_ORDER_C_RIGHT_2,
  Items.MM_SONG_ORDER_C_UP,
]);

export const MM_SONG_SOARING_NOTES = new Set([
  Items.MM_SONG_SOARING_C_DOWN_1,
  Items.MM_SONG_SOARING_C_LEFT_1,
  Items.MM_SONG_SOARING_C_UP_1,
  Items.MM_SONG_SOARING_C_DOWN_2,
  Items.MM_SONG_SOARING_C_LEFT_2,
  Items.MM_SONG_SOARING_C_UP_2,
]);

export const MM_SONG_STORMS_NOTES = new Set([
  Items.MM_SONG_STORMS_A_1,
  Items.MM_SONG_STORMS_C_DOWN_1,
  Items.MM_SONG_STORMS_C_UP_1,
  Items.MM_SONG_STORMS_A_2,
  Items.MM_SONG_STORMS_C_DOWN_2,
  Items.MM_SONG_STORMS_C_UP_2,
]);

export const MM_SONG_SUN_NOTES = new Set([
  Items.MM_SONG_SUN_C_RIGHT_1,
  Items.MM_SONG_SUN_C_DOWN_1,
  Items.MM_SONG_SUN_C_UP_1,
  Items.MM_SONG_SUN_C_RIGHT_2,
  Items.MM_SONG_SUN_C_DOWN_2,
  Items.MM_SONG_SUN_C_UP_2,
]);

export const MM_SONG_TIME_NOTES = new Set([
  Items.MM_SONG_TIME_C_RIGHT_1,
  Items.MM_SONG_TIME_A_1,
  Items.MM_SONG_TIME_C_DOWN_1,
  Items.MM_SONG_TIME_C_RIGHT_2,
  Items.MM_SONG_TIME_A_2,
  Items.MM_SONG_TIME_C_DOWN_3,
]);

export const MM_SONG_ZORA_NOTES = new Set([
  Items.MM_SONG_ZORA_C_LEFT_1,
  Items.MM_SONG_ZORA_C_UP,
  Items.MM_SONG_ZORA_C_LEFT_2,
  Items.MM_SONG_ZORA_C_RIGHT_1,
  Items.MM_SONG_ZORA_C_DOWN,
  Items.MM_SONG_ZORA_C_LEFT_3,
  Items.MM_SONG_ZORA_C_RIGHT_2,
]);

export const OOT_SONG_EPONA_NOTES = new Set([
  Items.OOT_SONG_EPONA_C_UP_1,
  Items.OOT_SONG_EPONA_C_LEFT_1,
  Items.OOT_SONG_EPONA_C_RIGHT_1,
  Items.OOT_SONG_EPONA_C_UP_2,
  Items.OOT_SONG_EPONA_C_LEFT_2,
  Items.OOT_SONG_EPONA_C_RIGHT_2,
]);

export const OOT_SONG_SARIA_NOTES = new Set([
  Items.OOT_SONG_SARIA_C_DOWN_1,
  Items.OOT_SONG_SARIA_C_RIGHT_1,
  Items.OOT_SONG_SARIA_C_LEFT_1,
  Items.OOT_SONG_SARIA_C_DOWN_2,
  Items.OOT_SONG_SARIA_C_RIGHT_2,
  Items.OOT_SONG_SARIA_C_LEFT_2,
]);

export const OOT_SONG_STORMS_NOTES = new Set([
  Items.OOT_SONG_STORMS_A_1,
  Items.OOT_SONG_STORMS_C_DOWN_1,
  Items.OOT_SONG_STORMS_C_UP_1,
  Items.OOT_SONG_STORMS_A_2,
  Items.OOT_SONG_STORMS_C_DOWN_2,
  Items.OOT_SONG_STORMS_C_UP_2,
]);

export const OOT_SONG_SUN_NOTES = new Set([
  Items.OOT_SONG_SUN_C_RIGHT_1,
  Items.OOT_SONG_SUN_C_DOWN_1,
  Items.OOT_SONG_SUN_C_UP_1,
  Items.OOT_SONG_SUN_C_RIGHT_2,
  Items.OOT_SONG_SUN_C_DOWN_2,
  Items.OOT_SONG_SUN_C_UP_2,
]);

export const OOT_SONG_TIME_NOTES = new Set([
  Items.OOT_SONG_TIME_C_RIGHT_1,
  Items.OOT_SONG_TIME_A_1,
  Items.OOT_SONG_TIME_C_DOWN_1,
  Items.OOT_SONG_TIME_C_RIGHT_2,
  Items.OOT_SONG_TIME_A_2,
  Items.OOT_SONG_TIME_C_DOWN_3,
]);

export const OOT_SONG_TP_FIRE_NOTES = new Set([
  Items.OOT_SONG_TP_FIRE_C_DOWN_1,
  Items.OOT_SONG_TP_FIRE_A_1,
  Items.OOT_SONG_TP_FIRE_C_DOWN_2,
  Items.OOT_SONG_TP_FIRE_A_2,
  Items.OOT_SONG_TP_FIRE_C_RIGHT_1,
  Items.OOT_SONG_TP_FIRE_C_DOWN_3,
  Items.OOT_SONG_TP_FIRE_C_RIGHT_2,
  Items.OOT_SONG_TP_FIRE_C_DOWN_4,
]);

export const OOT_SONG_TP_FOREST_NOTES = new Set([
  Items.OOT_SONG_TP_FOREST_A,
  Items.OOT_SONG_TP_FOREST_C_UP,
  Items.OOT_SONG_TP_FOREST_C_LEFT_1,
  Items.OOT_SONG_TP_FOREST_C_RIGHT_1,
  Items.OOT_SONG_TP_FOREST_C_LEFT_2,
  Items.OOT_SONG_TP_FOREST_C_RIGHT_2,
]);

export const OOT_SONG_TP_LIGHT_NOTES = new Set([
  Items.OOT_SONG_TP_LIGHT_C_UP_1,
  Items.OOT_SONG_TP_LIGHT_C_RIGHT_1,
  Items.OOT_SONG_TP_LIGHT_C_UP_2,
  Items.OOT_SONG_TP_LIGHT_C_RIGHT_2,
  Items.OOT_SONG_TP_LIGHT_C_LEFT,
  Items.OOT_SONG_TP_LIGHT_C_UP_3,
]);

export const OOT_SONG_TP_SHADOW_NOTES = new Set([
  Items.OOT_SONG_TP_SHADOW_C_LEFT_1,
  Items.OOT_SONG_TP_SHADOW_C_RIGHT_1,
  Items.OOT_SONG_TP_SHADOW_C_RIGHT_2,
  Items.OOT_SONG_TP_SHADOW_A,
  Items.OOT_SONG_TP_SHADOW_C_LEFT_2,
  Items.OOT_SONG_TP_SHADOW_C_RIGHT_3,
  Items.OOT_SONG_TP_SHADOW_C_DOWN,
]);

export const OOT_SONG_TP_SPIRIT_NOTES = new Set([
  Items.OOT_SONG_TP_SPIRIT_A_1,
  Items.OOT_SONG_TP_SPIRIT_C_DOWN_1,
...
export const OOT_SONG_TP_WATER_NOTES = new Set([
  Items.OOT_SONG_TP_WATER_A,
  Items.OOT_SONG_TP_WATER_C_DOWN,
  Items.OOT_SONG_TP_WATER_C_RIGHT_1,
  Items.OOT_SONG_TP_WATER_C_RIGHT_2,
  Items.OOT_SONG_TP_WATER_C_LEFT,
]);

export const OOT_SONG_ZELDA_NOTES = new Set([
  Items.OOT_SONG_ZELDA_C_LEFT_1,
  Items.OOT_SONG_ZELDA_C_UP_1,
  Items.OOT_SONG_ZELDA_C_RIGHT_1,
  Items.OOT_SONG_ZELDA_C_LEFT_2,
  Items.OOT_SONG_ZELDA_C_UP_2,
  Items.OOT_SONG_ZELDA_C_RIGHT_2,
]);

export const OOT_SONG_EMPTINESS_NOTES = new Set([
  Items.OOT_SONG_EMPTINESS_C_RIGHT_1,
  Items.OOT_SONG_EMPTINESS_C_LEFT_1,
  Items.OOT_SONG_EMPTINESS_C_RIGHT_2,
  Items.OOT_SONG_EMPTINESS_C_DOWN,
  Items.OOT_SONG_EMPTINESS_C_RIGHT_3,
  Items.OOT_SONG_EMPTINESS_C_UP,
  Items.OOT_SONG_EMPTINESS_C_LEFT_2,
]);

export const SHARED_SONG_EPONA_NOTES = new Set([
  Items.SHARED_SONG_EPONA_C_UP_1,
  Items.SHARED_SONG_EPONA_C_LEFT_1,
  Items.SHARED_SONG_EPONA_C_RIGHT_1,
  Items.SHARED_SONG_EPONA_C_UP_2,
  Items.SHARED_SONG_EPONA_C_LEFT_2,
  Items.SHARED_SONG_EPONA_C_RIGHT_2,
]);

export const SHARED_SONG_STORMS_NOTES = new Set([
  Items.SHARED_SONG_STORMS_A_1,
  Items.SHARED_SONG_STORMS_C_DOWN_1,
  Items.SHARED_SONG_STORMS_C_UP_1,
  Items.SHARED_SONG_STORMS_A_2,
  Items.SHARED_SONG_STORMS_C_DOWN_2,
  Items.SHARED_SONG_STORMS_C_UP_2,
]);

export const SHARED_SONG_SUN_NOTES = new Set([
  Items.SHARED_SONG_SUN_C_RIGHT_1,
  Items.SHARED_SONG_SUN_C_DOWN_1,
  Items.SHARED_SONG_SUN_C_UP_1,
  Items.SHARED_SONG_SUN_C_RIGHT_2,
  Items.SHARED_SONG_SUN_C_DOWN_2,
  Items.SHARED_SONG_SUN_C_UP_2,
]);

export const SHARED_SONG_TIME_NOTES = new Set([
  Items.SHARED_SONG_TIME_C_RIGHT_1,
  Items.SHARED_SONG_TIME_A_1,
  Items.SHARED_SONG_TIME_C_DOWN_1,
  Items.SHARED_SONG_TIME_C_RIGHT_2,
  Items.SHARED_SONG_TIME_A_2,
  Items.SHARED_SONG_TIME_C_DOWN_3,
]);

export const SHARED_SONG_EMPTINESS_NOTES = new Set([
  Items.SHARED_SONG_EMPTINESS_C_RIGHT_1,
  Items.SHARED_SONG_EMPTINESS_C_LEFT_1,
  Items.SHARED_SONG_EMPTINESS_C_RIGHT_2,
  Items.SHARED_SONG_EMPTINESS_C_DOWN,
  Items.SHARED_SONG_EMPTINESS_C_RIGHT_3,
  Items.SHARED_SONG_EMPTINESS_C_UP,
  Items.SHARED_SONG_EMPTINESS_C_LEFT_2,
]);

export const SONG_NOTES = new Set([
    ...MM_SONG_AWAKENING_NOTES,
    ...MM_SONG_EMPTINESS_NOTES,
    ...MM_SONG_EPONA_NOTES,
    ...MM_SONG_GORON_HALF_NOTES,
    ...MM_SONG_GORON_NOTES,
    ...MM_SONG_HEALING_NOTES,
    ...MM_SONG_ORDER_NOTES,
    ...MM_SONG_SOARING_NOTES,
    ...MM_SONG_STORMS_NOTES,
    ...MM_SONG_SUN_NOTES,
    ...MM_SONG_TIME_NOTES,
    ...MM_SONG_ZORA_NOTES,
    ...OOT_SONG_EPONA_NOTES,
    ...OOT_SONG_SARIA_NOTES,
    ...OOT_SONG_STORMS_NOTES,
    ...OOT_SONG_SUN_NOTES,
    ...OOT_SONG_TIME_NOTES,
    ...OOT_SONG_TP_FIRE_NOTES,
    ...OOT_SONG_TP_FOREST_NOTES,
    ...OOT_SONG_TP_LIGHT_NOTES,
    ...OOT_SONG_TP_SHADOW_NOTES,
    ...OOT_SONG_TP_SPIRIT_NOTES,
    ...OOT_SONG_TP_WATER_NOTES,
    ...OOT_SONG_ZELDA_NOTES,
    ...OOT_SONG_EMPTINESS_NOTES,
    ...SHARED_SONG_EPONA_NOTES,
    ...SHARED_SONG_STORMS_NOTES,
    ...SHARED_SONG_SUN_NOTES,
    ...SHARED_SONG_TIME_NOTES,
    ...SHARED_SONG_EMPTINESS_NOTES,
]);

export const SONG_NOTE_MAP = new Map<Items, Set<Items>>([
  [Items.OOT_SONG_EPONA, OOT_SONG_EPONA_NOTES],
  [Items.OOT_SONG_SARIA, OOT_SONG_SARIA_NOTES],
  [Items.OOT_SONG_STORMS, OOT_SONG_STORMS_NOTES],
  [Items.OOT_SONG_SUN, OOT_SONG_SUN_NOTES],
  [Items.OOT_SONG_TIME, OOT_SONG_TIME_NOTES],
  [Items.OOT_SONG_ZELDA, OOT_SONG_ZELDA_NOTES],
  [Items.OOT_SONG_TP_FOREST, OOT_SONG_TP_FOREST_NOTES],
  [Items.OOT_SONG_TP_WATER, OOT_SONG_TP_WATER_NOTES],
  [Items.OOT_SONG_TP_FIRE, OOT_SONG_TP_FIRE_NOTES],
  [Items.OOT_SONG_TP_SHADOW, OOT_SONG_TP_SHADOW_NOTES],
  [Items.OOT_SONG_TP_SPIRIT, OOT_SONG_TP_SPIRIT_NOTES],
  [Items.OOT_SONG_TP_LIGHT, OOT_SONG_TP_LIGHT_NOTES],
  [Items.MM_SONG_TIME, MM_SONG_TIME_NOTES],
  [Items.MM_SONG_AWAKENING, MM_SONG_AWAKENING_NOTES],
  [Items.MM_SONG_HEALING, MM_SONG_HEALING_NOTES],
  [Items.MM_SONG_EPONA, MM_SONG_EPONA_NOTES],
  [Items.MM_SONG_SOARING, MM_SONG_SOARING_NOTES],
  [Items.MM_SONG_GORON_HALF, MM_SONG_GORON_HALF_NOTES],
  [Items.MM_SONG_GORON, MM_SONG_GORON_NOTES],
  [Items.MM_SONG_ZORA, MM_SONG_ZORA_NOTES],
  [Items.MM_SONG_STORMS, MM_SONG_STORMS_NOTES],
  [Items.MM_SONG_EMPTINESS, MM_SONG_EMPTINESS_NOTES],
  [Items.MM_SONG_ORDER, MM_SONG_ORDER_NOTES],
  [Items.MM_SONG_SUN, MM_SONG_SUN_NOTES],
  [Items.SHARED_SONG_EPONA, SHARED_SONG_EPONA_NOTES],
  [Items.SHARED_SONG_TIME, SHARED_SONG_TIME_NOTES],
  [Items.SHARED_SONG_STORMS, SHARED_SONG_STORMS_NOTES],
  [Items.SHARED_SONG_SUN, SHARED_SONG_SUN_NOTES],
  [Items.OOT_SONG_EMPTINESS, OOT_SONG_EMPTINESS_NOTES],
  [Items.SHARED_SONG_EMPTINESS, SHARED_SONG_EMPTINESS_NOTES],
]);

export const PROGRESSIVE_SONG_NOTE_MAP = new Map<Items, Map<Items, number>>([
  [Items.OOT_SONG_EPONA, [Items.OOT_SONG_EPONA_PROGRESSIVE_NOTE, OOT_SONG_EPONA_NOTES.size]],
  [Items.OOT_SONG_SARIA, [Items.OOT_SONG_SARIA_PROGRESSIVE_NOTE, OOT_SONG_SARIA_NOTES.size]],
  [Items.OOT_SONG_STORMS, [Items.OOT_SONG_STORMS_PROGRESSIVE_NOTE, OOT_SONG_STORMS_NOTES.size]],
  [Items.OOT_SONG_SUN, [Items.OOT_SONG_SUN_PROGRESSIVE_NOTE, OOT_SONG_SUN_NOTES.size]],
  [Items.OOT_SONG_TIME, [Items.OOT_SONG_TIME_PROGRESSIVE_NOTE, OOT_SONG_TIME_NOTES.size]],
  [Items.OOT_SONG_ZELDA, [Items.OOT_SONG_ZELDA_PROGRESSIVE_NOTE, OOT_SONG_ZELDA_NOTES.size]],
  [Items.OOT_SONG_TP_FOREST, [Items.OOT_SONG_TP_FOREST_PROGRESSIVE_NOTE, OOT_SONG_TP_FOREST_NOTES.size]],
  [Items.OOT_SONG_TP_WATER, [Items.OOT_SONG_TP_WATER_PROGRESSIVE_NOTE, OOT_SONG_TP_WATER_NOTES.size]],
  [Items.OOT_SONG_TP_FIRE, [Items.OOT_SONG_TP_FIRE_PROGRESSIVE_NOTE, OOT_SONG_TP_FIRE_NOTES.size]],
  [Items.OOT_SONG_TP_SHADOW, [Items.OOT_SONG_TP_SHADOW_PROGRESSIVE_NOTE, OOT_SONG_TP_SHADOW_NOTES.size]],
  [Items.OOT_SONG_TP_SPIRIT, [Items.OOT_SONG_TP_SPIRIT_PROGRESSIVE_NOTE, OOT_SONG_TP_SPIRIT_NOTES.size]],
  [Items.OOT_SONG_TP_LIGHT, [Items.OOT_SONG_TP_LIGHT_PROGRESSIVE_NOTE, OOT_SONG_TP_LIGHT_NOTES.size]],
  [Items.MM_SONG_TIME, [Items.MM_SONG_TIME_PROGRESSIVE_NOTE, MM_SONG_TIME_NOTES.size]],
  [Items.MM_SONG_AWAKENING, [Items.MM_SONG_AWAKENING_PROGRESSIVE_NOTE, MM_SONG_AWAKENING_NOTES.size]],
  [Items.MM_SONG_HEALING, [Items.MM_SONG_HEALING_PROGRESSIVE_NOTE, MM_SONG_HEALING_NOTES.size]],
  [Items.MM_SONG_EPONA, [Items.MM_SONG_EPONA_PROGRESSIVE_NOTE, MM_SONG_EPONA_NOTES.size]],
  [Items.MM_SONG_SOARING, [Items.MM_SONG_SOARING_PROGRESSIVE_NOTE, MM_SONG_SOARING_NOTES.size]],
  [Items.MM_SONG_GORON_HALF, [Items.MM_SONG_GORON_HALF_PROGRESSIVE_NOTE, MM_SONG_GORON_HALF_NOTES.size]],
  [Items.MM_SONG_GORON, [Items.MM_SONG_GORON_PROGRESSIVE_NOTE, MM_SONG_GORON_NOTES.size]],
  [Items.MM_SONG_ZORA, [Items.MM_SONG_ZORA_PROGRESSIVE_NOTE, MM_SONG_ZORA_NOTES.size]],
  [Items.MM_SONG_STORMS, [Items.MM_SONG_STORMS_PROGRESSIVE_NOTE, MM_SONG_STORMS_NOTES.size]],
  [Items.MM_SONG_EMPTINESS, [Items.MM_SONG_EMPTINESS_PROGRESSIVE_NOTE, MM_SONG_EMPTINESS_NOTES.size]],
  [Items.MM_SONG_ORDER, [Items.MM_SONG_ORDER_PROGRESSIVE_NOTE, MM_SONG_ORDER_NOTES.size]],
  [Items.MM_SONG_SUN, [Items.MM_SONG_SUN_PROGRESSIVE_NOTE, MM_SONG_SUN_NOTES.size]],
  [Items.SHARED_SONG_EPONA, [Items.SHARED_SONG_EPONA_PROGRESSIVE_NOTE, SHARED_SONG_EPONA_NOTES.size]],
  [Items.SHARED_SONG_TIME, [Items.SHARED_SONG_TIME_PROGRESSIVE_NOTE, SHARED_SONG_TIME_NOTES.size]],
  [Items.SHARED_SONG_STORMS, [Items.SHARED_SONG_STORMS_PROGRESSIVE_NOTE, SHARED_SONG_STORMS_NOTES.size]],
  [Items.SHARED_SONG_SUN, [Items.SHARED_SONG_SUN_PROGRESSIVE_NOTE, SHARED_SONG_SUN_NOTES.size]],
  [Items.OOT_SONG_EMPTINESS, [Items.OOT_SONG_EMPTINESS_PROGRESSIVE_NOTE, OOT_SONG_EMPTINESS_NOTES.size]],
  [Items.SHARED_SONG_EMPTINESS, [Items.SHARED_SONG_EMPTINESS_PROGRESSIVE_NOTE, SHARED_SONG_EMPTINESS_NOTES.size]],
...
export const REQUIRED = new Set([
  ...
  Items.OOT_SLINGSHOT,
  Items.OOT_SONG_EPONA,
  Items.OOT_SONG_EPONA_PROGRESSIVE_NOTE,
  Items.OOT_SONG_SARIA,
  Items.OOT_SONG_SARIA_PROGRESSIVE_NOTE,
  Items.OOT_SONG_STORMS,
  Items.OOT_SONG_STORMS_PROGRESSIVE_NOTE,
  Items.OOT_SONG_SUN,
  Items.OOT_SONG_SUN_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TIME,
  Items.OOT_SONG_TIME_PROGRESSIVE_NOTE,
  Items.OOT_SONG_ZELDA,
  Items.OOT_SONG_ZELDA_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_FOREST,
  Items.OOT_SONG_TP_FOREST_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_WATER,
  Items.OOT_SONG_TP_WATER_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_FIRE,
  Items.OOT_SONG_TP_FIRE_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_SHADOW,
  Items.OOT_SONG_TP_SHADOW_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_SPIRIT,
  Items.OOT_SONG_TP_SPIRIT_PROGRESSIVE_NOTE,
  Items.OOT_SONG_TP_LIGHT,
  Items.OOT_SONG_TP_LIGHT_PROGRESSIVE_NOTE,
  ...
  Items.MM_SONG_TIME,
  Items.MM_SONG_TIME_PROGRESSIVE_NOTE,
  Items.MM_SONG_AWAKENING,
  Items.MM_SONG_AWAKENING_PROGRESSIVE_NOTE,
  Items.MM_SONG_HEALING,
  Items.MM_SONG_HEALING_PROGRESSIVE_NOTE,
  Items.MM_SONG_EPONA,
  Items.MM_SONG_EPONA_PROGRESSIVE_NOTE,
  Items.MM_SONG_SOARING,
  Items.MM_SONG_SOARING_PROGRESSIVE_NOTE,
  Items.MM_SONG_GORON_HALF,
  Items.MM_SONG_GORON_HALF_PROGRESSIVE_NOTE,
  Items.MM_SONG_GORON,
  Items.MM_SONG_GORON_PROGRESSIVE_NOTE,
  Items.MM_SONG_ZORA,
  Items.MM_SONG_ZORA_PROGRESSIVE_NOTE,
  Items.MM_SONG_STORMS,
  Items.MM_SONG_STORMS_PROGRESSIVE_NOTE,
  Items.MM_SONG_EMPTINESS,
  Items.MM_SONG_EMPTINESS_PROGRESSIVE_NOTE,
  Items.MM_SONG_ORDER,
  Items.MM_SONG_ORDER_PROGRESSIVE_NOTE,
  Items.MM_BOW,
  Items.MM_OCARINA,
  Items.MM_SWORD,
  Items.MM_SHIELD,
  ...
  Items.SHARED_SONG_EPONA,
  Items.SHARED_SONG_EPONA_PROGRESSIVE_NOTE,
  Items.SHARED_SONG_TIME,
  Items.SHARED_SONG_TIME_PROGRESSIVE_NOTE,
  Items.SHARED_SONG_STORMS,
  Items.SHARED_SONG_STORMS_PROGRESSIVE_NOTE,
  Items.SHARED_SONG_SUN,
  Items.SHARED_SONG_SUN_PROGRESSIVE_NOTE,
  ...
  Items.SHARED_MASK_STONE,
  Items.OOT_SONG_EMPTINESS,
  Items.OOT_SONG_EMPTINESS_PROGRESSIVE_NOTE,
  Items.SHARED_SONG_EMPTINESS,
  Items.SHARED_SONG_EMPTINESS_PROGRESSIVE_NOTE,
]);
