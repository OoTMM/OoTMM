const ITEM_IDS = [
  ...
  'OOT_SOUL_NPC_MARINE_SCIENTIST',
  'OOT_SOUL_NPC_BEAN_SALESMAN',
  'OOT_SOUL_NPC_DOG',
  'OOT_SOUL_NPC_MAGIC_CARPET_MAN',
  'OOT_SOUL_NPC_INGO',
  'OOT_SOUL_NPC_OWL',
  'OOT_SOUL_NPC_EPONA',
  ...
  'OOT_SOUL_ENEMY_POE',
  'MM_SOUL_ENEMY_POE',
  'OOT_SOUL_ENEMY_SPIKE_TRAPS',
  'MM_SOUL_ENEMY_SPIKE_TRAPS',
  'SHARED_SOUL_ENEMY_SPIKE_TRAPS',
  'OOT_SOUL_BOSS_GANONDORF',
  'OOT_SOUL_NPC_HONEY_DARLING',
  'OOT_SOUL_NPC_ROOFTOP_MAN',
  'OOT_SOUL_NPC_DOG_OWNER',
  ...
  'MM_SOUL_NPC_DEKU_PLAYGROUND_SCRUBS',
  'MM_SOUL_NPC_GORON_ELDER',
  'MM_SOUL_NPC_EPONA',
  'MM_SOUL_NPC_FISHERMAN',
  'MM_SOUL_NPC_GORMAN_BROS',
  'MM_SOUL_NPC_GORON_RACERS',
  'MM_SOUL_NPC_GORON_SHOPKEEPER',
  'MM_SOUL_NPC_HONEY_DARLING',
  'MM_SOUL_NPC_INDIE_GO_GO',
  'MM_SOUL_NPC_KAFEI',
  'MM_SOUL_NPC_KEATON',
  ...
  'MM_SOUL_NPC_TALON',
  'MM_SOUL_NPC_MONKEYS',
  'MM_SOUL_NPC_ASTRAL_OBVSERVER',
  'MM_SOUL_NPC_OWL',
  'MM_SOUL_NPC_POE_COLLECTOR',
  'MM_SOUL_NPC_BUSINESS_SCRUBS',
  'MM_SOUL_NPC_SEAHORSES',
  ...
  'MM_SOUL_NPC_MARINE_SCIENTIST',
  'MM_SOUL_NPC_THIEVES',
  'MM_SOUL_NPC_CHILD_MAJORA',
  'MM_SOUL_ENEMY_THIEVES',
  'MM_SOUL_NPC_CHILD_ODOLWA',
  'MM_SOUL_NPC_CHILD_GOHT',
  'MM_SOUL_NPC_CHILD_GYORG',
  'MM_SOUL_NPC_CHILD_TWINMOLD',
  'MM_SOUL_NPC_DOG_OWNER',
  'MM_SOUL_NPC_MAGIC_CARPET_MAN',
  'MM_SOUL_NPC_SAKON_BUNDLE',
  'SHARED_SOUL_NPC_MAGIC_CARPET_MAN',
  'SHARED_SOUL_ENEMY_POE',
  'SHARED_SOUL_ENEMY_THIEVES',
  'SHARED_SOUL_ENEMY_CURSE_SPIDER',
  ...
  'SHARED_SOUL_NPC_DARUNIA',
  'SHARED_SOUL_NPC_EPONA',
  ...
  'SHARED_SOUL_NPC_BUSINESS_SCRUBS',
  ...
  'SHARED_SOUL_NPC_DOG',
  'SHARED_SOUL_NPC_CUCCO',
  'SHARED_SOUL_NPC_GURU_GURU',
  'SHARED_SOUL_NPC_MARINE_SCIENTIST',
  'SHARED_SOUL_NPC_ROOFTOP_MAN',
  'SHARED_SOUL_NPC_DOG_OWNER',
  'MM_SOUL_BOSS_MAJORA',
  'MM_SOUL_NPC_OLD_HAG',
