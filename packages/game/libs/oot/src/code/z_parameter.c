...
void func_80083108(PlayState* play) {
    ...
    if ((gOotSave.cutsceneIndex < 0xFFF0) ||
        ((play->sceneId == SCENE_LON_LON_RANCH) && (gOotSave.cutsceneIndex == 0xFFF0))) {
        ...
        if ((player->stateFlags1 & PLAYER_STATE1_23) || (play->shootingGalleryStatus > 1) ||
            ...
            if (gOotSave.info.equips.buttonItems[0] != ITEM_NONE) {
                ...
                if ((gOotSave.info.equips.buttonItems[0] != ITEM_SLINGSHOT) &&
                    (gOotSave.info.equips.buttonItems[0] != ITEM_BOW) &&
                    (gOotSave.info.equips.buttonItems[0] != ITEM_BOMBCHU) &&
                    (gOotSave.info.equips.buttonItems[0] != ITEM_NONE)) {
                    gSaveContext.buttonStatus[0] = gOotSave.info.equips.buttonItems[0];
                    ...
                    if ((play->sceneId == SCENE_BOMBCHU_BOWLING_ALLEY) && Flags_GetSwitch(play, 0x38)) {
                        ...
                        if (play->shootingGalleryStatus > 1) {
                            if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
                                gOotSave.info.equips.buttonItems[0] = ITEM_SLINGSHOT;
                            }
            ...
            if (play->interfaceCtx.unk_260 != 0) {
                if (gOotSave.info.equips.buttonItems[0] != ITEM_FISHING_POLE) {
                    gSaveContext.buttonStatus[0] = gOotSave.info.equips.buttonItems[0];
                    gOotSave.info.equips.buttonItems[0] = ITEM_FISHING_POLE;
            ...
            } else if (gOotSave.info.equips.buttonItems[0] == ITEM_FISHING_POLE) {
            ...
            if ((Player_GetEnvironmentalHazard(play) >= PLAYER_ENV_HAZARD_UNDERWATER_FLOOR) &&
                ...
                for (i = 1; i < 4; i++) {
                    if (Player_GetEnvironmentalHazard(play) == PLAYER_ENV_HAZARD_UNDERWATER_FLOOR) {
                        if ((gOotSave.info.equips.buttonItems[i] != ITEM_HOOKSHOT) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_LONGSHOT)) {
                ...
                for (i = 1; i < 4; i++) {
                    if ((gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_FAIRY) &&
                        (gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_OF_TIME)) {
                        if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                            sp28 = true;
                        }
                ...
                if (interfaceCtx->restrictions.bButton == 0) {
                    if ((gOotSave.info.equips.buttonItems[0] == ITEM_SLINGSHOT) ||
                        ...
                        (gOotSave.info.equips.buttonItems[0] == ITEM_NONE)) {
                        if ((gOotSave.info.equips.buttonItems[0] != ITEM_NONE) ||
                            (gOotSave.info.infTable[INFTABLE_1DX_INDEX] == 0)) {
                            gOotSave.info.equips.buttonItems[0] = gSaveContext.buttonStatus[0];
                            sp28 = true;
                        ...
                        if (((gSaveContext.buttonStatus[0] & 0xFF) == BTN_DISABLED) ||
                            ...
                            gOotSave.info.equips.buttonItems[0] = gSaveContext.buttonStatus[0] & 0xFF;
                        }
                    }
                ...
                if (interfaceCtx->restrictions.bottles != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((gOotSave.info.equips.buttonItems[i] >= ITEM_BOTTLE_EMPTY) &&
                            (gOotSave.info.equips.buttonItems[i] <= ITEM_BOTTLE_POE)) {
                            if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.tradeItems != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((gOotSave.info.equips.buttonItems[i] >= ITEM_WEIRD_EGG) &&
                            (gOotSave.info.equips.buttonItems[i] <= ITEM_CLAIM_CHECK)) {
                            if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.farores != 0) {
                    for (i = 1; i < 4; i++) {
                        if (gOotSave.info.equips.buttonItems[i] == ITEM_FARORES_WIND) {
                            if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.dinsNayrus != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((gOotSave.info.equips.buttonItems[i] == ITEM_DINS_FIRE) ||
                            (gOotSave.info.equips.buttonItems[i] == ITEM_NAYRUS_LOVE)) {
                            if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                                sp28 = true;
                            }
                ...
                if (interfaceCtx->restrictions.all != 0) {
                    for (i = 1; i < 4; i++) {
                        if ((gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_FAIRY) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_OF_TIME) &&
                            !((gOotSave.info.equips.buttonItems[i] >= ITEM_BOTTLE_EMPTY) &&
                              (gOotSave.info.equips.buttonItems[i] <= ITEM_BOTTLE_POE)) &&
                            !((gOotSave.info.equips.buttonItems[i] >= ITEM_WEIRD_EGG) &&
                              (gOotSave.info.equips.buttonItems[i] <= ITEM_CLAIM_CHECK))) {
                            if ((play->sceneId != SCENE_TREASURE_BOX_SHOP) ||
                                (gOotSave.info.equips.buttonItems[i] != ITEM_LENS_OF_TRUTH)) {
                                if (gSaveContext.buttonStatus[i] == BTN_ENABLED) {
                                    sp28 = true;
                                }
                    ...
                    for (i = 1; i < 4; i++) {
                        if ((gOotSave.info.equips.buttonItems[i] != ITEM_DINS_FIRE) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_HOOKSHOT) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_LONGSHOT) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_FARORES_WIND) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_NAYRUS_LOVE) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_FAIRY) &&
                            (gOotSave.info.equips.buttonItems[i] != ITEM_OCARINA_OF_TIME) &&
                            !((gOotSave.info.equips.buttonItems[i] >= ITEM_BOTTLE_EMPTY) &&
                              (gOotSave.info.equips.buttonItems[i] <= ITEM_BOTTLE_POE)) &&
                            !((gOotSave.info.equips.buttonItems[i] >= ITEM_WEIRD_EGG) &&
...
void Inventory_SwapAgeEquipment(void) {
    ...
    if (LINK_AGE_IN_YEARS == YEARS_CHILD) {
        for (i = 0; i < 4; i++) {
            if (i != 0) {
                gOotSave.info.playerData.childEquips.buttonItems[i] =
                    gOotSave.info.equips.buttonItems[i];
            } else {
                gOotSave.info.playerData.childEquips.buttonItems[i] = ITEM_SWORD_KOKIRI;
            }

            if (i != 0) {
                gOotSave.info.playerData.childEquips.cButtonSlots[i - 1] =
                    gOotSave.info.equips.cButtonSlots[i - 1];
            }
        }

        gOotSave.info.playerData.childEquips.equipment = gOotSave.info.equips.equipment;
        ...
        if (gOotSave.info.playerData.adultEquips.buttonItems[0] == ITEM_NONE) {
            ...
            for (i = 0; i < 4; i++) {
                gOotSave.info.equips.buttonItems[i] =
                    gOotSave.info.playerData.adultEquips.buttonItems[i];

                if (i != 0) {
                    gOotSave.info.equips.cButtonSlots[i - 1] =
                        gOotSave.info.playerData.adultEquips.cButtonSlots[i - 1];
                }
                ...
                if (((gOotSave.info.equips.buttonItems[i] >= ITEM_BOTTLE_EMPTY) &&
                    ...
                    ((gOotSave.info.equips.buttonItems[i] >= ITEM_WEIRD_EGG) &&
                     (gOotSave.info.equips.buttonItems[i] <= ITEM_CLAIM_CHECK))) {
                    PRINTF("Register_Item_Pt(%d)=%d\n", i, gOotSave.info.equips.cButtonSlots[i - 1]);
                    gOotSave.info.equips.buttonItems[i] =
                        gOotSave.info.inventory.items[gOotSave.info.equips.cButtonSlots[i - 1]];
                }
            }

            gOotSave.info.equips.equipment = gOotSave.info.playerData.adultEquips.equipment;
        }
    } else {
        for (i = 0; i < 4; i++) {
            gOotSave.info.playerData.adultEquips.buttonItems[i] = gOotSave.info.equips.buttonItems[i];
        ...
        gOotSave.info.playerData.adultEquips.equipment = gOotSave.info.equips.equipment;

        if (gOotSave.info.playerData.childEquips.buttonItems[0] != ITEM_NONE) {
            for (i = 0; i < 4; i++) {
                gOotSave.info.equips.buttonItems[i] =
                    gOotSave.info.playerData.childEquips.buttonItems[i];
            ...
            gOotSave.info.equips.equipment = gOotSave.info.playerData.childEquips.equipment;
            gOotSave.info.equips.equipment &= (u16) ~(0xF << (EQUIP_TYPE_SWORD * 4));
            gOotSave.info.equips.equipment |= EQUIP_VALUE_SWORD_KOKIRI << (EQUIP_TYPE_SWORD * 4);
        }
    }

    shieldEquipValue = gEquipMasks[EQUIP_TYPE_SHIELD] & gOotSave.info.equips.equipment;
    if (shieldEquipValue) {
        shieldEquipValue >>= gEquipShifts[EQUIP_TYPE_SHIELD];
        if (!CHECK_OWNED_EQUIP_ALT(EQUIP_TYPE_SHIELD, shieldEquipValue - 1)) {
            gOotSave.info.equips.equipment &= gEquipNegMasks[EQUIP_TYPE_SHIELD];
        }
    }
}
...
void func_800849EC(PlayState* play) {
    gOotSave.info.inventory.equipment |= OWNED_EQUIP_FLAG(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BIGGORON);
    gOotSave.info.inventory.equipment ^=
...
void Interface_LoadItemIcon1(PlayState* play, u16 button) {
    ...
    DMA_REQUEST_ASYNC(&interfaceCtx->dmaRequest_160, interfaceCtx->iconItemSegment + (button * ITEM_ICON_SIZE),
                      GET_ITEM_ICON_VROM(gOotSave.info.equips.buttonItems[button]), ITEM_ICON_SIZE, 0,
...
void func_80084BF4(PlayState* play, u16 flag) {
    if (flag) {
        ...
        } else if (gOotSave.info.equips.buttonItems[0] == ITEM_NONE) {
            if ((gOotSave.info.equips.buttonItems[0] != ITEM_NONE) ||
                (gOotSave.info.infTable[INFTABLE_1DX_INDEX] == 0)) {
                gOotSave.info.equips.buttonItems[0] = gSaveContext.buttonStatus[0];
                Interface_LoadItemIcon1(play, 0);
...
u8 Item_Give(PlayState* play, u8 item) {
    ...
    PRINTF(VT_FGCOL(YELLOW));
    PRINTF("item_get_setting=%d  pt=%d  z=%x\n", item, slot, gOotSave.info.inventory.items[slot]);
    PRINTF(VT_RST);

    if ((item >= ITEM_MEDALLION_FOREST) && (item <= ITEM_MEDALLION_LIGHT)) {
        gOotSave.info.inventory.questItems |= gBitFlags[item - ITEM_MEDALLION_FOREST + QUEST_MEDALLION_FOREST];

        PRINTF(VT_FGCOL(YELLOW));
        PRINTF(T("封印 = %x\n", "Seals = %x\n"), gOotSave.info.inventory.questItems);
        PRINTF(VT_RST);
        ...
        gOotSave.info.inventory.questItems |= gBitFlags[item - ITEM_SONG_MINUET + QUEST_SONG_MINUET];
        ...
        gOotSave.info.inventory.questItems |= gBitFlags[item - ITEM_KOKIRI_EMERALD + QUEST_KOKIRI_EMERALD];
        ...
        gOotSave.info.inventory.questItems |= gBitFlags[item - ITEM_STONE_OF_AGONY + QUEST_STONE_OF_AGONY];
        ...
        gOotSave.info.inventory.questItems |= gBitFlags[item - ITEM_SKULL_TOKEN + QUEST_SKULL_TOKEN];
        ...
        if (item == ITEM_SWORD_BIGGORON) {
            ...
            if (ALL_EQUIP_VALUE(EQUIP_TYPE_SWORD) ==
                ...
                gOotSave.info.inventory.equipment ^=
                    OWNED_EQUIP_FLAG_ALT(EQUIP_TYPE_SWORD, EQUIP_INV_SWORD_BROKENGIANTKNIFE);
                if (gOotSave.info.equips.buttonItems[0] == ITEM_GIANTS_KNIFE) {
                    gOotSave.info.equips.buttonItems[0] = ITEM_SWORD_BIGGORON;
                    Interface_LoadItemIcon1(play, 0);
                }
            }
        ...
        gOotSave.info.inventory.equipment |= OWNED_EQUIP_FLAG(EQUIP_TYPE_SHIELD, item - ITEM_SHIELD_DEKU);
        return ITEM_NONE;
    } else if ((item >= ITEM_TUNIC_KOKIRI) && (item <= ITEM_TUNIC_ZORA)) {
        gOotSave.info.inventory.equipment |= OWNED_EQUIP_FLAG(EQUIP_TYPE_TUNIC, item - ITEM_TUNIC_KOKIRI);
        return ITEM_NONE;
    } else if ((item >= ITEM_BOOTS_KOKIRI) && (item <= ITEM_BOOTS_HOVER)) {
        gOotSave.info.inventory.equipment |= OWNED_EQUIP_FLAG(EQUIP_TYPE_BOOTS, item - ITEM_BOOTS_KOKIRI);
        return ITEM_NONE;
    } else if ((item == ITEM_DUNGEON_BOSS_KEY) || (item == ITEM_DUNGEON_COMPASS) || (item == ITEM_DUNGEON_MAP)) {
        gOotSave.info.inventory.dungeonItems[gSaveContext.mapIndex] |= gBitFlags[item - ITEM_DUNGEON_BOSS_KEY];
        return ITEM_NONE;
        ...
        if (gOotSave.info.inventory.dungeonKeys[gSaveContext.mapIndex] < 0) {
            ...
            gOotSave.info.inventory.dungeonKeys[gSaveContext.mapIndex]++;
            return ITEM_NONE;
        }
        ...
        if (gOotSave.info.inventory.items[slot] == ITEM_NONE) {
        ...
        gOotSave.info.inventory.questItems += 1 << QUEST_HEART_PIECE_COUNT;
        return ITEM_NONE;
        ...
        for (i = 0; i < 4; i++) {
            if (gOotSave.info.inventory.items[temp + i] == ITEM_NONE) {
                gOotSave.info.inventory.items[temp + i] = item;
                return ITEM_NONE;
            }
        }
        ...
        if ((item != ITEM_BOTTLE_MILK_FULL) && (item != ITEM_BOTTLE_RUTOS_LETTER)) {
            ...
            for (i = 0; i < 4; i++) {
                if (gOotSave.info.inventory.items[temp + i] == ITEM_BOTTLE_EMPTY) {
                    PRINTF(T("Item_Pt(1)=%d Item_Pt(2)=%d Item_Pt(3)=%d   空瓶=%d   中味=%d\n",
                             "Item_Pt(1)=%d Item_Pt(2)=%d Item_Pt(3)=%d   Empty Bottle=%d   Content=%d\n"),
                           gOotSave.info.equips.cButtonSlots[0], gOotSave.info.equips.cButtonSlots[1],
                           gOotSave.info.equips.cButtonSlots[2], temp + i, item);

                    if ((temp + i) == gOotSave.info.equips.cButtonSlots[0]) {
                        gOotSave.info.equips.buttonItems[1] = item;
                        Interface_LoadItemIcon2(play, 1);
                        gSaveContext.buttonStatus[1] = BTN_ENABLED;
                    } else if ((temp + i) == gOotSave.info.equips.cButtonSlots[1]) {
                        gOotSave.info.equips.buttonItems[2] = item;
                        Interface_LoadItemIcon2(play, 2);
                        gSaveContext.buttonStatus[2] = BTN_ENABLED;
                    } else if ((temp + i) == gOotSave.info.equips.cButtonSlots[2]) {
                        gOotSave.info.equips.buttonItems[3] = item;
        ...
        if (temp != ITEM_NONE) {
            for (i = 1; i < 4; i++) {
                if (temp == gOotSave.info.equips.buttonItems[i]) {
                    if (item != ITEM_SOLD_OUT) {
                        gOotSave.info.equips.buttonItems[i] = item;
                        Interface_LoadItemIcon1(play, i);
                    } else {
                        gOotSave.info.equips.buttonItems[i] = ITEM_NONE;
                    }
                    return ITEM_NONE;
                }
            }
    ...
    temp = gOotSave.info.inventory.items[slot];
...
u8 Item_CheckObtainability(u8 item) {
    ...
    return gOotSave.info.inventory.items[slot];
}
...
void Inventory_DeleteItem(u16 item, u16 invSlot) {
    ...
    gOotSave.info.inventory.items[invSlot] = ITEM_NONE;

    PRINTF("\nItem_Register(%d)\n", invSlot, gOotSave.info.inventory.items[invSlot]);

    for (i = 1; i < 4; i++) {
        if (gOotSave.info.equips.buttonItems[i] == item) {
            gOotSave.info.equips.buttonItems[i] = ITEM_NONE;
            gOotSave.info.equips.cButtonSlots[i - 1] = SLOT_NONE;
        }
    }
}
...
s32 Inventory_ReplaceItem(PlayState* play, u16 oldItem, u16 newItem) {
    ...
    for (i = 0; i < ARRAY_COUNT(gOotSave.info.inventory.items); i++) {
        if (gOotSave.info.inventory.items[i] == oldItem) {
            gOotSave.info.inventory.items[i] = newItem;
            PRINTF(T("アイテム消去(%d)\n", "Item Purge (%d)\n"), i);
            for (i = 1; i < 4; i++) {
                if (gOotSave.info.equips.buttonItems[i] == oldItem) {
                    gOotSave.info.equips.buttonItems[i] = newItem;
                    Interface_LoadItemIcon1(play, i);
                    break;
                }
            }
...
void Inventory_UpdateBottleItem(PlayState* play, u8 item, u8 button) {
    PRINTF("item_no=%x,  c_no=%x,  Pt=%x  Item_Register=%x\n", item, button,
           gOotSave.info.equips.cButtonSlots[button - 1],
           gOotSave.info.inventory.items[gOotSave.info.equips.cButtonSlots[button - 1]]);

    // Special case to only empty half of a Lon Lon Milk Bottle
    if ((gOotSave.info.inventory.items[gOotSave.info.equips.cButtonSlots[button - 1]] ==
         ITEM_BOTTLE_MILK_FULL) &&
        (item == ITEM_BOTTLE_EMPTY)) {
        item = ITEM_BOTTLE_MILK_HALF;
    }

    gOotSave.info.inventory.items[gOotSave.info.equips.cButtonSlots[button - 1]] = item;
    gOotSave.info.equips.buttonItems[button] = item;
...
s32 Inventory_ConsumeFairy(PlayState* play) {
    ...
    for (i = 0; i < 4; i++) {
        if (gOotSave.info.inventory.items[bottleSlot + i] == ITEM_BOTTLE_FAIRY) {
            for (j = 1; j < 4; j++) {
                if (gOotSave.info.equips.buttonItems[j] == ITEM_BOTTLE_FAIRY) {
                    gOotSave.info.equips.buttonItems[j] = ITEM_BOTTLE_EMPTY;
                    Interface_LoadItemIcon1(play, j);
                    i = 0;
                    bottleSlot = gOotSave.info.equips.cButtonSlots[j - 1];
                    break;
                }
            }
            PRINTF(T("妖精使用＝%d\n", "Fairy Usage=%d\n"), bottleSlot);
            gOotSave.info.inventory.items[bottleSlot + i] = ITEM_BOTTLE_EMPTY;
            return true;
        }
    }
...
s32 Health_ChangeBy(PlayState* play, s16 amount) {
    ...
    } else if (gOotSave.info.playerData.isDoubleDefenseAcquired && (amount < 0)) {
        amount >>= 1;
        PRINTF(T("ハート減少半分！！＝%d\n", "Heart decrease halved!! = %d\n"),  amount);
    }
    // clang-format on

    gOotSave.info.playerData.health += amount;

    if (gOotSave.info.playerData.health > gOotSave.info.playerData.healthCapacity) {
        gOotSave.info.playerData.health = gOotSave.info.playerData.healthCapacity;
    }

    heartCount = gOotSave.info.playerData.health % 0x10;
    ...
    PRINTF(T("  ライフ=%d  ＊＊＊  %d  ＊＊＊＊＊＊\n", "  Life=%d  ***  %d  ******\n"),
           gOotSave.info.playerData.health, healthLevel);

    if (gOotSave.info.playerData.health <= 0) {
        gOotSave.info.playerData.health = 0;
        return false;
    } else {
        return true;
    }
...
void Health_GiveHearts(s16 hearts) {
    gOotSave.info.playerData.healthCapacity += hearts * 0x10;
}
...
void Magic_Fill(PlayState* play) {
    if (gOotSave.info.playerData.isMagicAcquired) {
        ...
        gSaveContext.magicFillTarget =
            (gOotSave.info.playerData.isDoubleMagicAcquired + 1) * MAGIC_NORMAL_METER;
...
s32 Magic_RequestChange(PlayState* play, s16 amount, s16 type) {
    ...
    if ((type != MAGIC_ADD) && (gOotSave.info.playerData.magic - amount) < 0) {
    ...
    switch (type) {
        ...
        case MAGIC_CONSUME_NOW_ALT:
            ...
            if ((gSaveContext.magicState == MAGIC_STATE_IDLE) ||
                ...
                gSaveContext.magicTarget = gOotSave.info.playerData.magic - amount;
        ...
        case MAGIC_CONSUME_LENS:
            if (gSaveContext.magicState == MAGIC_STATE_IDLE) {
                if (gOotSave.info.playerData.magic != 0) {
        ...
        case MAGIC_ADD:
            ...
            if (gOotSave.info.playerData.magic <= gSaveContext.magicCapacity) {
                gSaveContext.magicTarget = gOotSave.info.playerData.magic + amount;
...
void Magic_Update(PlayState* play) {
    ...
    switch (gSaveContext.magicState) {
        case MAGIC_STATE_STEP_CAPACITY:
            ...
            temp = gOotSave.info.playerData.magicLevel * MAGIC_NORMAL_METER;
        ...
        case MAGIC_STATE_FILL:
            ...
            gOotSave.info.playerData.magic += 4;
            ...
            PRINTF(T("蓄電  MAGIC_NOW=%d (%d)\n", "Storage  MAGIC_NOW=%d (%d)\n"),
                   gOotSave.info.playerData.magic, gSaveContext.magicFillTarget);

            if (gOotSave.info.playerData.magic >= gSaveContext.magicFillTarget) {
                gOotSave.info.playerData.magic = gSaveContext.magicFillTarget;
        ...
        case MAGIC_STATE_CONSUME:
            ...
            gOotSave.info.playerData.magic -= 2;
            if (gOotSave.info.playerData.magic <= 0) {
                gOotSave.info.playerData.magic = 0;
                gSaveContext.magicState = MAGIC_STATE_METER_FLASH_1;
                sMagicBorderR = sMagicBorderG = sMagicBorderB = 255;
            } else if (gOotSave.info.playerData.magic == gSaveContext.magicTarget) {
                gSaveContext.magicState = MAGIC_STATE_METER_FLASH_1;
                sMagicBorderR = sMagicBorderG = sMagicBorderB = 255;
            }
            ...
            if (!IS_PAUSED(&play->pauseCtx) && (msgCtx->msgMode == MSGMODE_NONE) &&
                ...
                if ((gOotSave.info.playerData.magic == 0) ||
                    ...
                    ((Player_GetEnvironmentalHazard(play) >= PLAYER_ENV_HAZARD_UNDERWATER_FLOOR) &&
                     (Player_GetEnvironmentalHazard(play) <= PLAYER_ENV_HAZARD_UNDERWATER_FREE)) ||
                    ((gOotSave.info.equips.buttonItems[1] != ITEM_LENS_OF_TRUTH) &&
                     (gOotSave.info.equips.buttonItems[2] != ITEM_LENS_OF_TRUTH) &&
                     (gOotSave.info.equips.buttonItems[3] != ITEM_LENS_OF_TRUTH)) ||
        ...
        case MAGIC_STATE_ADD:
            ...
            Audio_PlaySfxGeneral(NA_SE_SY_GAUGE_UP - SFX_FLAG, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                 &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
            if (gOotSave.info.playerData.magic >= gSaveContext.magicTarget) {
                gOotSave.info.playerData.magic = gSaveContext.magicTarget;
                gSaveContext.magicState = gSaveContext.prevMagicState;
                gSaveContext.prevMagicState = MAGIC_STATE_IDLE;
            }
            break;
...
void Magic_DrawMeter(PlayState* play) {
    ...
    if (gOotSave.info.playerData.magicLevel != 0) {
        ...
        if (gSaveContext.magicState == MAGIC_STATE_METER_FLASH_2) {
            ...
            gSPTextureRectangle(OVERLAY_DISP++, R_MAGIC_FILL_X << 2, (magicMeterY + 3) << 2,
                                (R_MAGIC_FILL_X + gOotSave.info.playerData.magic) << 2,
...
void Interface_DrawItemButtons(PlayState* play) {
    ...
    for (temp = 1; temp < 4; temp++) {
        if (gOotSave.info.equips.buttonItems[temp] > 0xF0) {
            if (temp == 1) {
                gDPSetPrimColor(OVERLAY_DISP++, 0, 0, R_C_BTN_COLOR(0), R_C_BTN_COLOR(1), R_C_BTN_COLOR(2),
                                interfaceCtx->cLeftAlpha);
            } else if (temp == 2) {
...
void Interface_DrawAmmoCount(PlayState* play, s16 button, s16 alpha) {
    ...
    i = gOotSave.info.equips.buttonItems[button];
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if (gOotSave.info.playerData.rupees == CUR_CAPACITY(UPG_WALLET)) {
            gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 120, 255, 0, interfaceCtx->magicAlpha);
        } else if (gOotSave.info.playerData.rupees != 0) {
            gDPSetPrimColor(OVERLAY_DISP++, 0, 0, 255, 255, 255, interfaceCtx->magicAlpha);
        } else {
        ...
        interfaceCtx->counterDigits[2] = gOotSave.info.playerData.rupees;
            ...
            for (svar1 = 0; svar1 < ARRAY_COUNT(gSpoilingItems); svar1++) {
                if (INV_CONTENT(ITEM_TRADE_ADULT) == gSpoilingItems[svar1]) {
                    ...
                    for (svar2 = 1; svar2 < 4; svar2++) {
                        if (gOotSave.info.equips.buttonItems[svar2] == gSpoilingItems[svar1]) {
                            gOotSave.info.equips.buttonItems[svar2] = gSpoilingItemReverts[svar1];
        ...
        if (!IS_PAUSED(&play->pauseCtx) && (play->gameOverCtx.state == GAMEOVER_INACTIVE) &&
            ...
            switch (gSaveContext.timerState) {
                case TIMER_STATE_ENV_HAZARD_INIT:
                    ...
                    gSaveContext.timerSeconds = gOotSave.info.playerData.health >> 1;
                    ...
                    if ((gSaveContext.timerState >= TIMER_STATE_ENV_HAZARD_MOVE) && (msgCtx->msgLength == 0)) {
                        ...
                        if (sTimerNextSecondTimer == 0) {
                            ...
                            if (gSaveContext.timerSeconds == 0) {
                                ...
                                if (sEnvHazardActive) {
                                    gOotSave.info.playerData.health = 0;
                                    play->damagePlayer(play, -(gOotSave.info.playerData.health + 2));
                                }
                                sEnvHazardActive = false;
...
void Interface_Update(PlayState* play) {
    ...
    if (gSaveContext.healthAccumulator != 0) {
        ...
        gOotSave.info.playerData.health += 4;

        if ((gOotSave.info.playerData.health & 0xF) < 4) {
            Audio_PlaySfxGeneral(NA_SE_SY_HP_RECOVER, &gSfxDefaultPos, 4, &gSfxDefaultFreqAndVolScale,
                                 &gSfxDefaultFreqAndVolScale, &gSfxDefaultReverb);
        }

        PRINTF("now_life=%d  max_life=%d\n", gOotSave.info.playerData.health,
               gOotSave.info.playerData.healthCapacity);
    ...
    if (!IS_PAUSED(&play->pauseCtx) && (msgCtx->msgMode == MSGMODE_NONE) &&
        ...
        if (gOotSave.info.playerData.isMagicAcquired && (gOotSave.info.playerData.magicLevel == 0)) {
            gOotSave.info.playerData.magicLevel = gOotSave.info.playerData.isDoubleMagicAcquired + 1;
            gSaveContext.magicState = MAGIC_STATE_STEP_CAPACITY;
            PRINTF(VT_FGCOL(YELLOW));
            PRINTF(T("魔法スター─────ト！！！！！！！！！\n", "Magic Start!!!!!!!!!\n"));
            PRINTF("MAGIC_MAX=%d\n", gOotSave.info.playerData.magicLevel);
            PRINTF("MAGIC_NOW=%d\n", gOotSave.info.playerData.magic);
    ...
    if (gSaveContext.timerState == TIMER_STATE_OFF) {
        if (((sEnvHazard == PLAYER_ENV_HAZARD_HOTROOM) || (sEnvHazard == PLAYER_ENV_HAZARD_UNDERWATER_FLOOR) ||
            ...
            ((gOotSave.info.playerData.health >> 1) != 0)) {
    ...
    if (gSaveContext.sunsSongState != SUNSSONG_INACTIVE) {
        ...
        if (play->envCtx.sceneTimeSpeed != 0) {
            if (gSaveContext.sunsSongState != SUNSSONG_SPEED_TIME) {
                D_80125B60 = false;
                if ((gOotSave.dayTime >= CLOCK_TIME(6, 30)) &&
                    (gOotSave.dayTime <= CLOCK_TIME(18, 0) + 1)) {
                    D_80125B60 = true;
                }
            ...
            } else if (gOotSave.dayTime > CLOCK_TIME(18, 0) + 1) {
                gSaveContext.sunsSongState = SUNSSONG_INACTIVE;
                gTimeSpeed = sPrevTimeSpeed;
                play->msgCtx.ocarinaMode = OCARINA_MODE_04;
            }
            ...
            play->nextEntranceIndex = gOotSave.entranceIndex;
            play->transitionTrigger = TRANS_TRIGGER_START;
            gSaveContext.sunsSongState = SUNSSONG_INACTIVE;
#if OOT_VERSION >= PAL_1_0
            func_800F6964(30);
