...
static s16 sGetItemIds[] = {
   GI_OOT_BOTTLE_EMPTY,        // ITEM_ETC_BOTTLE
   GI_OOT_RUTO_LETTER,         // ITEM_ETC_LETTER
   GI_OOT_SHIELD_HYLIAN,       // ITEM_ETC_SHIELD_HYLIAN
   GI_OOT_BOW,                 // ITEM_ETC_QUIVER
   GI_OOT_SCALE_SILVER,        // ITEM_ETC_SCALE_SILVER
   GI_OOT_SCALE_GOLDEN,        // ITEM_ETC_SCALE_GOLD
   GI_OOT_SMALL_KEY,           // ITEM_ETC_KEY_SMALL
   GI_OOT_ARROW_FIRE,          // ITEM_ETC_ARROW_FIRE
