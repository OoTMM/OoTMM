...
u8 gSlotAgeReqs[] = {
    AGE_REQ_CHILD, // SLOT_OOT_DEKU_STICK
    AGE_REQ_NONE,  // SLOT_OOT_DEKU_NUT
    AGE_REQ_NONE,  // SLOT_OOT_BOMB
    AGE_REQ_ADULT, // SLOT_OOT_BOW
    AGE_REQ_ADULT, // SLOT_OOT_ARROW_FIRE
    AGE_REQ_NONE,  // SLOT_OOT_DINS_FIRE
    AGE_REQ_CHILD, // SLOT_OOT_SLINGSHOT
    AGE_REQ_NONE,  // SLOT_OOT_OCARINA
    AGE_REQ_NONE,  // SLOT_OOT_BOMBCHU
    AGE_REQ_ADULT, // SLOT_OOT_HOOKSHOT
    AGE_REQ_ADULT, // SLOT_OOT_ARROW_ICE
    AGE_REQ_NONE,  // SLOT_OOT_FARORES_WIND
    AGE_REQ_CHILD, // SLOT_OOT_BOOMERANG
    AGE_REQ_NONE,  // SLOT_OOT_LENS_OF_TRUTH
    AGE_REQ_CHILD, // SLOT_OOT_MAGIC_BEAN
    AGE_REQ_ADULT, // SLOT_OOT_HAMMER
    AGE_REQ_ADULT, // SLOT_OOT_ARROW_LIGHT
    AGE_REQ_NONE,  // SLOT_OOT_NAYRUS_LOVE
    AGE_REQ_NONE,  // SLOT_OOT_BOTTLE_1
    AGE_REQ_NONE,  // SLOT_OOT_BOTTLE_2
    AGE_REQ_NONE,  // SLOT_OOT_BOTTLE_3
    AGE_REQ_NONE,  // SLOT_OOT_BOTTLE_4
    AGE_REQ_ADULT, // SLOT_OOT_TRADE_ADULT
    AGE_REQ_CHILD, // SLOT_OOT_TRADE_CHILD
};
...
void KaleidoScope_Update(PlayState* play) {
    ...
    switch (pauseCtx->state) {
        case PAUSE_STATE_INIT:
            ...
            if (gBitFlags[WORLD_MAP_AREA_KAKARIKO_VILLAGE] & gOotSave.info.worldMapAreaData) {
            ...
            if (gBitFlags[WORLD_MAP_AREA_LOST_WOODS] & gOotSave.info.worldMapAreaData) {
