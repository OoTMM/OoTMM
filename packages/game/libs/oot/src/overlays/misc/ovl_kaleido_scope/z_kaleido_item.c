...
void KaleidoScope_DrawItemSelect(PlayState* play) {
        ...
        if (pauseCtx->cursorSpecialPos == 0) {
            ...
            if (ABS(pauseCtx->stickAdjX) > 30) {
                ...
                do {
                    if (pauseCtx->stickAdjX < -30) { // left
                        ...
                        if (pauseCtx->cursorX[PAUSE_ITEM] != 0) {
                            ...
                            if (gOotSave.info.inventory.items[pauseCtx->cursorPoint[PAUSE_ITEM]] !=
                                ITEM_NONE) {
                                cursorMoveResult = 1;
                            }
                        } else {
                ...
                if (cursorMoveResult == 1) {
                    cursorItem = gOotSave.info.inventory.items[pauseCtx->cursorPoint[PAUSE_ITEM]];
                }
            ...
            if (pauseCtx->stickAdjX > 30) {
                ...
                while (true) {
                    if (gOotSave.info.inventory.items[cursorPoint] != ITEM_NONE) {
                        pauseCtx->cursorPoint[PAUSE_ITEM] = cursorPoint;
                        pauseCtx->cursorX[PAUSE_ITEM] = cursorX;
    ...
    for (i = 0, j = ITEM_QUAD_GRID_SELECTED_C_LEFT * 4; i < 3; i++, j += 4) {
        if (gOotSave.info.equips.buttonItems[i + 1] != ITEM_NONE) {
    ...
    for (i = j = 0; i < (ITEM_GRID_ROWS * ITEM_GRID_COLS); i++, j += 4) {
        ...
        if (gOotSave.info.inventory.items[i] != ITEM_NONE) {
            ...
            KaleidoScope_DrawQuadTextureRGBA32(play->state.gfxCtx,
                                               gItemIcons[gOotSave.info.inventory.items[i]], ITEM_ICON_WIDTH,
                                               ITEM_ICON_HEIGHT, 0);
        }
    }
    ...
    for (i = 0; i < 15; i++) {
        if ((gAmmoItems[i] != ITEM_NONE) && (gOotSave.info.inventory.items[i] != ITEM_NONE)) {
            KaleidoScope_DrawAmmoCount(pauseCtx, play->state.gfxCtx, gOotSave.info.inventory.items[i]);
        }
    }
    ...
    if (sEquipAnimTimer == 0) {
        ...
        if (sEquipMoveTimer == 0) {
            ...
            if (pauseCtx->equipTargetCBtn == 0) {
                ...
                if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[1]) {
                    if (gOotSave.info.equips.buttonItems[1] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((gOotSave.info.equips.buttonItems[1] == ITEM_BOW) ||
                        ...
                        gOotSave.info.equips.buttonItems[2] = ITEM_NONE;
                        gOotSave.info.equips.cButtonSlots[1] = SLOT_NONE;
                    }
                } else if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[2]) {
                    if (gOotSave.info.equips.buttonItems[1] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((gOotSave.info.equips.buttonItems[1] == ITEM_BOW) ||
                             ((gOotSave.info.equips.buttonItems[1] >= ITEM_BOW_FIRE) &&
                        ...
                        gOotSave.info.equips.buttonItems[3] = ITEM_NONE;
                        gOotSave.info.equips.cButtonSlots[2] = SLOT_NONE;
                    }
                }

                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((gOotSave.info.equips.buttonItems[1] == ITEM_BOW) ||
                        ((gOotSave.info.equips.buttonItems[1] >= ITEM_BOW_FIRE) &&
                         (gOotSave.info.equips.buttonItems[1] <= ITEM_BOW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((gOotSave.info.equips.buttonItems[2] >= ITEM_BOW_FIRE) &&
                        ...
                        gOotSave.info.equips.buttonItems[2] = gOotSave.info.equips.buttonItems[1];
                        gOotSave.info.equips.cButtonSlots[1] = gOotSave.info.equips.cButtonSlots[0];
                        Interface_LoadItemIcon2(play, 2);
                    } else if ((gOotSave.info.equips.buttonItems[3] >= ITEM_BOW_FIRE) &&
                               (gOotSave.info.equips.buttonItems[3] <= ITEM_BOW_LIGHT)) {
                        gOotSave.info.equips.buttonItems[3] = gOotSave.info.equips.buttonItems[1];
                        gOotSave.info.equips.cButtonSlots[2] = gOotSave.info.equips.cButtonSlots[0];
                        Interface_LoadItemIcon2(play, 3);
                    }
                }

                gOotSave.info.equips.buttonItems[1] = pauseCtx->equipTargetItem;
                gOotSave.info.equips.cButtonSlots[0] = pauseCtx->equipTargetSlot;
                ...
                if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[0]) {
                    if (gOotSave.info.equips.buttonItems[2] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((gOotSave.info.equips.buttonItems[2] == ITEM_BOW) ||
                        ...
                        gOotSave.info.equips.buttonItems[1] = ITEM_NONE;
                        gOotSave.info.equips.cButtonSlots[0] = SLOT_NONE;
                    }
                } else if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[2]) {
                    if (gOotSave.info.equips.buttonItems[2] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((gOotSave.info.equips.buttonItems[2] == ITEM_BOW) ||
                        ((gOotSave.info.equips.buttonItems[2] >= ITEM_BOW_FIRE) &&
                         (gOotSave.info.equips.buttonItems[2] <= ITEM_BOW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                ...
                gOotSave.info.equips.buttonItems[2] = pauseCtx->equipTargetItem;
                gOotSave.info.equips.cButtonSlots[1] = pauseCtx->equipTargetSlot;
                ...
                if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[0]) {
                    if (gOotSave.info.equips.buttonItems[3] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((gOotSave.info.equips.buttonItems[3] == ITEM_BOW) ||
                ...
                } else if (pauseCtx->equipTargetSlot == gOotSave.info.equips.cButtonSlots[1]) {
                    if (gOotSave.info.equips.buttonItems[3] != ITEM_NONE) {
                        if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1) &&
                            ((gOotSave.info.equips.buttonItems[3] == ITEM_BOW) ||
                             ((gOotSave.info.equips.buttonItems[3] >= ITEM_BOW_FIRE) &&
                ...
                if ((pauseCtx->equipTargetItem >= 0xBF) && (pauseCtx->equipTargetItem <= 0xC1)) {
                    if ((gOotSave.info.equips.buttonItems[3] == ITEM_BOW) ||
                        ((gOotSave.info.equips.buttonItems[3] >= ITEM_BOW_FIRE) &&
                         (gOotSave.info.equips.buttonItems[3] <= ITEM_BOW_LIGHT))) {
                        pauseCtx->equipTargetItem -= 0xBF - ITEM_BOW_FIRE;
                        pauseCtx->equipTargetSlot = SLOT_BOW;
                    ...
                    if ((gOotSave.info.equips.buttonItems[1] >= ITEM_BOW_FIRE) &&
                        ...
                        gOotSave.info.equips.buttonItems[1] = gOotSave.info.equips.buttonItems[3];
                        Interface_LoadItemIcon2(play, 1);
                    } else if ((gOotSave.info.equips.buttonItems[2] >= ITEM_BOW_FIRE) &&
                               (gOotSave.info.equips.buttonItems[2] <= ITEM_BOW_LIGHT)) {
                        gOotSave.info.equips.buttonItems[2] = gOotSave.info.equips.buttonItems[3];
                        Interface_LoadItemIcon2(play, 2);
                    }
                ...
                gOotSave.info.equips.buttonItems[3] = pauseCtx->equipTargetItem;
                gOotSave.info.equips.cButtonSlots[2] = pauseCtx->equipTargetSlot;
