...
wordReplace = {
    ...
    "gSaveContext.weekEventReg": "gMmSave.saveInfo.weekEventReg",
    "gSaveContext.playerForm": "gMmSave.playerForm",
    "gSaveContext.day": "gMmSave.day",
    "gSaveContext.isNight": "gMmSave.isNight",
    "gSaveContext.environmentTime": "gSaveContext.skyboxTime",
    "gSaveContext.naviTimer": "gMmSave.saveInfo.playerData.tatlTimer",
    "gSaveContext.tatlTimer": "gMmSave.saveInfo.playerData.tatlTimer",
    "gSaveContext.rupees": "gMmSave.saveInfo.playerData.rupees",
    "gSaveContext.magicAcquired": "gMmSave.saveInfo.playerData.isMagicAcquired",
    "gSaveContext.doubleMagic": "gMmSave.saveInfo.playerData.isDoubleMagicAcquired",
    "gSaveContext.doubleDefense": "gMmSave.saveInfo.playerData.doubleDefense",
    "gSaveContext.playerName": "gMmSave.saveInfo.playerData.playerName",
    "gSaveContext.inventory": "gMmSave.saveInfo.inventory",
    "gSaveContext.equippedMask": "gMmSave.equippedMask",
    "gSaveContext.entranceIndex": "gMmSave.entrance",
    "gSaveContext.time": "gMmSave.time",
    "gMmSave.daySpeed": "gMmSave.timeSpeedOffset",
    "gSaveContext.unk_14": "gMmSave.timeSpeedOffset",
    "gSaveContext.unk_FE6": "gMmSave.saveInfo.bombersCaughtNum",
    "gSaveContext.unk_FE7": "gMmSave.saveInfo.bombersCaughtOrder",
    "gSaveContext.linkAge": "gMmSave.linkAge",
    "gSaveContext.dekuPlaygroundHighScores": "gMmSave.saveInfo.dekuPlaygroundHighScores",
    "gSaveContext.lotteryCodeGuess": "gMmSave.saveInfo.lotteryCodeGuess",
    "gSaveContext.permanentSceneFlags": "gMmSave.saveInfo.permanentSceneFlags",
    "gSaveContext.bomberCode": "gMmSave.saveInfo.bomberCode",
    "gSaveContext.skullTokenCount": "gMmSave.saveInfo.skullTokenCount",
    "gSaveContext.cutscene": "gMmSave.cutsceneIndex",
    "gMmSave.cutscene": "gMmSave.cutsceneIndex",
    "gSaveContext.health": "gMmSave.saveInfo.playerData.health",
    "gSaveContext.equips": "gMmSave.saveInfo.equips",
    "gSaveContext.unk_1016": "gSaveContext.jinxTimer",
    "gSaveContext.unk_3F58": "gSaveContext.sunsSongState",
    "gSaveContext.equips.buttonItems": "gMmSave.equips.buttonItems",
    "gSaveContext.unk_48C8": "gSaveContext.dungeonIndex",
    "gMmSave.saveInfo.playerData.magicAcquired": "gMmSave.saveInfo.playerData.isMagicAcquired",
    "gMmSave.playerData.doubleMagic": "gMmSave.saveInfo.playerData.isDoubleMagicAcquired",
    ...
    "gMmSave.entranceIndex": "gMmSave.entrance",
    ...
    "gMmSave.playerData": "gMmSave.saveInfo.playerData",
    "gMmSave.equips": "gMmSave.saveInfo.equips",
    "gMmSave.inventory": "gMmSave.saveInfo.inventory",
    "gMmSave.permanentSceneFlags": "gMmSave.saveInfo.permanentSceneFlags",

    "gMmSave.unk_E18": "gMmSave.saveInfo.unk_E5C",
    "gMmSave.dekuPlaygroundHighScores": "gMmSave.saveInfo.dekuPlaygroundHighScores",
    "gMmSave.pictoFlags0": "gMmSave.saveInfo.pictoFlags0",
    "gMmSave.pictoFlags1": "gMmSave.saveInfo.pictoFlags1",
    "gMmSave.unk_E84": "gMmSave.saveInfo.unk_E60",
    "gMmSave.unk_E88": "gMmSave.saveInfo.unk_E64",
    "gMmSave.unk_E64": "gMmSave.saveInfo.alienInfo",
    "gMmSave.scenesVisible": "gMmSave.saveInfo.scenesVisible",
    "gMmSave.skullTokenCount": "gMmSave.saveInfo.skullTokenCount",
    "gMmSave.unk_EC4": "gMmSave.saveInfo.unk_EA0",
    "gMmSave.unk_EC8": "gMmSave.saveInfo.unk_EA4",
    "gMmSave.unk_ECC": "gMmSave.saveInfo.unk_EA8",
    "gMmSave.stolenItems": "gMmSave.saveInfo.stolenItems",
    "gMmSave.unk_DD8": "gMmSave.saveInfo.unk_EB4",
    "gMmSave.bankRupees": "gMmSave.saveInfo.bankRupees",
    "gMmSave.unk_EE0": "gMmSave.saveInfo.unk_EBC",
    "gMmSave.unk_EE4": "gMmSave.saveInfo.unk_EC0",
    "gMmSave.unk_EE8": "gMmSave.saveInfo.unk_EC4",
    "gMmSave.horseBackBalloonHighScore": "gMmSave.saveInfo.horseBackBalloonHighScore",
    "gMmSave.lotteryCodeGuess": "gMmSave.saveInfo.lotteryCodeGuess",
    "gMmSave.shootingGalleryHighScores": "gMmSave.saveInfo.shootingGalleryHighScores",
    "gMmSave.weekEventReg": "gMmSave.saveInfo.weekEventReg",
    "gMmSave.regionsVisited": "gMmSave.saveInfo.regionsVisited",
    "gMmSave.worldMapCloudVisibility": "gMmSave.saveInfo.worldMapCloudVisibility",
    "gMmSave.unk_F64": "gMmSave.saveInfo.unk_F40",
    "gMmSave.unk_F65": "gMmSave.saveInfo.unk_F41",
    "gMmSave.scarecrowSpawnSong": "gMmSave.saveInfo.scarecrowSpawnSong",
    "gMmSave.bombersCaughtNum": "gMmSave.saveInfo.bombersCaughtNum",
    "gMmSave.bombersCaughtOrder": "gMmSave.saveInfo.bombersCaughtOrder",
    "gMmSave.lotteryCodes": "gMmSave.saveInfo.lotteryCodes",
    "gMmSave.spiderHouseMaskOrder": "gMmSave.saveInfo.spiderHouseMaskOrder",
    "gMmSave.bomberCode": "gMmSave.saveInfo.bomberCode",
    "gMmSave.horseData": "gMmSave.saveInfo.horseData",
    "gMmSave.checksum": "gMmSave.saveInfo.checksum",

    "gMmSave.daysElapsed": "gMmSave.eventDayCount",
