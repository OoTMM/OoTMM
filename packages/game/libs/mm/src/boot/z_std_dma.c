...
void DmaMgr_ThreadEntry(void* arg) {
    ...
    while (true) {
        ...
        osRecvMesg(&gDmaMgrMsgQueue, &msg, OS_MESG_BLOCK);
...
void DmaMgr_Init(void) {
    osCreateMesgQueue(&gDmaMgrMsgQueue, sDmaMgrMsgBuf, ARRAY_COUNT(sDmaMgrMsgBuf));
...
void DmaMgr_Stop(void) {
    osSendMesg(&gDmaMgrMsgQueue, NULL, OS_MESG_BLOCK);
}
