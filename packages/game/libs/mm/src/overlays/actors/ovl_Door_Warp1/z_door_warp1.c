...
void func_808B9CE8(DoorWarp1* this, PlayState* play) {
    ...
    if (!Actor_HasParent(&this->dyna.actor, play)) {
        Actor_OfferGetItem(&this->dyna.actor, play, (GI_MM_REMAINS_ODOLWA - 1) + func_808B849C(this, play), 30.0f, 80.0f);
        return;
    }

    switch (play->sceneId) {
        case SCENE_MITURIN_BS:
            gMmSave.saveInfo.unk_EA8[0] = (((void)0, gMmSave.saveInfo.unk_EA8[0]) & 0xFFFFFF00) |
                                                    (((u8)gMmSave.saveInfo.unk_EA8[1]) & 0xFF);
            break;

        case SCENE_HAKUGIN_BS:
            gMmSave.saveInfo.unk_EA8[0] = (((void)0, gMmSave.saveInfo.unk_EA8[0]) & 0xFFFF00FF) |
                                                    ((((u8)gMmSave.saveInfo.unk_EA8[1]) & 0xFF) << 8);
            break;

        case SCENE_INISIE_BS:
            gMmSave.saveInfo.unk_EA8[0] = (((void)0, gMmSave.saveInfo.unk_EA8[0]) & 0xFF00FFFF) |
                                                    ((((u8)gMmSave.saveInfo.unk_EA8[1]) & 0xFF) << 0x10);
            break;

        case SCENE_SEA_BS:
            gMmSave.saveInfo.unk_EA8[0] = (((void)0, gMmSave.saveInfo.unk_EA8[0]) & 0x00FFFFFF) |
                                                    ((((u8)gMmSave.saveInfo.unk_EA8[1]) & 0xFF) << 0x18);
            break;
    ...
    gMmSave.saveInfo.unk_EA8[1] = (gMmSave.saveInfo.unk_EA8[1] & 0xFFFFFF00) |
                                            ((((u8)gMmSave.saveInfo.unk_EA8[1]) + 1) & 0xFF);
...
void func_808BA10C(DoorWarp1* this, PlayState* play) {
    ...
    if ((play->sceneId == SCENE_MITURIN_BS) || (play->sceneId == SCENE_HAKUGIN_BS) ||
        ...
        if (this->unk_202 != 0) {
            ...
            switch (phi_v0_2) {
                case 0:
                    phi_a0 = gMmSave.saveInfo.unk_EA8[0] & 0xFF;
                    break;

                case 1:
                    phi_a0 = (gMmSave.saveInfo.unk_EA8[0] & 0xFF00) >> 8;
                    break;

                case 2:
                    phi_a0 = (gMmSave.saveInfo.unk_EA8[0] & 0xFF0000) >> 0x10;
                    break;

                case 3:
                    phi_a0 = (gMmSave.saveInfo.unk_EA8[0] & 0xFF000000) >> 0x18;
                    break;
