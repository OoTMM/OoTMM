...
void func_80837C78(PlayState* play, Player* this) {
    ...
    if (this->getItemId == GI_MM_HEART_CONTAINER) {
        this->av2.actionVar2 = 20;
...
s16 D_8085D1A4[PLAYER_IA_MAX] = {
    GI_NONE,                // PLAYER_IA_NONE
    GI_NONE,                // PLAYER_IA_LAST_USED
    GI_NONE,                // PLAYER_IA_FISHING_ROD
    GI_MM_SWORD_KOKIRI,         // PLAYER_IA_SWORD_KOKIRI
    GI_MM_SWORD_RAZOR,          // PLAYER_IA_SWORD_RAZOR
    GI_MM_SWORD_GILDED,         // PLAYER_IA_SWORD_GILDED
    GI_MM_GREAT_FAIRY_SWORD,    // PLAYER_IA_SWORD_TWO_HANDED
    GI_MM_STICK,                // PLAYER_IA_DEKU_STICK
    GI_MM_SWORD_KOKIRI,         // PLAYER_IA_ZORA_BOOMERANG
    GI_MM_BOW,                  // PLAYER_IA_BOW
    GI_MM_ARROW_FIRE,           // PLAYER_IA_BOW_FIRE
    GI_MM_ARROW_ICE,            // PLAYER_IA_BOW_ICE
    GI_MM_ARROW_LIGHT,          // PLAYER_IA_BOW_LIGHT
    GI_MM_HOOKSHOT,             // PLAYER_IA_HOOKSHOT
    GI_MM_BOMB,                 // PLAYER_IA_BOMB
    GI_MM_POWDER_KEG,           // PLAYER_IA_POWDER_KEG
    GI_MM_BOMBCHU_10,           // PLAYER_IA_BOMBCHU
    GI_NONE,                 // PLAYER_IA_11
    GI_MM_NUT,                  // PLAYER_IA_DEKU_NUT
    GI_MM_PICTOGRAPH_BOX,       // PLAYER_IA_PICTOGRAPH_BOX
    GI_MM_OCARINA_OF_TIME,      // PLAYER_IA_OCARINA
    GI_MM_BOTTLE_EMPTY,         // PLAYER_IA_BOTTLE_EMPTY
    GI_MM_FISH,                 // PLAYER_IA_BOTTLE_FISH
    GI_NONE,                 // PLAYER_IA_BOTTLE_SPRING_WATER
    GI_NONE,                 // PLAYER_IA_BOTTLE_HOT_SPRING_WATER
    GI_NONE,                 // PLAYER_IA_BOTTLE_ZORA_EGG
    GI_MM_GOLD_DUST,            // PLAYER_IA_BOTTLE_DEKU_PRINCESS
    GI_NONE,                 // PLAYER_IA_BOTTLE_GOLD_DUST
    GI_NONE,                 // PLAYER_IA_BOTTLE_1C
    GI_NONE,                 // PLAYER_IA_BOTTLE_SEAHORSE
    GI_NONE,                 // PLAYER_IA_BOTTLE_MUSHROOM
    GI_NONE,                 // PLAYER_IA_BOTTLE_HYLIAN_LOACH
    GI_MM_BUGS,                 // PLAYER_IA_BOTTLE_BUG
    GI_MM_POE,                  // PLAYER_IA_BOTTLE_POE
    GI_MM_BIG_POE,              // PLAYER_IA_BOTTLE_BIG_POE
    GI_MM_POTION_RED,           // PLAYER_IA_BOTTLE_POTION_RED
    GI_MM_POTION_BLUE,          // PLAYER_IA_BOTTLE_POTION_BLUE
    GI_MM_POTION_GREEN,         // PLAYER_IA_BOTTLE_POTION_GREEN
    GI_NONE,                 // PLAYER_IA_BOTTLE_MILK
    GI_NONE,                 // PLAYER_IA_BOTTLE_MILK_HALF
    GI_MM_CHATEAU,              // PLAYER_IA_BOTTLE_CHATEAU
    GI_MM_FAIRY,                // PLAYER_IA_BOTTLE_FAIRY
    GI_MM_MOON_TEAR,            // PLAYER_IA_MOONS_TEAR
    GI_MM_DEED_LAND,            // PLAYER_IA_DEED_LAND
    GI_MM_ROOM_KEY,             // PLAYER_IA_ROOM_KEY
    GI_MM_LETTER_TO_KAFEI,      // PLAYER_IA_LETTER_TO_KAFEI
    GI_MM_MAGIC_BEAN,           // PLAYER_IA_MAGIC_BEANS
    GI_MM_DEED_SWAMP,           // PLAYER_IA_DEED_SWAMP
    GI_MM_DEED_MOUNTAIN,        // PLAYER_IA_DEED_MOUNTAIN
    GI_MM_DEED_OCEAN,           // PLAYER_IA_DEED_OCEAN
    GI_MM_MOON_TEAR,            // PLAYER_IA_32
    GI_MM_LETTER_TO_MAMA,       // PLAYER_IA_LETTER_MAMA
    GI_NONE,                 // PLAYER_IA_34
    GI_NONE,                 // PLAYER_IA_35
    GI_MM_PENDANT_OF_MEMORIES,  // PLAYER_IA_PENDANT_OF_MEMORIES
    GI_MM_PENDANT_OF_MEMORIES,  // PLAYER_IA_37
    GI_MM_PENDANT_OF_MEMORIES,  // PLAYER_IA_38
    GI_MM_PENDANT_OF_MEMORIES,  // PLAYER_IA_39
    GI_MM_MASK_TRUTH,           // PLAYER_IA_MASK_TRUTH
    GI_MM_MASK_KAFEI,           // PLAYER_IA_MASK_KAFEIS_MASK
    GI_MM_MASK_ALL_NIGHT,       // PLAYER_IA_MASK_ALL_NIGHT
    GI_MM_MASK_BUNNY,           // PLAYER_IA_MASK_BUNNY
    GI_MM_MASK_KEATON,          // PLAYER_IA_MASK_KEATON
    GI_MM_MASK_GARO,            // PLAYER_IA_MASK_GARO
    GI_MM_MASK_ROMANI,          // PLAYER_IA_MASK_ROMANI
    GI_MM_MASK_TROUPE_LEADER,   // PLAYER_IA_MASK_CIRCUS_LEADER
    GI_MM_MASK_POSTMAN,         // PLAYER_IA_MASK_POSTMAN
    GI_MM_MASK_COUPLE,          // PLAYER_IA_MASK_COUPLE
    GI_MM_MASK_GREAT_FAIRY,     // PLAYER_IA_MASK_GREAT_FAIRY
    GI_MM_MASK_GIBDO,           // PLAYER_IA_MASK_GIBDO
    GI_MM_MASK_DON_GERO,        // PLAYER_IA_MASK_DON_GERO
    GI_MM_MASK_KAMARO,          // PLAYER_IA_MASK_KAMARO
    GI_MM_MASK_CAPTAIN,         // PLAYER_IA_MASK_CAPTAIN
    GI_MM_MASK_STONE,           // PLAYER_IA_MASK_STONE
    GI_MM_MASK_BREMEN,          // PLAYER_IA_MASK_BREMEN
    GI_MM_MASK_BLAST,           // PLAYER_IA_MASK_BLAST
    GI_MM_MASK_SCENTS,          // PLAYER_IA_MASK_SCENTS
    GI_MM_MASK_GIANT,           // PLAYER_IA_MASK_GIANT
    GI_MM_MASK_FIERCE_DEITY,    // PLAYER_IA_MASK_FIERCE_DEITY
    GI_MM_MASK_GORON,           // PLAYER_IA_MASK_GORON
    GI_MM_MASK_ZORA,            // PLAYER_IA_MASK_ZORA
    GI_MM_MASK_DEKU,            // PLAYER_IA_MASK_DEKU
    GI_MM_LENS,                 // PLAYER_IA_LENS_OF_TRUTH
};
                    ...
                    if (this->getItemId != GI_NONE) {
                        if (CHECK_BTN_ALL(sPlayerControlInput->press.button, BTN_A)) {
                            ...
                            if ((giEntry->itemId != ITEM_NONE) &&
                                ...
                                this->getItemId =
                                    (giEntry->itemId == ITEM_MASK_CAPTAIN) ? -GI_MM_RECOVERY_HEART : -GI_MM_RUPEE_BLUE;
...
s32 func_808482E0(PlayState* play, Player* this) {
    ...
    if (this->av1.actionVar1 == 0) {
        ...
        if ((this->getItemId >= GI_MM_MASK_DEKU) && (this->getItemId <= GI_MM_MASK_KAFEI)) {
            Audio_PlayFanfare(NA_BGM_GET_NEW_MASK);
        } else if (((this->getItemId >= GI_MM_RUPEE_GREEN) && (this->getItemId <= GI_MM_RUPEE_RED)) ||
                   (this->getItemId == GI_MM_RECOVERY_HEART)) {
            Audio_PlaySfx(NA_SE_SY_GET_BOXITEM);
        } else {
            s32 seqId;

            if ((this->getItemId == GI_MM_HEART_CONTAINER) ||
                ((this->getItemId == GI_MM_HEART_PIECE) && EQ_MAX_QUEST_HEART_PIECE_COUNT)) {
                seqId = NA_BGM_GET_HEART | 0x900;
            } else {
                s32 var_v1;

                if ((this->getItemId == GI_MM_HEART_PIECE) ||
                    ((this->getItemId >= GI_MM_RUPEE_PURPLE) && (this->getItemId <= GI_MM_RUPEE_GOLD))) {
        ...
        if (this->getItemId == GI_MM_OCARINA_OF_TIME) {
...
void Player_Action_65(Player* this, PlayState* play) {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->av2.actionVar2 != 0) {
            ...
            if ((this->getItemId == GI_MM_STRAY_FAIRY) || (this->getItemId == GI_OOT_ICE_TRAP)) {
                Player_StopCutscene(this);
                this->stateFlags1 &= ~(PLAYER_STATE1_400 | PLAYER_STATE1_CARRYING_ACTOR);
                if (this->getItemId == GI_MM_STRAY_FAIRY) {
                    func_80839E74(this, play);
                } else {
    ...
    if (PlayerAnimation_Update(play, &this->skelAnime)) {
        if (this->av2.actionVar2 == 0) {
            ...
            if (Actor_HasParent(&this->actor, play)) {
                ...
                Actor_OfferGetItem(&this->actor, play, GI_MM_PENDANT_OF_MEMORIES, 9999.9f, 9999.9f);
            }
        }
    } else if (PlayerAnimation_OnFrame(&this->skelAnime, 4.0f)) {
