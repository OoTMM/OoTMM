...
u8 D_80ADFB38[PLAYER_FORM_MAX][2] = {
    { GI_MM_RUPEE_PURPLE, GI_MM_RUPEE_PURPLE }, // PLAYER_FORM_FIERCE_DEITY
    { GI_MM_HEART_PIECE, GI_MM_RUPEE_PURPLE },  // PLAYER_FORM_GORON
    { GI_MM_RUPEE_RED, GI_MM_RUPEE_RED },       // PLAYER_FORM_ZORA
    { GI_MM_NUTS_10, GI_MM_NUTS_5 },  // PLAYER_FORM_DEKU
    { GI_MM_RUPEE_PURPLE, GI_MM_RUPEE_PURPLE }, // PLAYER_FORM_HUMAN
};
