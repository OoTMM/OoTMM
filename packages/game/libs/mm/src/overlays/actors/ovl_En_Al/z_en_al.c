...
MsgScript D_80BDFDF8[] = {
    ...
    /* 0x0049 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_BOTTLE_CHATEAU, 0x0),
    ...
    /* 0x005C 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_PURPLE, 0x0),
...
MsgScript D_80BDFE8C[] = {
    ...
    /* 0x0025 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_MASK_KAFEI, 0x0),
...
MsgScript D_80BDFED4[] = {
    ...
    /* 0x001C 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_BOTTLE_CHATEAU, 0x0),
    ...
    /* 0x002F 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_PURPLE, 0x0),
...
MsgScript D_80BDFF24[] = {
    ...
    /* 0x0039 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_BOTTLE_CHATEAU, 0x0),
    ...
    /* 0x004C 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_PURPLE, 0x0),
