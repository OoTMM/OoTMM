...
static MsgScript D_80AE6F00[] = {
    ...
    /* 0x00A4 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_HEART_PIECE, 0x0),
    ...
    /* 0x00BB 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_SILVER, 0x0),
    ...
    /* 0x00DD 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_HEART_PIECE, 0x0),
    ...
    /* 0x00F4 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_SILVER, 0x0),
    ...
    /* 0x0101 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_RED, 0x0),
    ...
    /* 0x0114 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_BLUE, 0x0),
...
static MsgScript D_80AE70B8[] = {
    ...
    /* 0x0076 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_HEART_PIECE, 0x0),
    ...
    /* 0x008D 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_SILVER, 0x0),
    ...
    /* 0x00AE 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_HEART_PIECE, 0x0),
    ...
    /* 0x00C5 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_SILVER, 0x0),
    ...
    /* 0x00D2 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_RED, 0x0),
    ...
    /* 0x00E5 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_BLUE, 0x0),
...
void EnShn_Init(Actor* thisx, PlayState* play) {
    ...
    this->unk_1D8 = 0;
    if (gMmSave.entrance != ENTRANCE(TOURIST_INFORMATION, 2)) {
        SubS_SetOfferMode(&this->unk_1D8, SUBS_OFFER_MODE_ONSCREEN, SUBS_OFFER_MODE_MASK);
        this->unk_2BE = 0;
    } else {
