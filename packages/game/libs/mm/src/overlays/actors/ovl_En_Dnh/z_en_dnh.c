...
MsgScript D_80A51250[] = {
    ...
    /* 0x002D 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_PICTOGRAPH_BOX, 0x0),
...
MsgScript D_80A5138C[] = {
    ...
    /* 0x002E 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_HEART_PIECE, 0x0),
    ...
    /* 0x0059 0x05 */ MSCRIPT_CMD_OFFER_ITEM(GI_MM_RUPEE_PURPLE, 0x0),
