...
static int addItemPictoBoom(PlayState* play, u8 itemId, s16 gi, u16 param)
{
    itemId = kMmPictoBoom[param];
...
static const SharedItem kSimpleSharedItems[] = {
    ...
    { CFG_SHARED_SONG_GORON, GI_OOT_SONG_GORON_HALF, GI_MM_SONG_GORON_HALF },
    ...
    { CFG_SHARED_SOULS_ENEMY, GI_OOT_SOUL_ENEMY_LIZALFOS_DINOLFOS, GI_MM_SOUL_ENEMY_LIZALFOS_DINOLFOS },
    ...
    { CFG_SHARED_SOULS_ENEMY, GI_OOT_SOUL_ENEMY_POE, GI_MM_SOUL_ENEMY_POE },
    ...
    { CFG_SHARED_SOULS_ANIMAL, GI_OOT_SOUL_ANIMAL_CUCCO, GI_MM_SOUL_ANIMAL_CUCCO },
    { CFG_SHARED_SOULS_ANIMAL, GI_OOT_SOUL_ANIMAL_COW, GI_MM_SOUL_ANIMAL_COW },
    { CFG_SHARED_SOULS_ANIMAL, GI_OOT_SOUL_ANIMAL_DOG, GI_MM_SOUL_ANIMAL_DOG },
