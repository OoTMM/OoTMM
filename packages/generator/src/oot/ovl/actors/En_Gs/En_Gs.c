...
#include <assets/oot/objects/object_gs.h>
    ...
    switch (Message_GetState(&play->msgCtx)) {
        case TEXT_STATE_DONE:
            if (Message_ShouldAdvance(play)) {
                switch (this->actor.messageId) {
                    case 0x2054:
                        this->actor.messageId = PARAMS_GET_U(this->actor.params, 0, 8) + 0x400;
                        ret = 1;
                        break;
                    default:
                        ret = 0;
...
void func_80A4E648(EnGs* this, PlayState* play) {
    ...
    if (this->unk_19C == 1) {
        Message_ContinueTextbox(play, this->actor.messageId);
        this->unk_19C = 2;
        ...
        if ((sp26 >= 0) && (sp26 <= 320) && (sp24 >= 0) && (sp24 <= 240) && (this->unk_19C != 3)) {
            if (Actor_OfferTalk(&this->actor, play, 40.0f) == 1) {
                if (Player_GetMask(play) == 0x08 /* PLAYER_MASK_TRUTH */) {
                    this->actor.messageId = 0x2054;
                } else {
                    this->actor.messageId = 0x2053;
                }
            }
        }
    }
...
void func_80A4ED34(EnGs* this, PlayState* play) {
        ...
        if ((this->unk_200 < 80) && ((this->unk_200 % 20) < 8)) {
            if (this->unk_200 < 20) {
                ...
                if ((this->unk_200 % 20) == 7) {
                    Sfx_PlaySfxCentered(NA_SE_SY_WARNING_COUNT_E);
                }
            } else {
                Color_RGBA8_Copy(&this->flashColor, &flashBlue);
                if ((this->unk_200 % 20) == 7) {
                    Sfx_PlaySfxCentered(NA_SE_SY_WARNING_COUNT_N);
                }
            }
        }
        if (this->unk_200 <= 0) {
    ...
    if (this->unk_19F == 4) {
        Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 20.0f, 60.0f, UPDBGCHECKINFO_FLAG_OOT_0 | UPDBGCHECKINFO_FLAG_OOT_1);
...
void func_80A4F13C(EnGs* this, PlayState* play) {
    ...
    if (this->unk_19F == 1) {
        ...
        this->unk_1A0[0].y += DEG_TO_BINANG(this->unk_1E8);
        if (tmpf1 == 0.0f) {
            this->unk_200 = 0;
            this->unk_19F = 2;
        }
    ...
    if (this->unk_19F == 3) {
        this->unk_1A0[0].y += DEG_TO_BINANG(90.0f);
    ...
    if (this->unk_19F == 4) {
        tmpf1 = Math_SmoothStepToF(&this->unk_1E8, this->unk_1EC, 0.8f, DEG_TO_BINANG(90.0f), DEG_TO_BINANG(20.0f));
    ...
    if (this->unk_19F == 5) {
        ...
        this->unk_1E8 = tmp;
        tmpf1 = Math_SmoothStepToF(&this->unk_1E8, this->unk_1EC, 0.8f, DEG_TO_BINANG(20.0f), 0.001f);
