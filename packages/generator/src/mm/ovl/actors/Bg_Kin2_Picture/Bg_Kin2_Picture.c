...
#include "Bg_Kin2_Picture.h"
#include <assets/mm/objects/object_kin2_obj.h>
...
static InitChainEntry sInitChain[] = {
    ...
    ICHAIN_F32(cullingVolumeDownward, 100, ICHAIN_CONTINUE), ICHAIN_VEC3F_DIV1000(scale, 100, ICHAIN_STOP),
};

int BgKin2Picture_IsSkulltulaCollected(PlayState* play, s32 skulltulaParams) {
    s32 flag = -1;
...
void BgKin2Picture_Init(Actor* thisx, PlayState* play) {
    ...
    DynaPolyActor_LoadMesh(play, &this->dyna, (void*)gOceanSpiderHouseSkullkidPaintingCol);
...
OVL_INFO_ACTOR(ACTOR_BG_KIN2_PICTURE, Bg_Kin2_Picture_Profile);
