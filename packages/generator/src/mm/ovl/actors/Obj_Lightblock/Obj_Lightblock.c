...
#include "Obj_Lightblock.h"
#include "assets/mm/objects/object_lightblock.h"
...
void ObjLightblock_SetupWait(Actor_ObjLightblock* this);
void ObjLightblock_Wait(Actor_ObjLightblock* this, PlayState* play);
void ObjLightblock_SetupPlayCutscene(Actor_ObjLightblock* this);
void ObjLightblock_PlayCutscene(Actor_ObjLightblock* this, PlayState* play);
void ObjLightblock_SetupFadeAway(Actor_ObjLightblock* this);
void ObjLightblock_FadeAway(Actor_ObjLightblock* this, PlayState* play);
...
static LightblockTypeVars sLightblockTypeVars[] = {
    { 0.1f, 76, 80, 19, 2 /*DEMO_EFFECT_TIMEWARP_LIGHTBLOCK_LARGE*/ },
    { (1.0f / 6.0f), 126, 144, 19, 3 /*DEMO_EFFECT_TIMEWARP_LIGHTBLOCK_VERY_LARGE*/ },
};
...
void ObjLightblock_SpawnEffect(Actor_ObjLightblock* this, PlayState* play) {
...
void ObjLightblock_Init(Actor* thisx, PlayState* play) {
    Actor_ObjLightblock* this = (Actor_ObjLightblock*)thisx;
    LightblockTypeVars* typeVars = &sLightblockTypeVars[LIGHTBLOCK_TYPE(&this->dyna.actor)];
    ...
    DynaPolyActor_LoadMesh(play, &this->dyna, (CollisionHeader*)gSunBlockCol);
...
void ObjLightblock_Wait(Actor_ObjLightblock* this, PlayState* play) {
    ...
    if ((Config_Flag(CFG_MM_EASY_LIGHTBLOCKS) && (this->collisionCounter >= 1)) || (this->collisionCounter >= 8)) {
...
OVL_INFO_ACTOR(ACTOR_OBJ_LIGHTBLOCK, Obj_Lightblock_Profile);
