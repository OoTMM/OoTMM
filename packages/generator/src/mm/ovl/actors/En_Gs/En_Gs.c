...
OVL_INFO_ACTOR(ACTOR_EN_GS, En_Gs_Profile);
...
s8 func_80997A90(s16 arg0, s16 arg1) {
    ...
    if ((arg0 == 0) || ((arg0 != 1) && (arg0 != 2) && (arg0 == 3))) {
        ...
        phi_v1 = (gSaveContext.save.info.unk_EA0 >> (arg1 * 3)) & 7;
    }
    return phi_v1;
}
...
void func_809985B8(EnGs* this, PlayState* play) {
    ...
    if (SubS_StartCutscene(&this->actor, this->csIdList[0], CS_ID_NONE, SUBS_CUTSCENE_WITH_PLAYER)) {
        ...
        this->unk_200 = 0.0f;
        gSaveContext.save.info.unk_EA0 = ((u32)gSaveContext.save.info.unk_EA0 & ~(7 << (this->unk_198 * 3))) | ((this->unk_194 & 7) << (this->unk_198 * 3));
        gossipStone = NULL;
...
void func_8099874C(EnGs* this, PlayState* play) {
    ...
    if (phi_v0 == 0) {
        ...
        if ((this->unk_19C == 5) && (this->unk_194 != 0)) {
            ...
            for (i = 0; i < 4; i++) {
                if (((gSaveContext.save.info.unk_EA0 >> (i * 3)) & 7) != (u32)this->unk_194) {
                    phi_v0 = 0;
                }
            }
            ...
            if (phi_v0 != 0) {
                ...
                switch (this->unk_194) {
                    case 1:
                        if (!MM_GET_EVENT_WEEK(EV_MM_77_08)) {
                            this->getItemId = GI_MM_RUPEE_SILVER;
                            MM_SET_EVENT_WEEK(EV_MM_77_08);
                        }
                        break;

                    case 3:
                        if (!MM_GET_EVENT_WEEK(EV_MM_77_10)) {
                            this->getItemId = GI_MM_RUPEE_SILVER;
                            MM_SET_EVENT_WEEK(EV_MM_77_10);
                        }
                        break;

                    case 2:
                        if (!MM_GET_EVENT_WEEK(EV_MM_77_20)) {
                            this->getItemId = GI_MM_RUPEE_SILVER;
                            MM_SET_EVENT_WEEK(EV_MM_77_20);
                        }
                        break;
                ...
                if (!MM_GET_EVENT_WEEK(EV_MM_WEEK_GOSSIP_STONES_HEART_PIECE)) {
                    MM_SET_EVENT_WEEK(EV_MM_WEEK_GOSSIP_STONES_HEART_PIECE);
...
s32 func_80998F9C(EnGs* this, PlayState* play) {
    ...
    if (this->unk_19D == 1) {
        ...
        this->unk_19E[0].y += (s32)DEG_TO_BINANG(this->unk_1DC);
        if (sp48 == 0.0f) {
            this->unk_1D4 = 0;
            this->unk_19D = 2;
        }
...
s32 func_809995A4(EnGs* this, PlayState* play) {
    ...
    if (this->unk_19D == 4) {
        Actor_UpdateBgCheckInfo(play, &this->actor, 20.0f, 20.0f, 60.0f, UPDBGCHECKINFO_FLAG_MM_1 | UPDBGCHECKINFO_FLAG_MM_2);
        ...
        if (this->actor.yDistanceFromLink < -12000.0f) {
            Actor_Spawn(&play->actorCtx, play, ACTOR_EN_BOM, this->actor.world.pos.x, this->actor.world.pos.y,
                        this->actor.world.pos.z, 0 /*BOMB_EXPLOSIVE_TYPE_BOMB*/, this->actor.world.rot.y, 0, 0 /*BOMB_TYPE_BODY*/);
...
void EnGs_Update(Actor* thisx, PlayState* play) {
    ...
    if (Actor_TalkOfferAccepted(&this->actor, &play->state)) {
        ...
        if ((this->actor.flags & ACTOR_FLAG_INSIDE_CULLING_VOLUME) || (this->unk_19A & 0x100) ||
            ...
            if ((this->actor.xyzDistToPlayerSq > SQ(400.0f)) || (screenPosX < 0) || (screenPosX > 320) ||
                (screenPosY < 0) || (screenPosY > 240)) {
                this->unk_216 = 0;
