...
#define OCARINA_SONG_CUSTOM_START               0x20
#define OCARINA_SONG_CUSTOM_MINUET              0x20
#define OCARINA_SONG_CUSTOM_BOLERO              0x21
#define OCARINA_SONG_CUSTOM_SERENADE            0x22
#define OCARINA_SONG_CUSTOM_REQUIEM             0x23
#define OCARINA_SONG_CUSTOM_NOCTURNE            0x24
#define OCARINA_SONG_CUSTOM_PRELUDE             0x25
...
typedef enum OcarinaSongActionId {
    ...
    /* 0x32 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_SOARING,
    /* 0x33 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_TIME,
    /* 0x34 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_ELEGY,
    /* 0x35 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_DOUBLE_TIME,
    /* 0x36 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_HEALING,
    /* 0x37 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_AWAKENING,
    /* 0x38 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_GORON,
    /* 0x39 */ OCARINA_ACTION_CHECK_CUSTOM_SONG_GORON_HALF,
    /* 0x3A */ OCARINA_ACTION_CHECK_CUSTOM_SONG_ZORA,
    /* 0x3B */ OCARINA_ACTION_CHECK_CUSTOM_SONG_ORDER,
    /* 0x3C */ OCARINA_ACTION_CHECK_MAX,
} OcarinaSongActionId;
