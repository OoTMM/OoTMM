...
#define gTriforceCount              SAVE_EXTRA_RECORD(u32,              14)
#define gOotExtraAmmo               SAVE_EXTRA_RECORD(OotExtraAmmo,     15)
#define gMmExtraAmmo                SAVE_EXTRA_RECORD(MmExtraAmmo,      16)
