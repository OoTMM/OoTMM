...
const ITEM_NAMES: {[k in ItemID]: string} = {
  ...
  MM_BOTTLE_RANDOM: "Random Bottle (MM)",
  ...
  MM_CLOCK: "Progressive Clock (MM)",
  MM_CLOCK1: "Clock (MM, Day 1)",
  MM_CLOCK2: "Clock (MM, Night 1)",
  MM_CLOCK3: "Clock (MM, Day 2)",
  MM_CLOCK4: "Clock (MM, Night 2)",
  MM_CLOCK5: "Clock (MM, Day 3)",
  MM_CLOCK6: "Clock (MM, Night 3)",
  ...
  MM_DEKU_SEEDS_30: "30 Deku Seeds (MM)",
  MM_DEKU_SEEDS_5: "5 Deku Seeds (MM)",
  MM_FAIRY_BIG: 'Big Fairy (MM)',
  MM_FAIRY: "Fairy (MM)",
  MM_FISH: "Fish (MM)",
  MM_GREAT_FAIRY_SWORD: "Great Fairy's Sword (MM)",
  ...
  MM_RUSTY_KEY_BENEATH_GRAVEYARD: "Rusty Key (Beneath the Graveyard)",
  MM_RUSTY_KEY_BLACKSMITH: "Rusty Key (Blacksmith)",
  MM_RUSTY_KEY_BOMB_SHOP: "Rusty Key (Bomb Shop)",
  MM_RUSTY_KEY_CUCCO_SHACK: "Rusty Key (Cucco Shack)",
  MM_RUSTY_KEY_CURIOSITY_SHOP: "Rusty Key (Curiosity Shop)",
  MM_RUSTY_KEY_DAMPE_HOUSE: "Rusty Key (Dampe's House)",
  MM_RUSTY_KEY_DOG_RACETRACK: "Rusty Key (Doggy Racetrack)",
  MM_RUSTY_KEY_GRANDMA_ROOM: "Rusty Key (Grandma's Room)",
  MM_RUSTY_KEY_HONEY_DARLING: "Rusty Key (Honey & Darling)",
  MM_RUSTY_KEY_KAFEI_HIDEOUT: "Rusty Key (Kafei's Hideout)",
  MM_RUSTY_KEY_LABORATORY: "Rusty Key (Oceanic Laboratory)",
  MM_RUSTY_KEY_LOTTERY: "Rusty Key (Lottery)",
  MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI: "Rusty Key (Kafei's Room)",
  MM_RUSTY_KEY_MAYOR_RESIDENCE_OFFICE: "Rusty Key (Mayor's Residence Office)",
  MM_RUSTY_KEY_MAYOR_RESIDENCE_SALON: "Rusty Key (Mayor's Residence Salon)",
  MM_RUSTY_KEY_MAYOR_RESIDENCE: "Rusty Key (Mayor's Residence)",
  MM_RUSTY_KEY_MILK_BAR: "Rusty Key (Milk Bar)",
  MM_RUSTY_KEY_MUSIC_HOUSE: "Rusty Key (Music House)",
  MM_RUSTY_KEY_OBSERVATORY: "Rusty Key (Observatory)",
  MM_RUSTY_KEY_POST_OFFICE: "Rusty Key (Post Office)",
  MM_RUSTY_KEY_POTION_SHOP: "Rusty Key (Potion Shop)",
  MM_RUSTY_KEY_RANCH_BARN: "Rusty Key (Romani Ranch Barn)",
  MM_RUSTY_KEY_RANCH_HOUSE_ROOM: "Rusty Key (Romani's Room)",
  MM_RUSTY_KEY_RANCH_HOUSE: "Rusty Key (Romani Ranch House)",
  MM_RUSTY_KEY_STOCK_POT_INN_DORMITORY: "Rusty Key (Stock Pot Inn Dormitory)",
  MM_RUSTY_KEY_STOCK_POT_INN_ROOF: "Rusty Key (Stock Pot Inn Roof)",
  MM_RUSTY_KEY_STOCK_POT_INN_STAFF_ROOM: "Rusty Key (Stock Pot Inn Staff Room)",
  MM_RUSTY_KEY_STOCK_POT_INN: "Rusty Key (Stock Pot Inn)",
  MM_RUSTY_KEY_SWAMP_ARCHERY: "Rusty Key (Swamp Archery)",
  MM_RUSTY_KEY_SWORDSMAN_SCHOOL: "Rusty Key (Swordsman School)",
  MM_RUSTY_KEY_TOURIST_INFORMATION: "Rusty Key (Tourist Information)",
  MM_RUSTY_KEY_TOWN_ARCHERY: "Rusty Key (Town Archery)",
  MM_RUSTY_KEY_TRADING_POST: "Rusty Key (Trading Post)",
  MM_RUSTY_KEY_TREASURE_CHEST_GAME: "Rusty Key (Treasure Game)",
  MM_RUSTY_KEY_ZORA_EVAN_ROOM: "Rusty Key (Evan's Room)",
  MM_RUSTY_KEY_ZORA_JAPAS_ROOM: "Rusty Key (Japas' Room)",
  MM_RUSTY_KEY_ZORA_LULU_ROOM: "Rusty Key (Lulu's Room)",
  MM_RUSTY_KEY_ZORA_SHOP: "Rusty Key (Zora Shop)",
  MM_RUSTY_KEY_ZORA_TIJO_ROOM: "Rusty Key (Tijo's Room)",
  MM_SCALE: "Progressive Scale (MM)",
  MM_SHIELD_DEKU: "Deku Shield (MM)",
  MM_SHIELD_HERO: "Hero's Shield (MM)",
  MM_SHIELD_HYLIAN: "Hylian Shield (MM)",
  MM_SHIELD_MIRROR: "Mirror Shield (MM)",
  MM_SHIELD: "Progressive Shield (MM)",
  MM_SHOVEL: "Shovel (MM)",
  MM_SKELETON_KEY: "Skeleton Key (MM)",
  MM_SLINGSHOT: 'Fairy Slingshot (MM)',
  ...
  MM_SONG_AWAKENING: "Sonata of Awakening (MM)",
  MM_SONG_EMPTINESS: "Elegy of Emptiness (MM)",
  MM_SONG_EPONA: "Epona's Song (MM)",
  MM_SONG_GORON_HALF: "Progressive Goron Lullaby (MM)",
  MM_SONG_GORON: "Goron Lullaby (MM)",
  MM_SONG_HEALING: "Song of Healing (MM)",
  MM_SONG_NOTE_AWAKENING: "Note from Sonata of Awakening (MM)",
  MM_SONG_NOTE_EMPTINESS: "Note from Elegy of Emptiness (MM)",
  MM_SONG_NOTE_EPONA: "Note from Epona's Song (MM)",
  MM_SONG_NOTE_GORON: "Note from Goron Lullaby (MM)",
  MM_SONG_NOTE_HEALING: "Note from Song of Healing (MM)",
  MM_SONG_NOTE_ORDER: "Note from Oath to Order (MM)",
  MM_SONG_NOTE_SARIA: "Note from Saria's Song (MM)",
  MM_SONG_NOTE_SOARING: "Note from Song of Soaring (MM)",
  MM_SONG_NOTE_STORMS: "Note from Song of Storms (MM)",
  MM_SONG_NOTE_SUN: "Note from Sun's Song (MM)",
  MM_SONG_NOTE_TIME: "Note from Song of Time (MM)",
  MM_SONG_NOTE_TP_FIRE: "Note from Bolero of Fire (MM)",
  MM_SONG_NOTE_TP_FOREST: "Note from Minuet of Forest (MM)",
  MM_SONG_NOTE_TP_LIGHT: "Note from Prelude of Light (MM)",
  MM_SONG_NOTE_TP_SHADOW: "Note from Nocturne of Shadow (MM)",
  MM_SONG_NOTE_TP_SPIRIT: "Note from Requiem of Spirit (MM)",
  MM_SONG_NOTE_TP_WATER: "Note from Serenade of Water (MM)",
  MM_SONG_NOTE_ZELDA: "Note from Zelda's Lullaby (MM)",
  MM_SONG_NOTE_ZORA: "Note from New Wave Bossa Nova (MM)",
  MM_SONG_ORDER: "Oath to Order (MM)",
  MM_SONG_SARIA: "Saria's Song (MM)",
  MM_SONG_SOARING: "Song of Soaring (MM)",
  MM_SONG_STORMS: "Song of Storms (MM)",
  MM_SONG_SUN: "Sun's Song (MM)",
  MM_SONG_TIME: "Song of Time (MM)",
  MM_SONG_TP_FIRE: "Bolero of Fire (MM)",
  MM_SONG_TP_FOREST: "Minuet of Forest (MM)",
  MM_SONG_TP_LIGHT: "Prelude of Light (MM)",
  MM_SONG_TP_SHADOW: "Nocturne of Shadow (MM)",
  MM_SONG_TP_SPIRIT: "Requiem of Spirit (MM)",
  MM_SONG_TP_WATER: "Serenade of Water (MM)",
  MM_SONG_ZELDA: "Zelda's Lullaby (MM)",
  MM_SONG_ZORA: "New Wave Bossa Nova (MM)",
  MM_SOUL_ANIMAL_BUTTERFLY: 'Soul of Butterflies (MM)',
  MM_SOUL_ANIMAL_COW: 'Soul of Cows (MM)',
  MM_SOUL_ANIMAL_CUCCO: 'Soul of Cuccos (MM)',
  MM_SOUL_ANIMAL_DOG: 'Soul of Dogs (MM)',
  ...
  MM_SOUL_ENEMY_LIZALFOS_DINOLFOS: "Soul of Lizalfos/Dinolfos (MM)",
  ...
  MM_SOUL_NPC_BEAN_SALESMAN: "Soul of the Bean Salesman (MM)",
  ...
  MM_SPIN_UPGRADE: "Spin Attack Upgrade (MM)",
  MM_STICK_UPGRADE: "Deku Stick Upgrade (MM)",
  MM_STICK: "Deku Stick (MM)",
  MM_STONE_OF_AGONY: "Stone of Agony (MM)",
  ...
  MM_SWORD_BIGGORON: "Biggoron's Sword (MM)",
  MM_SWORD_GORON: "Progressive Goron Sword (MM)",
  MM_SWORD_KNIFE: "Giant's Knife (MM)",
  MM_SWORD_MASTER: "Master Sword (MM)",
  ...
  OOT_BOTTLE_CHATEAU: "Bottle of Chateau Romani",
  ...
  OOT_BOTTLE_RANDOM: "Random Bottle (OoT)",
  ...
  OOT_GREAT_FAIRY_SWORD: "Great Fairy's Sword (OoT)",
  ...
  OOT_RUPEE_RAINBOW: "Rainbow Rupee (OoT)",
  ...
  OOT_RUSTY_KEY_ADULT_BAZAAR: "Rusty Key (Adult Bazaar)",
  OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK: "Rusty Key (Adult Potion Shop Back)",
  OOT_RUSTY_KEY_ADULT_POTION_SHOP: "Rusty Key (Adult Potion Shop)",
  OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY: "Rusty Key (Adult Shooting Gallery)",
  OOT_RUSTY_KEY_BACK_ALLEY_HOUSE: "Rusty Key (Back Alley House)",
  OOT_RUSTY_KEY_BOMBCHU_BOWLING: "Rusty Key (Bombchu Bowling)",
  OOT_RUSTY_KEY_BOMBCHU_SHOP: "Rusty Key (Bombchu Shop)",
  OOT_RUSTY_KEY_CARPENTER_HOUSE: "Rusty Key (Carpenter House)",
  OOT_RUSTY_KEY_CHILD_BAZAAR: "Rusty Key (Child Bazaar)",
  OOT_RUSTY_KEY_CHILD_POTION_SHOP: "Rusty Key (Child Potion Shop)",
  OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY: "Rusty Key (Child Shooting Gallery)",
  OOT_RUSTY_KEY_DOG_LADY_HOUSE: "Rusty Key (Dog Lady House)",
  OOT_RUSTY_KEY_FISHING_POND: "Rusty Key (Fishing Pond)",
  OOT_RUSTY_KEY_GRANNY_POTION_SHOP: "Rusty Key (Granny Potion Shop)",
  OOT_RUSTY_KEY_GRAVEYARD: "Rusty Key (Kakariko Graveyard Hut)",
  OOT_RUSTY_KEY_GUARD_HOUSE: "Rusty Key (Guard House)",
  OOT_RUSTY_KEY_HYRULE_CASTLE: "Rusty Key (Hyrule Castle)",
  OOT_RUSTY_KEY_IMPA_HOUSE: "Rusty Key (Impa's House)",
  OOT_RUSTY_KEY_LABORATORY: "Rusty Key (Laboratory)",
  OOT_RUSTY_KEY_MASK_SHOP: "Rusty Key (Mask Shop)",
  ...
  OOT_RUSTY_KEY_SKULLTULA_HOUSE: "Rusty Key (Skulltula House)",
  OOT_RUSTY_KEY_TREASURE_CHEST_GAME: "Rusty Key (Treasure Chest Game)",
  OOT_RUSTY_KEY_WINDMILL: "Rusty Key (Windmill)",
  OOT_SCALE: "Progressive Scale (OoT)",
  OOT_SHIELD_DEKU: "Deku Shield (OoT)",
  OOT_SHIELD_HERO: "Hero's Shield (OoT)",
  OOT_SHIELD_HYLIAN: "Hylian Shield (OoT)",
  ...
  OOT_SLINGSHOT: "Fairy Slingshot (OoT)",
  ...
  OOT_SONG_AWAKENING: "Sonata of Awakening (OoT)",
  OOT_SONG_EMPTINESS: "Elegy of Emptiness (OoT)",
  OOT_SONG_EPONA: "Epona's Song (OoT)",
  OOT_SONG_GORON_HALF: "Progressive Goron Lullaby (OoT)",
  OOT_SONG_GORON: "Goron Lullaby (OoT)",
  OOT_SONG_HEALING: "Song of Healing (OoT)",
  OOT_SONG_NOTE_AWAKENING: "Note from Sonata of Awakening (OoT)",
  OOT_SONG_NOTE_EMPTINESS: "Note from Elegy of Emptiness (OoT)",
  OOT_SONG_NOTE_EPONA: "Note from Epona's Song (OoT)",
  OOT_SONG_NOTE_GORON: "Note from Goron Lullaby (OoT)",
  OOT_SONG_NOTE_HEALING: "Note from Song of Healing (OoT)",
  OOT_SONG_NOTE_ORDER: "Note from Oath to Order (OoT)",
  OOT_SONG_NOTE_SARIA: "Note from Saria's Song (OoT)",
  OOT_SONG_NOTE_SOARING: "Note from Song of Soaring (OoT)",
  OOT_SONG_NOTE_STORMS: "Note from Song of Storms (OoT)",
  OOT_SONG_NOTE_SUN: "Note from Sun's Song (OoT)",
  OOT_SONG_NOTE_TIME: "Note from Song of Time (OoT)",
  OOT_SONG_NOTE_TP_FIRE: "Note from Bolero of Fire (OoT)",
  OOT_SONG_NOTE_TP_FOREST: "Note from Minuet of Forest (OoT)",
  OOT_SONG_NOTE_TP_LIGHT: "Note from Prelude of Light (OoT)",
  OOT_SONG_NOTE_TP_SHADOW: "Note from Nocturne of Shadow (OoT)",
  OOT_SONG_NOTE_TP_SPIRIT: "Note from Requiem of Spirit (OoT)",
  OOT_SONG_NOTE_TP_WATER: "Note from Serenade of Water (OoT)",
  OOT_SONG_NOTE_ZELDA: "Note from Zelda's Lullaby (OoT)",
  OOT_SONG_NOTE_ZORA: "Note from New Wave Bossa Nova (OoT)",
  OOT_SONG_ORDER: "Oath to Order (OoT)",
  OOT_SONG_SARIA: "Saria's Song (OoT)",
  OOT_SONG_SOARING: "Song of Soaring (OoT)",
  OOT_SONG_STORMS: "Song of Storms (OoT)",
  OOT_SONG_SUN: "Sun's Song (OoT)",
  OOT_SONG_TIME: "Song of Time (OoT)",
  OOT_SONG_TP_FIRE: "Bolero of Fire (OoT)",
  OOT_SONG_TP_FOREST: "Minuet of Forest (OoT)",
  OOT_SONG_TP_LIGHT: "Prelude of Light (OoT)",
  OOT_SONG_TP_SHADOW: "Nocturne of Shadow (OoT)",
  OOT_SONG_TP_SPIRIT: "Requiem of Spirit (OoT)",
  OOT_SONG_TP_WATER: "Serenade of Water (OoT)",
  OOT_SONG_ZELDA: "Zelda's Lullaby (OoT)",
  OOT_SONG_ZORA: "New Wave Bossa Nova (OoT)",
  ...
  OOT_SOUL_ENEMY_GOHMA_LARVA: "Soul of Gohma Larvae",
  ...
  OOT_SOUL_ENEMY_LIZALFOS_DINOLFOS: "Soul of Lizalfos/Dinolfos (OoT)",
  ...
  OOT_SOUL_ENEMY_WOLFOS: "Soul of Wolfos (OoT)",
  ...
  OOT_SPIN_UPGRADE: "Spin Attack Upgrade (OoT)",
  ...
  OOT_STONE_OF_AGONY: "Stone of Agony (OoT)",
  ...
  OOT_SWORD_GORON: "Progressive Goron Sword (OoT)",
  OOT_SWORD_KNIFE: "Giant's Knife",
  OOT_SWORD_KOKIRI: "Kokiri Sword (OoT)",
  OOT_SWORD_MASTER: "Master Sword (OoT)",
  OOT_SWORD: "Progressive Sword (OoT)",
  OOT_TRAP_ANTI_MAGIC: "Anti-Magic Trap",
  OOT_TRAP_DRAIN: "Drain Trap",
  OOT_TRAP_FIRE: "Fire Trap",
  OOT_TRAP_ICE: "Ice Trap",
  OOT_TRAP_KNOCKBACK: "Knockback Trap",
  OOT_TRAP_RUPOOR: "Rupoor",
  ...
  SHARED_ARROW_FIRE: "Fire Arrows",
  SHARED_ARROW_ICE: "Ice Arrows",
  SHARED_ARROW_LIGHT: "Light Arrows",
  SHARED_ARROWS_10: "10 Arrows",
  SHARED_ARROWS_30: "30 Arrows",
  SHARED_ARROWS_40: "40 Arrows",
  SHARED_ARROWS_5: "5 Arrows",
  SHARED_BIG_POE: "Big Poe",
  SHARED_BLUE_FIRE: "Blue Fire",
  ...
  SHARED_BOTTLE_BIG_POE: "Bottled Big Poe",
  SHARED_BOTTLE_BLUE_FIRE: "Bottle of Blue Fire",
  SHARED_BOTTLE_CHATEAU: "Bottle of Chateau Romani",
  SHARED_BOTTLE_EMPTY: "Empty Bottle",
  SHARED_BOTTLE_FAIRY: "Bottled Fairy",
  SHARED_BOTTLE_MILK: "Bottle of Milk",
  SHARED_BOTTLE_POE: "Bottled Poe",
  SHARED_BOTTLE_POTION_BLUE: "Bottle of Blue Potion",
  SHARED_BOTTLE_POTION_GREEN: "Bottle of Green Potion",
  SHARED_BOTTLE_POTION_RED: "Bottle of Red Potion",
  SHARED_BOTTLE_RANDOM: "Random Bottle",
  SHARED_BOTTLE_RUTO_LETTER: "Ruto's Letter",
  SHARED_BOTTLED_GOLD_DUST: "Bottle of Gold Dust",
  SHARED_BOW: "Bow",
  SHARED_BUGS: "Bugs",
  ...
  SHARED_CHATEAU: "Chateau Romani Refill",
  SHARED_DEFENSE_UPGRADE: "Double Defense",
  SHARED_DEKU_SEEDS_30: "30 Deku Seeds",
  SHARED_DEKU_SEEDS_5: "5 Deku Seeds",
  SHARED_FAIRY_BIG: 'Big Fairy',
  SHARED_FAIRY: "Fairy",
  SHARED_FISH: "Fish",
  SHARED_GREAT_FAIRY_SWORD: "Great Fairy's Sword",
  ...
  SHARED_POE: "Poe",
  SHARED_POTION_BLUE: "Blue Potion",
  SHARED_POTION_GREEN: "Green Potion",
  SHARED_POTION_RED: "Red Potion",
  SHARED_POWDER_KEG: 'Powder Keg',
  ...
  SHARED_RUPEE_RAINBOW: "Rainbow Rupee",
  SHARED_RUPEE_RED: "Red Rupee",
  SHARED_RUPEE_SILVER: "Silver Rupee",
  SHARED_SCALE: "Progressive Scale",
  SHARED_SHIELD_DEKU: "Deku Shield",
  SHARED_SHIELD_HERO: "Hero's Shield",
  SHARED_SHIELD_HYLIAN: "Hylian Shield",
  SHARED_SHIELD_MIRROR: "Mirror Shield",
  SHARED_SHIELD: "Progressive Shield",
  SHARED_SHOVEL: "Shovel",
  SHARED_SKELETON_KEY: "Skeleton Key",
  SHARED_SLINGSHOT: 'Fairy Slingshot',
  SHARED_SONG_AWAKENING: "Sonata of Awakening",
  SHARED_SONG_EMPTINESS: "Elegy of Emptiness",
  SHARED_SONG_EPONA: "Epona's Song",
  SHARED_SONG_GORON_HALF: "Progressive Goron Lullaby",
  SHARED_SONG_GORON: "Goron Lullaby",
  SHARED_SONG_HEALING: "Song of Healing",
  SHARED_SONG_NOTE_AWAKENING: "Note from Sonata of Awakening",
  SHARED_SONG_NOTE_EMPTINESS: "Note from Elegy of Emptiness",
  SHARED_SONG_NOTE_EPONA: "Note from Epona's Song",
  SHARED_SONG_NOTE_GORON: "Note from Goron Lullaby",
  SHARED_SONG_NOTE_HEALING: "Note from Song of Healing",
  SHARED_SONG_NOTE_ORDER: "Note from Oath to Order",
  SHARED_SONG_NOTE_SARIA: "Note from Saria's Song",
  SHARED_SONG_NOTE_SOARING: "Note from Song of Soaring",
  SHARED_SONG_NOTE_STORMS: "Note from Song of Storms",
  SHARED_SONG_NOTE_SUN: "Note from Sun's Song",
  SHARED_SONG_NOTE_TIME: "Note from Song of Time",
  SHARED_SONG_NOTE_TP_FIRE: "Note from Bolero of Fire",
  SHARED_SONG_NOTE_TP_FOREST: "Note from Minuet of Forest",
  SHARED_SONG_NOTE_TP_LIGHT: "Note from Prelude of Light",
  SHARED_SONG_NOTE_TP_SHADOW: "Note from Nocturne of Shadow",
  SHARED_SONG_NOTE_TP_SPIRIT: "Note from Requiem of Spirit",
  SHARED_SONG_NOTE_TP_WATER: "Note from Serenade of Water",
  SHARED_SONG_NOTE_ZELDA: "Note from Zelda's Lullaby",
  SHARED_SONG_NOTE_ZORA: "Note from New Wave Bossa Nova",
  SHARED_SONG_ORDER: "Oath to Order",
  SHARED_SONG_SARIA: "Saria's Song",
  SHARED_SONG_SOARING: "Song of Soaring",
  SHARED_SONG_STORMS: "Song of Storms",
  SHARED_SONG_SUN: "Sun's Song",
  SHARED_SONG_TIME: "Song of Time",
  SHARED_SONG_TP_FIRE: "Bolero of Fire",
  SHARED_SONG_TP_FOREST: "Minuet of Forest",
  SHARED_SONG_TP_LIGHT: "Prelude of Light",
  SHARED_SONG_TP_SHADOW: "Nocturne of Shadow",
  SHARED_SONG_TP_SPIRIT: "Requiem of Spirit",
  SHARED_SONG_TP_WATER: "Serenade of Water",
  SHARED_SONG_ZELDA: "Zelda's Lullaby",
  SHARED_SONG_ZORA: "New Wave Bossa Nova",
  ...
  SHARED_SOUL_ENEMY_LIZALFOS_DINOLFOS: "Soul of Lizalfos/Dinolfos",
  ...
  SHARED_SOUL_NPC_ANJU: "Soul of Cucco Lady/Anju",
  SHARED_SOUL_NPC_ASTRONOMER: "Soul of the Astronomer",
  SHARED_SOUL_NPC_BANKER: "Soul of the Beggar/Banker",
  SHARED_SOUL_NPC_BAZAAR_SHOPKEEPER: "Soul of the Bazaar/Swamp Archery Owner",
  SHARED_SOUL_NPC_BEAN_SALESMAN: "Soul of the Bean Salesman",
  SHARED_SOUL_NPC_BIGGORON: "Soul of Biggoron",
  SHARED_SOUL_NPC_BOMBCHU_BOWLING_LADY: "Soul of Bombchu Bowling/Chest Game Lady",
  SHARED_SOUL_NPC_BOMBCHU_SHOPKEEPER: "Soul of the Bombchu/Bomb Shop Owner",
  SHARED_SOUL_NPC_BOMBERS: "Soul of the Graveyard Kid/Bombers",
  SHARED_SOUL_NPC_CARPENTERS: "Soul of Carpenters",
  SHARED_SOUL_NPC_CARPET_MAN: "Soul of the Carpet Man/Swordsman",
  SHARED_SOUL_NPC_CHEST_GAME_OWNER: "Soul of the Chest Game Owner/Fisherman",
  SHARED_SOUL_NPC_CITIZEN: "Soul of Citizens",
  SHARED_SOUL_NPC_COMPOSER_BROS: "Soul of Composer Bros.",
  SHARED_SOUL_NPC_DAMPE: "Soul of Dampe",
  SHARED_SOUL_NPC_DOG_LADY: "Soul of the Dog Lady",
  SHARED_SOUL_NPC_FISHING_POND_OWNER: "Soul of Fishing Pond/Trading Post Owner",
  SHARED_SOUL_NPC_GORMAN: "Soul of Ingo/Gorman & Bros.",
  SHARED_SOUL_NPC_GORON_CHILD: "Soul of the Goron Child/Baby",
  SHARED_SOUL_NPC_GORON_SHOPKEEPER: "Soul of the Goron Shopkeeper",
  SHARED_SOUL_NPC_GORON: "Soul of Gorons",
  SHARED_SOUL_NPC_GROG: "Soul of the Punk Kid/Grog",
  SHARED_SOUL_NPC_GURU_GURU: "Soul of Guru-Guru",
  SHARED_SOUL_NPC_HONEY_DARLING: "Soul of Honey & Darling",
  SHARED_SOUL_NPC_MALON: "Soul of Malon/Romani/Cremia",
  SHARED_SOUL_NPC_MEDIGORON: "Soul of Medigoron/Keg Trial Goron",
  SHARED_SOUL_NPC_OLD_HAG: "Soul of the Old Hag/Anju's Grandmother",
  SHARED_SOUL_NPC_POE_COLLECTOR: "Soul of Poe Collector/Ghost Hut Owner",
  SHARED_SOUL_NPC_ROOFTOP_MAN: "Soul of Rooftop Man/Part-Timer",
  SHARED_SOUL_NPC_RUTO: "Soul of Ruto/Lulu",
  SHARED_SOUL_NPC_SCIENTIST: "Soul of the Scientist",
  SHARED_SOUL_NPC_SHOOTING_GALLERY_OWNER: "Soul of the Shooting Gallery/Town Archery Owner",
  SHARED_SOUL_NPC_TALON: "Soul of Talon/Mr. Barten",
  SHARED_SOUL_NPC_THIEVES: 'Soul of the Patrolling Thieves and their Chief',
  SHARED_SOUL_NPC_ZORA_SHOPKEEPER: "Soul of the Zora Shopkeeper",
  SHARED_SOUL_NPC_ZORA: "Soul of Zoras",
  SHARED_SPELL_FIRE: "Din's Fire",
  SHARED_SPELL_LOVE: "Nayru's Love",
  SHARED_SPELL_WIND: "Farore's Wind",
  SHARED_SPIN_UPGRADE: "Spin Attack Upgrade",
  ...
  SHARED_STONE_OF_AGONY: "Stone of Agony",
  SHARED_STRENGTH: "Progressive Strength",
  SHARED_SWORD_BIGGORON: "Biggoron's Sword",
  SHARED_SWORD: "Progressive Child Sword",
  SHARED_SWORD_GORON: "Progressive Goron Sword",
  SHARED_SWORD_KNIFE: "Giant's Knife",
  SHARED_SWORD_MASTER: "Master Sword",
