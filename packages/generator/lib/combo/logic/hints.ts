import type { Game, Settings, CountMap, PlayerItems, PlayerItem } from '@ootmm/core';
...
import { Random, sample, shuffle, randomInt, countMapArray, ItemGroups, ItemHelpers, Items, itemByID, makePlayerItem } from '@ootmm/core';
