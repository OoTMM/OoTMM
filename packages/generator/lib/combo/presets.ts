  ...
  plando: {
    songEvents: {
      oot: {
        ...
        SONG_EVENT_GREAT_FAIRY_SPELL_FIRE: 'ZELDAS_LULLABY',
        SONG_EVENT_GREAT_FAIRY_SPELL_LOVE: 'ELEGY',
        SONG_EVENT_GREAT_FAIRY_UPGRADE_MAGIC: 'GORON_LULLABY',
        SONG_EVENT_GREAT_FAIRY_UPGRADE_MAGIC2: 'GORON_LULLABY',
        SONG_EVENT_GREAT_FAIRY_UPGRADE_DEFENSE: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_WATER: 'NEW_WAVE',
        SONG_EVENT_TEMPLE_SHADOW: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_SPIRIT_STATUE: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_SPIRIT_LOWER: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_SPIRIT_HIGHER: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_BOTW: 'ZELDAS_LULLABY',
        SONG_EVENT_TEMPLE_GANON: 'ZELDAS_LULLABY',
    },
    mm: {
      SONG_EVENT_TEMPLE_WOODFALL: 'SONATA',
      SONG_EVENT_TEMPLE_SNOWHEAD: 'GORON_LULLABY',
      SONG_EVENT_TEMPLE_GREATBAY: 'NEW_WAVE',
      SONG_EVENT_HEALING_DARMANI: 'HEALING',
      SONG_EVENT_HEALING_PAMELA_FATHER: 'HEALING',
      SONG_EVENT_HEALING_KAMARO: 'HEALING',
      SONG_EVENT_HEALING_MIKAU: 'HEALING',
      SONG_EVENT_AWAKENING_KEETA: 'SONATA',
      SONG_EVENT_LULLABY_KID: 'GORON_LULLABY',
      SONG_EVENT_STORMS_COMPOSER: 'ZELDAS_LULLABY',
      SONG_EVENT_CLOCK_TOWER_ROOF: 'OATH'
    }
  },
  locations: {
