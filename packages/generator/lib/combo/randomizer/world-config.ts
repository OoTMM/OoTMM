...
export function worldConfig(world: LogicResultWorld, settings: Settings): Set<Confvar> {
  ...
  const exprs: Partial<Record<Confvar, boolean>> = {
    ...
    MM_PROGRESSIVE_SWORDS_GORON: settings.progressiveGoronSwordsMm === 'progressive',
    MM_MASTER_SWORD: settings.masterSwordMm,
    MM_BIGGORON_SWORD: settings.goronSwordsMm,
    MM_HYLIAN_SHIELD: settings.hylianShieldMm,
    MM_DEKU_SHIELD: settings.dekuShieldMm,
    SHARED_CHILD_SWORDS: settings.sharedChildSwords,
    SHARED_MASTER_SWORD: settings.sharedMasterSword,
    SHARED_GORON_SWORDS: settings.sharedGoronSwords,
    SHARED_DEKU_SHIELD: settings.sharedDekuShield,
    SHARED_HYLIAN_SHIELD: settings.sharedHylianShield,
    SHARED_MIRROR_SHIELD: settings.sharedMirrorShield,
    OOT_HERO_SHIELD: settings.heroShieldOot,
    SHARED_HERO_SHIELD: settings.sharedHeroShield,
    ...
    SHARED_MASK_GERUDO: settings.sharedMaskGerudo,
    SHARED_MASK_SKULL: settings.sharedMaskSkull,
    SHARED_MASK_SPOOKY: settings.sharedMaskSpooky,
    ...
    OOT_EXTRA_BOTTLES: settings.extraBottlesOot,
    ...
    OOT_CLOCKS: settings.clocksOot !== 'none',
    OOT_CLOCKS_NIGHT: settings.clocksOot === 'night',
