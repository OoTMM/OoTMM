...
export function Header() {
	return (
		<header className="flex items-center h-16 bg-linear-to-r from-blue-900 to-purple-900 text-white">
      ...
      <nav className="flex text-xl items-center gap-8 ml-10">
        ...
        <a className="nav-link" target="_blank" href="https://opencollective.com/ootmm">Donate</a>
      </nav>
