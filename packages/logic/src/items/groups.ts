...
export const SONGS = new Set([
  ...
  Items.OOT_SONG_HEALING,
  Items.SHARED_SONG_HEALING,
  Items.OOT_SONG_SOARING,
  Items.SHARED_SONG_SOARING,
  Items.OOT_SONG_AWAKENING,
  Items.SHARED_SONG_AWAKENING,
  Items.OOT_SONG_GORON,
  Items.SHARED_SONG_GORON,
  Items.OOT_SONG_GORON_HALF,
  Items.SHARED_SONG_GORON_HALF,
  Items.OOT_SONG_ZORA,
  Items.SHARED_SONG_ZORA,
  Items.OOT_SONG_ORDER,
  Items.SHARED_SONG_ORDER,
  Items.MM_SONG_ZELDA,
  Items.MM_SONG_SARIA,
  Items.MM_SONG_SUN,
  Items.MM_SONG_TP_FIRE,
  Items.MM_SONG_TP_FOREST,
  Items.MM_SONG_TP_LIGHT,
  Items.MM_SONG_TP_SHADOW,
  Items.MM_SONG_TP_SPIRIT,
  Items.MM_SONG_TP_WATER,
  Items.SHARED_SONG_ZELDA,
  Items.SHARED_SONG_SARIA,
  Items.SHARED_SONG_SUN,
  Items.SHARED_SONG_TP_FIRE,
  Items.SHARED_SONG_TP_FOREST,
  Items.SHARED_SONG_TP_LIGHT,
...
export const SONG_NOTES = new Set([
  ...
  Items.OOT_SONG_NOTE_HEALING,
  Items.SHARED_SONG_NOTE_HEALING,
  Items.OOT_SONG_NOTE_SOARING,
  Items.SHARED_SONG_NOTE_SOARING,
  Items.OOT_SONG_NOTE_AWAKENING,
  Items.SHARED_SONG_NOTE_AWAKENING,
  Items.OOT_SONG_NOTE_GORON,
  Items.SHARED_SONG_NOTE_GORON,
  Items.OOT_SONG_NOTE_ZORA,
  Items.SHARED_SONG_NOTE_ZORA,
  Items.OOT_SONG_NOTE_ORDER,
  Items.SHARED_SONG_NOTE_ORDER,
  Items.MM_SONG_NOTE_ZELDA,
  Items.MM_SONG_NOTE_SARIA,
  Items.MM_SONG_NOTE_SUN,
  Items.MM_SONG_NOTE_TP_FIRE,
  Items.MM_SONG_NOTE_TP_FOREST,
  Items.MM_SONG_NOTE_TP_LIGHT,
  Items.MM_SONG_NOTE_TP_SHADOW,
  Items.MM_SONG_NOTE_TP_SPIRIT,
  Items.MM_SONG_NOTE_TP_WATER,
  Items.SHARED_SONG_NOTE_ZELDA,
  Items.SHARED_SONG_NOTE_SARIA,
  Items.SHARED_SONG_NOTE_SUN,
  Items.SHARED_SONG_NOTE_TP_FIRE,
  Items.SHARED_SONG_NOTE_TP_FOREST,
  Items.SHARED_SONG_NOTE_TP_LIGHT,
  Items.SHARED_SONG_NOTE_TP_SHADOW,
  Items.SHARED_SONG_NOTE_TP_SPIRIT,
  Items.SHARED_SONG_NOTE_TP_WATER,
]);
...
export const JUNK = new Set([
  ...
  Items.MM_ARROWS_30,
  Items.MM_ARROWS_40,
  Items.MM_DEKU_SEEDS_5,
  Items.MM_DEKU_SEEDS_30,
  Items.MM_BOMB,
  Items.MM_BOMBS_5,
  Items.MM_BOMBS_10,
  Items.MM_BOMBS_20,
  ...
  Items.SHARED_DEKU_SEEDS_5,
  Items.SHARED_DEKU_SEEDS_30,
  Items.SHARED_BOMB,
...
export const CONSUMABLES = new Set([
  ...
  Items.SHARED_MAGIC_JAR_SMALL,
  Items.SHARED_MAGIC_JAR_LARGE,
  Items.SHARED_POTION_RED,
  Items.SHARED_POTION_GREEN,
  Items.SHARED_POTION_BLUE,
  Items.SHARED_FAIRY,
  Items.SHARED_POE,
  Items.SHARED_BIG_POE,
  Items.SHARED_BLUE_FIRE,
  Items.SHARED_MILK,
  Items.SHARED_CHATEAU,
  Items.SHARED_BUGS,
  Items.SHARED_FISH,
]);
...
export const OOT_SOULS_ENEMY = new Set([
  ...
  Items.OOT_SOUL_ENEMY_LIZALFOS_DINOLFOS,
...
export const OOT_SOULS_ANIMAL = new Set([
  Items.OOT_SOUL_ANIMAL_CUCCO,
  Items.OOT_SOUL_ANIMAL_COW,
  Items.OOT_SOUL_ANIMAL_DOG,
  Items.OOT_SOUL_ANIMAL_BUTTERFLY,
]);

export const MM_SOULS_ANIMAL = new Set([
  Items.MM_SOUL_ANIMAL_CUCCO,
  Items.MM_SOUL_ANIMAL_COW,
  Items.MM_SOUL_ANIMAL_DOG,
  Items.MM_SOUL_ANIMAL_BUTTERFLY,
]);

export const SHARED_SOULS_ANIMAL = new Set([
  Items.SHARED_SOUL_ANIMAL_CUCCO,
  Items.SHARED_SOUL_ANIMAL_COW,
  Items.SHARED_SOUL_ANIMAL_DOG,
  Items.SHARED_SOUL_ANIMAL_BUTTERFLY,
]);
...
export const MM_SOULS_ENEMY = new Set([
  ...
  Items.MM_SOUL_ENEMY_LIZALFOS_DINOLFOS,
...
export const SHARED_SOULS_ENEMY = new Set([
  ...
  Items.SHARED_SOUL_ENEMY_LIZALFOS_DINOLFOS,
...
export const BOTTLES_SHARED = new Set([
  Items.SHARED_BOTTLE_EMPTY,
  Items.SHARED_BOTTLE_MILK,
  Items.SHARED_BOTTLE_CHATEAU,
  Items.SHARED_BOTTLE_POTION_RED,
  Items.SHARED_BOTTLE_POTION_GREEN,
  Items.SHARED_BOTTLE_POTION_BLUE,
  Items.SHARED_BOTTLE_FAIRY,
  Items.SHARED_BOTTLE_POE,
  Items.SHARED_BOTTLE_BIG_POE,
  Items.SHARED_BOTTLE_BLUE_FIRE,
]);
...
export const OOT_RUSTY_KEYS = new Set([
  Items.OOT_RUSTY_KEY_TREASURE_CHEST_GAME,
  Items.OOT_RUSTY_KEY_GUARD_HOUSE,
  Items.OOT_RUSTY_KEY_HYRULE_CASTLE,
  Items.OOT_RUSTY_KEY_DOG_LADY_HOUSE,
  Items.OOT_RUSTY_KEY_BACK_ALLEY_HOUSE,
  Items.OOT_RUSTY_KEY_BOMBCHU_SHOP,
  Items.OOT_RUSTY_KEY_MASK_SHOP,
  Items.OOT_RUSTY_KEY_CHILD_BAZAAR,
  Items.OOT_RUSTY_KEY_CHILD_POTION_SHOP,
  Items.OOT_RUSTY_KEY_CHILD_SHOOTING_GALLERY,
  Items.OOT_RUSTY_KEY_BOMBCHU_BOWLING,
  Items.OOT_RUSTY_KEY_LABORATORY,
  Items.OOT_RUSTY_KEY_FISHING_POND,
  Items.OOT_RUSTY_KEY_SILO,
  Items.OOT_RUSTY_KEY_RANCH_STABLE,
  Items.OOT_RUSTY_KEY_RANCH_HOUSE,
  Items.OOT_RUSTY_KEY_RANCH_HOUSE_ROOM,
  Items.OOT_RUSTY_KEY_GRAVEYARD,
  Items.OOT_RUSTY_KEY_WINDMILL,
  Items.OOT_RUSTY_KEY_IMPA_HOUSE,
  Items.OOT_RUSTY_KEY_CARPENTER_HOUSE,
  Items.OOT_RUSTY_KEY_GRANNY_POTION_SHOP,
  Items.OOT_RUSTY_KEY_ADULT_SHOOTING_GALLERY,
  Items.OOT_RUSTY_KEY_SKULLTULA_HOUSE,
  Items.OOT_RUSTY_KEY_ADULT_BAZAAR,
  Items.OOT_RUSTY_KEY_ADULT_POTION_SHOP,
  Items.OOT_RUSTY_KEY_ADULT_POTION_SHOP_BACK,
]);

export const MM_RUSTY_KEYS = new Set([
  Items.MM_RUSTY_KEY_TOURIST_INFORMATION,
  Items.MM_RUSTY_KEY_POTION_SHOP,
  Items.MM_RUSTY_KEY_POST_OFFICE,
  Items.MM_RUSTY_KEY_SWORDSMAN_SCHOOL,
  Items.MM_RUSTY_KEY_LOTTERY,
  Items.MM_RUSTY_KEY_BOMB_SHOP,
  Items.MM_RUSTY_KEY_TRADING_POST,
  Items.MM_RUSTY_KEY_CURIOSITY_SHOP,
  Items.MM_RUSTY_KEY_KAFEI_HIDEOUT,
  Items.MM_RUSTY_KEY_TOWN_ARCHERY,
  Items.MM_RUSTY_KEY_SWAMP_ARCHERY,
  Items.MM_RUSTY_KEY_OBSERVATORY,
  Items.MM_RUSTY_KEY_BLACKSMITH,
  Items.MM_RUSTY_KEY_MUSIC_HOUSE,
  Items.MM_RUSTY_KEY_LABORATORY,
  Items.MM_RUSTY_KEY_BENEATH_GRAVEYARD,
  Items.MM_RUSTY_KEY_DAMPE_HOUSE,
  Items.MM_RUSTY_KEY_MAYOR_RESIDENCE,
  Items.MM_RUSTY_KEY_MAYOR_RESIDENCE_OFFICE,
  Items.MM_RUSTY_KEY_MAYOR_RESIDENCE_SALON,
  Items.MM_RUSTY_KEY_MAYOR_RESIDENCE_KAFEI,
  Items.MM_RUSTY_KEY_TREASURE_CHEST_GAME,
  Items.MM_RUSTY_KEY_HONEY_DARLING,
  Items.MM_RUSTY_KEY_MILK_BAR,
  Items.MM_RUSTY_KEY_DOG_RACETRACK,
  Items.MM_RUSTY_KEY_CUCCO_SHACK,
  Items.MM_RUSTY_KEY_RANCH_HOUSE,
  Items.MM_RUSTY_KEY_RANCH_BARN,
  Items.MM_RUSTY_KEY_RANCH_HOUSE_ROOM,
  Items.MM_RUSTY_KEY_ZORA_SHOP,
  Items.MM_RUSTY_KEY_ZORA_JAPAS_ROOM,
  Items.MM_RUSTY_KEY_ZORA_TIJO_ROOM,
  Items.MM_RUSTY_KEY_ZORA_LULU_ROOM,
  Items.MM_RUSTY_KEY_ZORA_EVAN_ROOM,
  Items.MM_RUSTY_KEY_STOCK_POT_INN,
  Items.MM_RUSTY_KEY_STOCK_POT_INN_ROOF,
  Items.MM_RUSTY_KEY_GRANDMA_ROOM,
  Items.MM_RUSTY_KEY_STOCK_POT_INN_STAFF_ROOM,
  Items.MM_RUSTY_KEY_STOCK_POT_INN_DORMITORY,
]);
...
export const REQUIRED = new Set([
  ...
  ...CLOCKS,
  Items.OOT_CLOCK,
  Items.SHARED_BOTTLED_GOLD_DUST,
  Items.SHARED_BOTTLE_RUTO_LETTER,
