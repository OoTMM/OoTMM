...
const DUNGEON_SCENES = [
  'DEKU_TREE', 'DEKU_TREE_MQ', 'LAIR_GOHMA',
  'DODONGO_CAVERN', 'DODONGO_CAVERN_MQ', 'LAIR_KING_DODONGO',
  'INSIDE_JABU_JABU', 'INSIDE_JABU_JABU_MQ', 'LAIR_BARINADE',
  'TEMPLE_FOREST', 'TEMPLE_FOREST_MQ', 'LAIR_PHANTOM_GANON',
  'TEMPLE_FIRE', 'TEMPLE_FIRE_MQ', 'LAIR_VOLVAGIA',
  'TEMPLE_WATER', 'TEMPLE_WATER_MQ', 'LAIR_MORPHA',
  'TEMPLE_SPIRIT', 'TEMPLE_SPIRIT_MQ', 'LAIR_TWINROVA',
  'TEMPLE_SHADOW', 'TEMPLE_SHADOW_MQ', 'LAIR_BONGO_BONGO',
  'GANON_TOWER', 'LAIR_GANONDORF',
  'BOTTOM_OF_THE_WELL', 'BOTTOM_OF_THE_WELL_MQ',
  'ICE_CAVERN', 'ICE_CAVERN_MQ',
  'GERUDO_TRAINING_GROUND', 'GERUDO_TRAINING_GROUND_MQ', 'THIEVES_HIDEOUT',
  'INSIDE_GANON_CASTLE', 'INSIDE_GANON_CASTLE_MQ',
