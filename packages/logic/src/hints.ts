...
import type { Settings, CountMap, Region } from '@ootmm/core';
...
import { hintLocations, CHECKS_BY_LOCATION } from '@ootmm/data';
import { Monitor, Random, sample, shuffle, randomInt, countMapArray, makeRegion } from '@ootmm/core';
